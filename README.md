...
本项目采用 [Adobe开放源代码行为](code-of-conduct.md)[准则或。NET Foundation行为准则](https://dotnetfoundation.org/code-of-conduct)。 有关详细信息，请参阅 [提供](contributing.md) 文章。
...
如果您是Adobe Experience Cloud解决方案的技术撰稿人、项目经理或产品团队的开发人员，并且您的工作是撰写技术文章或撰写技术文章，则应使用上的专用存储库 `https://git.corp.adobe.com/AdobeDocs`。
