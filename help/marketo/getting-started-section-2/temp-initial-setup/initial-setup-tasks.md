...
# Marketo Engage的初始设置任务{#initial-setup-tasks-for-marketo-engage}

在首次设置全新的Adobe Marketo Engage实例时，您必须执行几项任务/我们强烈建议您执行这些任务以便启动并运行。

完成初始设置后，请查看我们的 [新Marketo Engage实例的最佳实践](/help/marketo/temp-getting-started-section/temp-best-practice-checklists/where-to-start.md) 充分利用您的投资并为长期成功做好准备。

## 任务1：允许列表域 {#allowlist-domains}
...
## 任务2：为登陆页面和电子邮件创建DNS记录 {#step-create-dns-records-for-landing-pages-and-email}
...
## 任务3：允许列表Marketo IP {#step-allowlist-marketo-ips}
...
## 任务4：设置SPF和DKIM {#step-set-up-spf-and-dkim}
...
## 任务6：为您的域设置MX记录 {#step-set-up-mx-records-for-your-domain}
