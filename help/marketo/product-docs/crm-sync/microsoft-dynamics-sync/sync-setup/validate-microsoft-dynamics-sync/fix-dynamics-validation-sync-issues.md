...
如果您在此处具有![x](assets/delete.png)，请验证是否已在Microsoft Dynamics的Marketo默认页面上分配了同步用户。
...
如果您在此处具有![x](assets/delete.png)，请在Microsoft Dynamics的Marketo配置默认设置步骤的Marketo用户字段中分配正确的同步用户。
