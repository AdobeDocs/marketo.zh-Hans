...
在同步[!DNL Microsoft Dynamics 365]和Marketo之前，您需要先在[!DNL Dynamics]中安装Marketo解决方案。 需要&#x200B;**[!DNL Dynamics]管理员权限。**
...
1. 现在，返回[!UICONTROL Solution Information]页面，单击&#x200B;**[!UICONTROL Next]**。
...
1. [!UICONTROL Marketo Lead Management]现在将显示在解决方案列表中。
...
1. 选择&#x200B;**[!UICONTROL Marketo Lead Management]**&#x200B;并单击&#x200B;**[!UICONTROL Publish All Customizations]**。
   ...
   >[!MORELIKETHIS]
   >
   >[第2步（共3步）：使用S2S连接设置Marketo解决方案](/help/marketo/product-docs/crm-sync/microsoft-dynamics-sync/sync-setup/microsoft-dynamics-365-with-s2s-connection/step-2-of-3-set-up.md){target="_blank"}
