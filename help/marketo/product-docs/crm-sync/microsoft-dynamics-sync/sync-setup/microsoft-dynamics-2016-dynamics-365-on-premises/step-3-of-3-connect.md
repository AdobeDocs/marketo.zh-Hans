---
description: 安装Marketo for Microsoft Dynamics 2016/Dynamics 365内部部署步骤3（共3步） — Marketo文档 — 产品文档
title: 安装Marketo for Microsoft Dynamics 2016/Dynamics 365内部部署步骤3（共3步）
...
# 步骤3（共3步）：连接Marketo Dynamics（2016年Prem/Dynamics 365本地版） {#step-of-connect-marketo-dynamics-on-premises-2016}
...
>* [安装Marketo for Microsoft Dynamics 2016/Dynamics 365内部部署步骤2（共3步）](/help/marketo/product-docs/crm-sync/microsoft-dynamics-sync/sync-setup/microsoft-dynamics-2016-dynamics-365-on-premises/step-2-of-3-set-up.md)
