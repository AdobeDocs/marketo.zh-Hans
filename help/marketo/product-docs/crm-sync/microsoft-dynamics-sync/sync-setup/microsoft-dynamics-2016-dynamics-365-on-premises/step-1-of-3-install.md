...
1. 单击 **[!UICONTROL 浏览]** 并选择您的解决方案 [已下载](/help/marketo/product-docs/crm-sync/microsoft-dynamics-sync/sync-setup/download-the-marketo-lead-management-solution.md){target="_blank"}. 单击&#x200B;**下一步**。
...
1. 选择Marketo解决方案，然后单击 **[!UICONTROL 发布所有自定义项]**.
   ...
   >[!MORELIKETHIS]
   >
   >[安装Marketo for Dynamics 2015内部部署和2016 365内部部署第2步（共3步）](/help/marketo/product-docs/crm-sync/microsoft-dynamics-sync/sync-setup/microsoft-dynamics-2016-dynamics-365-on-premises/step-2-of-3-set-up.md){target="_blank"}
