...
>* [第3步（共4步）：在MS Dynamics上设置客户端应用程序](/help/marketo/product-docs/crm-sync/microsoft-dynamics-sync/sync-setup/microsoft-dynamics-365-with-ropc-connection/step-3-of-4-set-up.md)
...
1. 输入 **用户名**， **密码**， Microsoft Dynamics **URL**， **客户端ID**、和 **客户端密码**. 单击 **保存** 完成时。
