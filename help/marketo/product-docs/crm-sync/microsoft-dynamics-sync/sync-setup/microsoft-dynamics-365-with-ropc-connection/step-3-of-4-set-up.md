...
1. 按照中的步骤授予管理员同意 [本文](/help/marketo/product-docs/crm-sync/microsoft-dynamics-sync/sync-setup/grant-consent-for-client-id-and-app-registration.md){target="_blank"}.

1. 通过单击在管理中心生成客户端密钥 **[!UICONTROL 证书和密钥]**.

   ![](assets/step-3-of-4-set-up-client-app-ms-dynamics-ropc-1.png)

1. 单击 **[!UICONTROL 新客户端密码]**.

   ![](assets/step-3-of-4-set-up-client-app-ms-dynamics-ropc-2.png)

1. 添加客户端密码说明并单击 **[!UICONTROL 添加]**.
