...
description: 安装Marketo for Microsoft Dynamics 2015本地步骤1（共3步） — Marketo文档 — 产品文档
title: 安装Marketo for Microsoft Dynamics 2015本地步骤1（共3步）
...
# 步骤1（共3步）：为Marketo配置同步用户（2015年上线） {#step-of-configure-sync-user-for-marketo-on-premises-2015}

在将Microsoft Dynamics 2015本地版与Marketo同步之前，您需要先在Dynamics中安装Marketo解决方案。
