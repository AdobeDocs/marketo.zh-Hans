...
description: 了解如何使用内部部署Dynamics 2013为Marketo配置同步用户。 在Dynamics中设置用户并分配Marketo同步用户角色。
...
# 第 2 步（共 3 步）：为 Marketo（2013 本地部署）配置同步用户 {#step-of-configure-sync-user-for-marketo-on-premises}
