...
>[!PREREQUISITES]
>
>[第1步（共3步）：在Dynamics中安装Marketo解决方案（2013年内部部署）](/help/marketo/product-docs/crm-sync/microsoft-dynamics-sync/sync-setup/connecting-to-legacy-versions/step-1-of-3-install-2013.md){target="_blank"}
...
1. Check **[!UICONTROL Marketo同步用户]** 并单击 **[!UICONTROL 确定]**.
   ...
   >[!TIP]
   >
   >如果您看不到角色，请返回 [第1步（共3步）](/help/marketo/product-docs/crm-sync/microsoft-dynamics-sync/sync-setup/connecting-to-legacy-versions/step-1-of-3-install-2013.md){target="_blank"} 并导入解决方案。
...
1. 下 **[!UICONTROL 设置]**，单击 **[!UICONTROL Marketo配置]**.
   ...
   >[!NOTE]
   >
   >如果缺少“Marketo配置”，请尝试刷新页面。 如果问题仍然存在， [发布Marketo解决方案](/help/marketo/product-docs/crm-sync/microsoft-dynamics-sync/sync-setup/connecting-to-legacy-versions/step-1-of-3-install-2013.md) 或者尝试注销并重新登录。
...
>[!MORELIKETHIS]
>
>[第3步（共3步）：连接Marketo和Dynamics（2013年内部部署）](/help/marketo/product-docs/crm-sync/microsoft-dynamics-sync/sync-setup/connecting-to-legacy-versions/step-3-of-3-connect-2013.md){target="_blank"}
