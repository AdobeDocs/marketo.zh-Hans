...
>[!PREREQUISITES]
>
>您必须拥有 [面向互联网的部署](https://www.microsoft.com/en-us/download/confirmation.aspx?id=41701){target="_blank"} (IFD) with [Active Directory Federation Services](https://msdn.microsoft.com/en-us/library/bb897402.aspx){target="_blank"} 已配置2.0、2.1或3.0 (ADFS)。 注意：单击该链接时，会自动下载IFD文档。
>
>[下载Marketo解决方案](/help/marketo/product-docs/crm-sync/microsoft-dynamics-sync/sync-setup/download-the-marketo-lead-management-solution.md){target="_blank"} 开始之前。
...
1. 登录Dynamics。 单击 **[!UICONTROL Microsoft Dynamics CRM]** 下拉菜单并选择 **[!UICONTROL 设置]**.
