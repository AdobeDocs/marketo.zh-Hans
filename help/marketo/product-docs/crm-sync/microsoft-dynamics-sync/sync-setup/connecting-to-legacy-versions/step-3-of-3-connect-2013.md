...
description: 了解如何在最后一步中连接Marketo和Dynamics 2013内部部署。 在Marketo管理员中输入同步用户信息并启用同步。
...
Marketo和[!DNL Microsoft Dynamics]之间的双向同步现已设置。 如果您已购买[!DNL Marketo Sales Insight]，请参阅以下内容：

>[!MORELIKETHIS]
>
>[在 [!DNL Microsoft Dynamics] 2013](/help/marketo/product-docs/marketo-sales-insight/msi-for-microsoft-dynamics/installing/install-and-configure-marketo-sales-insight-in-microsoft-dynamics-2013.md)中安装和配置 [!DNL Marketo Sales Insight] 
