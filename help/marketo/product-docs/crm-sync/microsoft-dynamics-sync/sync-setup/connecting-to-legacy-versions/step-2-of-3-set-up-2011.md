...
## 在继续执行步骤3之前 {#before-proceeding-to-step}
    ...
    *如果要限制同步记录数，请立即[设置自定义同步过滤器](/help/marketo/product-docs/crm-sync/microsoft-dynamics-sync/create-a-custom-dynamics-sync-filter.md)。
    *运行[验证 [!DNL Microsoft Dynamics] 同步](/help/marketo/product-docs/crm-sync/microsoft-dynamics-sync/sync-setup/validate-microsoft-dynamics-sync.md)进程。 它验证您的初始设置是否正确完成。
    *在 [!DNL Microsoft Dynamics] CRM.
中登录到Marketo Sync User
