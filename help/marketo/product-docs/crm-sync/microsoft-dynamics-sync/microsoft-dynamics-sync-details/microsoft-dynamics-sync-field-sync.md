...
Marketo到Dynamics的同步功能非常强大。 详情如下。

## 这两个系统之间的字段详细信息如何保持同步？ {#how-are-field-details-kept-in-sync-between-the-two-systems}

对于潜在客户和联系人实体，同步是双向的。 如果您对Dynamics中的潜在客户或联系人或Marketo中的人员进行了更改，则您的更新将同时反映在这两个系统中。
...
尽管这种情况很少见，但Marketo将为人员（潜在客户）带来优势，而Dynamics将为联系人带来优势。 这是因为我们认为营销部门对人具有权威性，而官方的联系人记录系统是在销售(CRM)部门。 对于单向同步实体，Dynamics将始终获胜。
...
您可以随时添加字段，并希望数据从Dynamics刷新到Marketo。 参见 [将与Microsoft Dynamics快速同步用于新自定义字段](/help/marketo/product-docs/crm-sync/microsoft-dynamics-sync/microsoft-dynamics-sync-details/microsoft-dynamics-sync-field-sync/use-quick-sync-with-microsoft-dynamics-for-a-new-custom-field.md) 了解详细信息。

## 在将字段添加到同步后，如果我想要删除Dynamics中的字段怎么办？ {#what-if-i-want-to-delete-a-field-in-dynamics-after-the-field-has-been-added-to-sync}
