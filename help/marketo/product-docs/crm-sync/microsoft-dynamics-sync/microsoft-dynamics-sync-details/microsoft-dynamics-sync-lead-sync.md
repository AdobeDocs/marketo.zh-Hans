...
>[!NOTE]
>
>删除操作并不始终自动在两个方向同步。 请参阅[删除潜在客户或联系人](/help/marketo/product-docs/crm-sync/microsoft-dynamics-sync/deleting-a-lead-or-contact.md)。
...
是，使用[将人员同步到Microsoft](/help/marketo/product-docs/core-marketo-concepts/smart-campaigns/microsoft-dynamics-flow-actions/sync-person-to-microsoft.md)流操作。 如果潜在客户不存在，这将在Dynamics中创建潜在客户。 如果潜在客户存在，流程步骤将不执行任何操作。
...
不可以，自动后台同步是在Marketo和Dynamics之间同步更新的唯一方式。 [将人员同步到Microsoft](/help/marketo/product-docs/core-marketo-concepts/smart-campaigns/microsoft-dynamics-flow-actions/sync-person-to-microsoft.md)流操作不会强制潜在客户进行同步。
