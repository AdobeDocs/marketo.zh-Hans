...
请 [下载与您的Dynamics版本](http://docs.marketo.com/x/LoJo) 对应的最新插件。
...
1. 在Dynamics CRM的现有版本上导入解决方案的最新版本(例如：如果您的Dynamics CRM版本为1.4，而最新版本为1.5，则可导 *入版本* 1.4以上)。
1. 您将看到以下弹出窗口。 选择“更 **新** ”和“ **覆盖自定义** ”选项，然后单 **击“导入**”。
...
<table> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colspan="1"><p>错误修复：在MSD API配置中隐藏MSI密码</p></td> 
  </tr> 
  <tr> 
   <td colspan="1">05/26/20</td> 
   <td colspan="1">2.0.0.18</td> 
   <td colspan="1"><p>错误修复：更改用于显示MSI按钮的MSI角色ID验证</p></td> 
  </tr> 
  <tr> 
   <td colspan="1">05/21/20</td> 
   <td colspan="1">2.0.0.17</td> 
   <td colspan="1"><p>错误修复：取消隐藏所有者字段并将字段设为非必填字段</p></td> 
  </tr> 
  <tr> 
