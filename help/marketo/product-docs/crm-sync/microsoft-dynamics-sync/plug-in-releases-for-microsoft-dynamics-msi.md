...
1. 导入最新版本的解决方案 _覆盖现有版本_ ，方法是按下 **导入** 按钮。
...
<table> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colspan="1">发送电子邮件的项目采用得分</td> 
  </tr>
  <tr> 
   <td colspan="1">10/28/21</td> 
   <td colspan="1">2.0.0.25</td> 
   <td colspan="1">产品采用得分量度，新的全局功能板（Web活动、电子邮件、最佳匹配）</td> 
  </tr>
  <tr> 
  ...
  <tr> 
   ...
   <td colspan="1">错误修复：在MSD API配置中隐藏MSI加密密码</td> 
  </tr> 
  <tr> 
   <td colspan="1">05/26/20</td> 
   <td colspan="1">2.0.0.18</td> 
   <td colspan="1">错误修复：要更改用于显示MSI按钮的MSI角色ID验证</td> 
  </tr> 
  <tr> 
   <td colspan="1">05/21/20</td> 
   <td colspan="1">2.0.0.17</td> 
   <td colspan="1">错误修复：取消隐藏所有者字段并将字段设为非必填字段</td> 
  </tr> 
  <tr> 
   <td colspan="1">04/28/20</td> 
   <td colspan="1">2.0.0.16</td> 
   <td colspan="1">错误修复：删除MSD CRM Sitemap设置链接依赖关系</td> 
  </tr> 
 </tbody> 
</table>
