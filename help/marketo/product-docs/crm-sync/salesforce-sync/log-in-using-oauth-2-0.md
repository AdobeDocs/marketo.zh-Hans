...
1. 在Salesforce的设置下，在平台工具中，导航到应用程序、应用程序管理器，然后单击 **[!UICONTROL 新连接的应用程序]**.

   ![](assets/setting-up-oauth-2-1.png)

1. 填写详细信息并单击 **[!UICONTROL 保存]**.
...
>[!CAUTION]
>
在单击之前，请确保向同步用户隐藏Marketo中所有不需要的字段 **[!UICONTROL 同步字段]**. 单击“同步字段”后，用户在SFDC中可以查看的所有字段都将在Marketo中永久创建，且无法删除。

1. 在Marketo管理部分中，单击 **[!UICONTROL CRM]**，则 **[!UICONTROL 与Salesforce同步]**.

   ![](assets/setting-up-oauth-2-7.png)

1. 添加您之前录制的“使用者密钥”和“使用者密钥”信息，然后单击 **[!UICONTROL 保存]**.
...
1. 字段同步完成后，单击 **[!UICONTROL 启动Salesforce同步]**.
