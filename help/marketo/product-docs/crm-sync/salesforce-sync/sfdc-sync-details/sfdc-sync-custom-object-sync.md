...
>[!PREREQUISITES]
>
>要使用自定义对象，它必须与Salesforce中的[lead](/help/marketo/product-docs/crm-sync/salesforce-sync/sfdc-sync-details/sfdc-sync-field-sync.md)、[contact](/help/marketo/product-docs/crm-sync/salesforce-sync/sfdc-sync-details/sfdc-sync-contact-sync.md)或[account](/help/marketo/product-docs/crm-sync/salesforce-sync/sfdc-sync-details/sfdc-sync-account-sync.md)对象关联。
...
1. 将要同步的自定义对象拖入画布。
   ...
   >[!NOTE]
   >
   >自定义对象必须具有唯一的名称。 Marketo不支持两个名称相同的不同自定义对象。
...
1. 要视图您的所有Salesforce自定义对象，请单击&#x200B;**Admin**&#x200B;和&#x200B;**Salesforce对象同步**&#x200B;链接（与上面的步骤1相同）。
