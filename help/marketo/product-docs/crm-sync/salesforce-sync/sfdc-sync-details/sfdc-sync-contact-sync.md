...
description: 了解Salesforce和Marketo之间联系同步的工作方式。 了解双向同步、将人员转换为联系人以及与流程操作强制同步。
title: SFDC同步 — 联系人同步
...
Marketo将整个数据库与[!DNL Salesforce]同步。 它同步，然后等待5分钟，然后每天再次同步。 以下是Marketo如何专门处理[!DNL Salesforce]联系人的一些详细信息。
