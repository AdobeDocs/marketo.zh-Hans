...
description: 了解如何从Salesforce同步中隐藏Marketo字段以优化性能。 在同步用户配置文件上使用字段级安全性可排除不需要的字段。
...
1. 在搜索栏中输入“配置文件”，然后单击&#x200B;**[!UICONTROL Manage Users]**&#x200B;下的&#x200B;**[!UICONTROL Profiles]**。
