...
Marketo允许您将人员添加到[Salesforce潜在客户队列](https://help.salesforce.com/apex/HTViewHelpDoc?id=queues_overview.htm)以帮助进行潜在客户分发。 下面是详细信息。

## 如何将人员分配到Marketo中的队列？{#how-to-assign-a-person-to-a-queue-in-marketo}

您可以使用以下任一流操作将人员分配到Salesforce潜在客户队列：
