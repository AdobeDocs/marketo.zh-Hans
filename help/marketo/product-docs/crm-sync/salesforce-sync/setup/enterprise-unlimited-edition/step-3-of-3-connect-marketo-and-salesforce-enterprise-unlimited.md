...
1. 在快速查找中，键入“reset”，然后单击“Reset **My Security Token”**。
...
1. 阅读警告，然后单击“确 **认凭据**”。
   ...
   >[!CAUTION]
   >
   >如果要查看映射并自 [定义它们](https://docs.marketo.com/display/public/DOCS/Edit+Initial+Field+Mappings)，这是您唯一这样做的机会！ 单击“开始Salesforce同步”即可完成。
