...
1. 在导航搜索栏中键入“[!UICONTROL page layouts]”而不按&#x200B;**[!UICONTROL Enter]**，然后单击&#x200B;**[!UICONTROL Leads]**&#x200B;下的&#x200B;**[!UICONTROL Page Layout]**。
...
1. 完成&#x200B;**[!UICONTROL Contact Page Layout]**&#x200B;后请记得单击&#x200B;**[!UICONTROL Save]**。
...
现在，您拥有了一个帐户，Marketo可使用该帐户连接到[!DNL Salesforce]。
