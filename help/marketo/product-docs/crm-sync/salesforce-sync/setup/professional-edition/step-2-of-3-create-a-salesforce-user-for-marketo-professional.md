...
1. 请记得单击 **保存** 当您使用完 **联系人页面布局**.

   ![](assets/image2014-12-9-12-3a57-3a30.png)

   >[!NOTE]
   >
   >确保 **全天活动** 字段已添加至 **事件页面布局**.
...
>[!NOTE]
>
>如果您的组织没有额外的Salesforce许可证，则可以使用现有的 **营销用户** 使用 **系统管理员** 个人资料。

1. 在导航搜索栏中输入“users”，然后单击 **用户** 下 **管理用户**.
