...
1. 在潜在客户和联系人之间映射这些自定义字段，以便在Salesforce中进行转换时，这些值会继承。
...
对三个自定义字段中的每个字段执行以下步骤以添加它们。 以&#x200B;**Score**&#x200B;开头。
...
1. 单击页面底部“自定义字段和关系”部分中的&#x200B;**New**。

   ![](assets/image2016-5-26-14-3a41-3a40.png)

1. 选择相应的字段类型(对于Score — **number**;客户获取程序 — **text**;客户获取日期 — **日期/时间**)。
...
1. 指定访问设置，然后单击&#x200B;**Next**:
   ...
   * 清除同步用户配置文件的&#x200B;**只读**&#x200B;复选框：
      ...
      * 如果用户的配置文件为&#x200B;_系统管理员_，则请清除系统管理员配置文件的&#x200B;**只读**&#x200B;复选框（如下所示）

      * 如果您为同步用户创建了&#x200B;_自定义配置文件_，请清除该自定义配置文件的&#x200B;**只读**&#x200B;复选框
...
1. 单击&#x200B;**保存并新建**&#x200B;以返回并创建其他两个自定义字段中的每个字段。 单击&#x200B;**Save**，三者全部完成。
...
>[!NOTE]
>
>以下是整个流程的[视频，该视频应该能够清晰显示！](https://nation.marketo.com/videos/1475)
