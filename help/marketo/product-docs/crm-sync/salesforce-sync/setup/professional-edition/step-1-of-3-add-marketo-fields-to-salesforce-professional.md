...
1. 登录Salesforce并单击“设 **置”。**

   ** ![](assets/image2016-5-23-13-3a15-3a21.png)

   **

1. 在左侧的“生成”菜单中，单击“自 **定义** ”并选 **择Lead**。 单击 **字段**。

   ![](assets/image2016-5-23-13-3a20-3a5.png)

1. 在页 **面底部** 的“自定义字段和关系”部分中单击“新建”。
...
1. 单 **击“保存** 并新建”返回并创建其他两个自定义字段。 单击 **“** Save with you&#39;re doped with the all there.

   ![](assets/image2016-5-23-15-3a8-3a43.png)

1. 在左侧的“生成”菜单中，单击“**自定义**”，然后选择“联 **系人**”。 单击 **字段**。
...
1. 在导航搜索中键入“字段”，无需按Enter。 字段显示在不同对象下；单击潜在客户下的字段。
...
>**深潜**
>
>这是一段关 [于整个过程的视频](https://nation.marketo.com/videos/1475) ，它应该能够清晰显示！
