...
对三个自定义字段中的每一个执行以下步骤以添加它们。 开始于 **[!UICONTROL 分数]**.
...
1. 单击 **[!UICONTROL 新建]** 页面底部的自定义字段和关系部分。

   ![](assets/image2016-5-26-14-3a41-3a40.png)

1. 选择相应的字段类型(对于分数 —  **[!UICONTROL 数字]**；客户获取计划 —  **[!UICONTROL 文本]**；客户获取日期 —  **日期/时间**)。
...
1. 指定访问设置，然后单击 **[!UICONTROL 下一个]**：
   ...
   * 清除 **[!UICONTROL 只读]** 用于同步用户配置文件的复选框：

      * 如果您有一个用户，且该用户的配置文件为 _系统管理员_ 作为同步用户，清除 **[!UICONTROL 只读]** 用于系统管理员配置文件的复选框（如下所示）

      * 如果您创建了 _自定义配置文件_ 对于同步用户，清除 **[!UICONTROL 只读]** 用于该自定义配置文件的复选框
...
1. 单击 **[!UICONTROL 保存并新建]** 以返回并创建另外两个自定义字段。 单击 **[!UICONTROL 保存]** 你都受够了。
...
1. Type &quot;[!UICONTROL 字段]”进入导航搜索，而不按Enter。 字段显示在不同的对象下；单击 **[!UICONTROL 字段]** 在“潜在客户”下。

   ![](assets/image2016-5-26-16-3a36-3a32.png)

1. 转到Lead Custom Fields &amp; Relationship部分，然后单击 **[!UICONTROL 映射潜在客户字段]**.
