...
对三个自定义字段中的每个字段执行以下步骤以添加它们。 开始具有&#x200B;**得分**。
...
1. 选择相应的字段类型(对于“得分”— **number**;客户获取项目— **text**;获取日期— **日期／时间**)。
...
1. 在左侧的“生成”菜单中，单击“**自定义**”，然后选择“**联系人**”。 单击&#x200B;**字段**。
...
>**深潜**
>
>这是整个进程的[视频，它应该清晰明了！](https://nation.marketo.com/videos/1475)
