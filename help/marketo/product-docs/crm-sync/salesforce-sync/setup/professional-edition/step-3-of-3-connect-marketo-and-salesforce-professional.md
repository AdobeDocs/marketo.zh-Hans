...
description: 第3步（共3步） — 连接Marketo和Salesforce（专业版） — Marketo文档 — 产品文档
...
# 步骤3（共3步）：连接Marketo和Salesforce(Professional) {#step-of-connect-marketo-and-salesforce-professional}
