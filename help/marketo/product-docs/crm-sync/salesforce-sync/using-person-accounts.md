...
可在Salesforce中设置人员帐户以满足贵组织的需求。 以下内容介绍了Marketo Engage如何处理人员帐户。
...
人员帐户有两个电子邮件字段。 在您的表单（而不是&#x200B;**[!UICONTROL Person Email Address]**）中使用&#x200B;**[!UICONTROL Email Address]**&#x200B;字段以确保Marketo的重复数据消除和其他电子邮件处理正常工作。
