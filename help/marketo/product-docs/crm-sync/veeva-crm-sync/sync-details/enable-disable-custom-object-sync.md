---
description: 了解如何在Veeva CRM和Marketo Engage之间启用或禁用自定义对象同步。 使用管理员和Veeva对象同步选择和同步自定义对象。
title: 启用/禁用自定义对象同步
...
您现在可以在[!UICONTROL Smart Campaigns]和[!UICONTROL Smart Lists]中使用此自定义对象的数据。
