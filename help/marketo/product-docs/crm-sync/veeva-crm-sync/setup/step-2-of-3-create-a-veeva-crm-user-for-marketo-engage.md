...
1. 不按Enter键单击导航搜索栏中的&#x200B;**[!UICONTROL Account]** （人员帐户）页面布局，然后单击[!UICONTROL Contacts]下的&#x200B;**[!UICONTROL Page Layout]**。
...
1. 在[!UICONTROL General User Permissions]部分下，验证是否已选择[!UICONTROL Edit Events]和[!UICONTROL Edit Tasks]。

   ![](assets/step-2-of-3-create-a-veeva-crm-user-13.png)

1. 在[!UICONTROL Standard Object Permissions]部分下，确保检查[!UICONTROL Accounts]和[!UICONTROL Contacts]的[!UICONTROL Read]、[!UICONTROL Create]、[!UICONTROL Edit]和[!UICONTROL Delete]权限。

   ![](assets/step-2-of-3-create-a-veeva-crm-user-14.png)

1. 在[!UICONTROL Custom Object Permissions]部分下，确保为[!UICONTROL Call]、[!UICONTROL Call Key Message]和任何其他所需的自定义对象检查[!UICONTROL Read]权限。
...
1. 在导航搜索栏中输入“用户”，然后单击[!UICONTROL Manage Users]下的&#x200B;**[!UICONTROL Users]**。
...
>[!TIP]
>
>验证您输入的电子邮件地址是否有效。 您需要以同步用户身份登录才能重置密码。

现在，您拥有了一个帐户，Marketo Engage可使用该帐户连接到[!DNL Veeva] CRM。
