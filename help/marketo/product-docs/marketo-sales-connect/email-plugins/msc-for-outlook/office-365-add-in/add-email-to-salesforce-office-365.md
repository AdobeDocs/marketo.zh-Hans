...
我们正在更改功能，以便您记录已发送的电子邮件。 同时，如果电子邮件在发送时未自动记录，或在活动日志中显示在失 [败活动中](http://docs.marketo.com/pages/assets/external-link.jspa)，则可以将其转发到 [Salesforce密送电子邮件地址](http://docs.marketo.com/x/soLS)。
