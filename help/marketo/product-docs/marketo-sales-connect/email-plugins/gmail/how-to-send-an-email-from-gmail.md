...
description: 了解如何使用Sales Connect插件从Gmail发送跟踪电子邮件。 在Gmail中撰写并跟踪打开、点击和回复。
...
>[!CAUTION]
>
>使用Gmail中的“撤消发送”功能会阻止在使用Gmail扩展时发送电子邮件，但是，如果您将活动记录到Salesforce，则仍可能会在Web应用程序和Salesforce中看到活动。
