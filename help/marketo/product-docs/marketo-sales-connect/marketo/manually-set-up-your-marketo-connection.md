---
description: 手动设置Marketo连接 — Marketo文档 — 产品文档
title: 手动设置Marketo连接
...
# 手动设置Marketo连接{#manually-set-up-your-marketo-connection}

>[!NOTE]
>
>配置MSC时，Marketo将自动将您的凭据发送到Sales Connect，并将您的实例连接到Marketo。 如果未看到在设置Sales Connect实例后建立的连接，则此步骤是必需的&#x200B;**仅**。 如果连接已建立，您将在Marketo管理设置页面上看到输入的凭据。
