...
description: 了解如何使用Sales Connect数据创建Salesforce优先级呼叫报告。 生成包含Sales Connect中的呼叫活动的报表。
...
了解如何使用[!DNL Sales Connect]电子邮件参与数据创建[!DNL Salesforce]报告/通话列表，以重点关注具有发展动力的人员或机会。
