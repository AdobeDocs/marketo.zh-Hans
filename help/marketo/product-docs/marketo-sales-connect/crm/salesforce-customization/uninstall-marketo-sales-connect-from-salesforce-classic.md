...
1. 在左侧导航中的Build下，依次展开（但不单击）Customize和Leads。 然后选择&#x200B;**页面布局**。
...
1. 在左侧导航中的Build下，依次展开（但不单击）Customize和Leads。 然后选择&#x200B;**搜索布局**。
...
1. 选择&#x200B;**添加到MSC Campaign (Classic)**、**使用MSC (Classic)的电子邮件**&#x200B;和&#x200B;**推送到MSC (Classic)**，然后单击“删除”箭头。 然后单击&#x200B;**保存**。
...
1. 在左侧导航中的“生成”下，依次展开（但不单击）自定义、联系人。 然后选择&#x200B;**页面布局**。
...
1. 在左侧导航中的Build下，依次展开（但不单击）Customize和Opportunities。 然后选择&#x200B;**页面布局**。
...
1. 在左侧导航中的生成下，展开（但不单击）自定义，然后展开帐户。 然后选择&#x200B;**页面布局**。
