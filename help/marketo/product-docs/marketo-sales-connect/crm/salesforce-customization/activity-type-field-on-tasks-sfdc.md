...
description: 了解将Sales Connect同步到Salesforce时任务的“活动类型”字段。 了解任务类型如何在Salesforce中映射和显示。
...
1. 确保为[!UICONTROL Email]、[!UICONTROL Call]和[!UICONTROL Reply]列出了[!UICONTROL Type]值。
