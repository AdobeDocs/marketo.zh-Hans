...
description: 快速开始视频和Tutorials- Marketo Docs —— 产品文档
title: 快速开始视频和Tutorials
...
# 快速开始视频和Tutorials{#quick-start-videos-and-tutorials}

>[!NOTE]
>
>Marketo Sales Engage最近更名为Marketo Sales Connect。 我们正在更新所有视频，但有些视频可能仍显示旧名。

## 启用营销洞察{#enabling-marketing-insights}
...
## 电子邮件设置概述{#email-settings-overview}
...
## 在Salesforce {#installing-customizations-in-salesforce}中安装自定义
...
## Salesforce概述{#salesforce-overview}
