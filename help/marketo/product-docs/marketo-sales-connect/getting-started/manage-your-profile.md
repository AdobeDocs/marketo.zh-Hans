---
description: 了解如何管理Sales Connect配置文件。 在Web应用程序中更新您的姓名、电子邮件和其他配置文件设置。
title: 管理您的轮廓
...
>[!NOTE]
>
>如果将Exchange On Prem与Sales Connect一起使用，它将不会更新投放渠道（第1行项目）或回复跟踪（第2行项目）集成运行状况检查。 我们正努力在未来的版本中支持此功能。
