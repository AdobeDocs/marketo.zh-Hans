...
>[!PREREQUISITES]
>
>**与电子邮件服务器的连接：** Sales Connect必须与您的收件箱连接，以便我们了解新回复何时到达。 您需要将您的Sales Connect帐户[连接到Gmail](/help/marketo/product-docs/marketo-sales-connect/email-plugins/gmail/email-connection-for-gmail-users.md)。 如果你使用的是Outlook，我们需要与你的[Exchange服务器](https://toutapp.com/next#settings/exchange_settings)集成。
