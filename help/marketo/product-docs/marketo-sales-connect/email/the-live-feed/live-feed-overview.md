...
实时查看与MSE电子邮件的互动（查看、点击和回复）。

标有紫色的人正在接触您的营销内容。 MSE中可能不存在这些人员。 您可以单击向下箭头以添加它们，并获取其他快速操作的列表。

![](assets/purple.png)

标有蓝线的人表示与通过MSE发送的电子邮件的互动。

>[!NOTE]
>
>总体而言，我们根据IP跟踪尽可能准确地确定位置。 不幸的是，这不是一门精确的科学。 如果我们误解了某个收件人的位置，下面提供了一些选项来确定可能发生了什么情况：
>
>* 如果您的收件人登录了某公司的IT总部位于另一个城市或国家/地区的无线网络，我们会记录该位置，而不是收件人的当前区域设置。
>* 如果您的电子邮件是由抄送/密件抄送字段中的某人转发或打开的，我们会尝试准确地显示这些人员的位置。

## “任务”选项卡 {#tasks-tab}

![](assets/task.jpg)

直接从实时信息源快速检查您的待办事项列表。
...
查看按商机得分排列的前几个人（从最高到最低排序）。 商机得分是从您的Marketo实例中提取的。
...
<table> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colspan="1">在“有趣的时刻”下列出的任何通知，包括电子邮件、Web和里程碑</td> 
  </tr> 
 </tbody> 
</table>
...
>[!NOTE]
>
>如果您看到有人在实时信息源中反复查看您的电子邮件，他们可能会将电子邮件转发给其他收件人。 如果您注意到这些视图的位置开始发生更改，则很可能是这种情况。
