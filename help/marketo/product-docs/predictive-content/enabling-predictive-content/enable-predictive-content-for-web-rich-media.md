...
预测内容通过机器学习和预测分析提供支持，让Web访客拥有最相关的内容。 借助Web富媒体，您可以通过文本描述和图像增强内容，并在您的网站上嵌入多个预测内容推荐。
...
1. 要启用单个标题，请单击标题以打开编辑器。 单击富媒体，然后查看 **在富媒体中启用预测内容** 框，单击 **保存**.

   ![](assets/image2017-10-3-9-3a50-3a29.png)

1. 对于多段内容，请在 **预测内容** ，请勾选标题旁边的复选框。

   ![](assets/image2017-10-3-10-3a0-3a42.png)

1. 单击 **内容操作** 下拉框并选择 **为Web富媒体启用**.

   ![](assets/image2017-10-3-10-3a2-3a6.png)|

## 自定义Javascript代码并将其嵌入到您的网站中  {#customize-the-javascript-code-and-embed-it-into-your-website}

请参阅有关富媒体推荐模板的文档 [在Marketo开发人员网站上](https://developers.marketo.com/documentation/websites/rtp-rich-media-recommendations-api){target=&quot;_blank&quot;}。 本文说明了如何自定义网站的模板。

将JavaScript代码粘贴到您网站中希望模板显示的位置。

**模板示例**

* 模板1:包含图像、标题和描述的三个水平内容片段
* 模板2:包含图像、标题和描述的三个垂直内容片段
