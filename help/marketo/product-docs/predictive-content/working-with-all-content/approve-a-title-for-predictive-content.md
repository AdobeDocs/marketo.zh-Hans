...
description: 了解如何从“所有内容”页面或“编辑内容”弹出窗口中审批预测内容的标题。 将已批准的内容添加到推荐的“预测内容”页面。
title: 批准预测性内容标题
...
您可以在[!UICONTROL All Content]页面或[!UICONTROL Edit Content]弹出窗口中批准[!UICONTROL All Content]页面上的任何标题，以将其添加到预测内容。
...
1. 在[!UICONTROL Edit Content]弹出窗口中选中&#x200B;**[!UICONTROL Approve for Predictive Content]**&#x200B;框并单击&#x200B;**[!UICONTROL Save]**。
