...
* **查看次数**：对发现的Web内容（包括所有源）的总点击次数
* **转化**：在同一次访问中查看内容片段并完成表单的访客数量
* **转化率**：由直接转化除以点击量计算的百分比
* **批准以进行预测**：内容获得批准后显示图标

您可以添加新内容并对其进行跟踪、删除一段内容或批准一段内容。 批准内容后，您可以在“预测内容”页面上编辑内容。
