...
<table> 
 ...
 <tbody> 
  <tr> 
   <td colspan="1" rowspan="1">关键字短语</td> 
   <td colspan="1" rowspan="1">手头的关键字。</td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colspan="1" rowspan="1">难以获取特定关键字的排名。 </td> 
  </tr> 
  <tr> 
   <td colspan="1" rowspan="1">月度搜索</td> 
   <td colspan="1" rowspan="1">每月关键字发生的搜索数。 此数据基于精确匹配，仅在12个月的时间内对Google-US可用。 </td> 
  </tr> 
  <tr> 
   <td colspan="1" rowspan="1">关键字短语的排名最高的URL</td> 
   <td colspan="1" rowspan="1">URL中，该URL是关键字排名最高的URL。</td> 
  </tr> 
 </tbody> 
</table>
