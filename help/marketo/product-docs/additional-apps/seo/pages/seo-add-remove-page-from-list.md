...
1. 将鼠标悬停在要添加到列表的页面上。 单击&#x200B;**[!UICONTROL 添加/删除列表]**。
...
1. 单击要将页面添加到的列表。
   ...
   >[!TIP]
   >
   >您还可以为页面创建一个新列表以供转至。 只需在[!UICONTROL 创建新列表]中键入所需的名称。
...
1. 在&#x200B;**[!UICONTROL 页面]**&#x200B;选项卡上，单击要清理的列表。

   ![](assets/image2014-9-18-13-3a3-3a59.png)

1. 将鼠标悬停在要删除的页面上。 单击&#x200B;**[!UICONTROL 添加/删除列表]**。
