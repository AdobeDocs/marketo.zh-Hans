...
description: 了解如何从页面部分的SEO跟踪列表中永久删除页面。
title: SEO - 移除/删除页面
...
# SEO - 移除/删除页面 {#seo-remove-delete-a-page}
...
1. 在[!UICONTROL Pages]选项卡上，将鼠标悬停在要删除的页面上，单击&#x200B;**[!UICONTROL Delete]**，然后单击&#x200B;**[!UICONTROL Remove]**。
