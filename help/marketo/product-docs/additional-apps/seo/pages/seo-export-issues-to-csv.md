...
description: 将页面优化问题从页面详细信息导出到CSV文件，以便在Marketo外部共享。
title: SEO - 将问题导出为 CSV
...
如果要与Marketo以外的人员共享该信息，您可以将页面问题数据导出到CSV文件。 操作方法如下：
...
1. 单击要查看其详细信息的页面。
   ...
   这是页面详细信息向下展开。 **[!UICONTROL Page Optimization Results]**&#x200B;是该特定页面所有问题的列表。
