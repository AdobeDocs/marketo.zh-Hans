...
description: 使用SEO功能板推荐部分可查找热门页面优化问题和热门链接机会以改进您的网站。
title: 了解SEO功能板 — SEO推荐
...
# 了解 SEO 仪表板：SEO 建议 {#understanding-the-seo-dashboard-seo-recommendations}
...
您还可以使用[!UICONTROL Recommendations]部分了解如何改进。 让我们跳进去！
...
>[!TIP]
>
>您可以单击[!UICONTROL Top Page Optimization Issues]查看完整列表。
...
>[!TIP]
>
>您可以单击[!UICONTROL Top Link Optimization]查看完整列表。
