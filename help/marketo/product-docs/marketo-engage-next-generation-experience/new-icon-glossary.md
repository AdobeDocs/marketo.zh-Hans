---
description: 新图标词汇表 — Marketo Docs — 产品文档
title: 新建图标词汇表
...
# 新图标词汇表{#new-icon-glossary}

以下是新AdobeMarketo Engage界面的所有新图标。 如果您仍在运行Marketo Classic，则图标词汇表可以在此处](/help/marketo/getting-started/icon-glossary.md)找到。[
