...
1. 添加任意数量的区段（最多100个）。
   ...
   >
   >
   >如果您在审批过程中收到错误消息并需要帮助降低分段的复杂性，请与[营销人员支持](http://docs.marketo.com/cdn-cgi/l/email-protection#e794929797889593a78a86958c829388c984888a)联系。
...
1. 拖放区段以更改其顺序。 完成后，单击&#x200B;**创建**。
   ...
   >[!NOTE]
   >
   >在定义的[order](segmentation-order-priority.md)中，人符合第一个匹配段的条件。
