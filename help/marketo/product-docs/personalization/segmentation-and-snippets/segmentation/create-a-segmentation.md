...
description: 创建区段 — Marketo文档 — 产品文档
title: 创建分段
...
利用分段，可将人员分组为不同的用户档案，以便报告和动态内容。 以下是如何创建它们。
...
1. 拖放区段以更改其顺序。 完成后，单击 **创建**.
   ...
   >[!NOTE]
   >
   >人员将符合以下项的第一个匹配区段的条件： [订购](/help/marketo/product-docs/personalization/segmentation-and-snippets/segmentation/segmentation-order-priority.md) 已定义。
