...
>[!CAUTION]
>
>工作区可能设置得比较复杂。 联系[Marketo支持](https://nation.marketo.com/t5/Support/ct-p/Support)，了解他们是否适合您。
...
>* 业务部门： [!DNL Quicken]、[!DNL Quickbooks]和[!DNL TurboTax]各自获得工作区
>
...
>[!IMPORTANT]
>
>虽然上面列出的所有项目都可以跨工作区进行克隆，但克隆时，电子邮件、表单和登陆页面&#x200B;_必须位于程序_&#x200B;中。

>[!NOTE]
>
>克隆具有模板的资产时，必须与目标工作区共享这些模板。

## 将Assets移到其他工作区 {#moving-assets-to-other-workspaces}
...
人员分区就像单独的数据库。 每个分区都有各自的人员，他们不会执行重复数据删除或与其他分区混合。 如果您觉得业务用例可能需要具有相同电子邮件地址的重复记录，请联系[Marketo支持](https://nation.marketo.com/t5/Support/ct-p/Support)。
