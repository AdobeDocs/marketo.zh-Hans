...
description: 创建新工作区的步骤，包括命名、选择人员分区、选择主品牌域和设置工作区语言。
title: 创建新工作区
...
>[!NOTE]
>
>有关详细信息，请参阅[了解工作区和人员分区](/help/marketo/product-docs/administration/workspaces-and-person-partitions/understanding-workspaces-and-person-partitions.md){target="_blank"}。
...
1. 输入&#x200B;**[!UICONTROL Name]**，然后选择要使用的&#x200B;**[!UICONTROL Person Partitions]**。 选择&#x200B;**[!UICONTROL Primary Person Partition]**。 确保[人员分区](/help/marketo/product-docs/administration/workspaces-and-person-partitions/create-a-person-partition.md){target="_blank"}已创建（如果尚未创建）。
