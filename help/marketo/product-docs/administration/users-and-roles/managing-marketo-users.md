...
description: 创建和删除用户、重置密码以及编辑用户信息和未使用Adobe Identity的订阅的权限的步骤。
title: 管理 Marketo 用户
...
>[!IMPORTANT]
>
>本文仅适用于&#x200B;_不_&#x200B;将[Marketo与Adobe标识](/help/marketo/product-docs/administration/marketo-with-adobe-identity/adobe-identity-management-overview.md){target="_blank"}一起使用的用户。 如果是，请按照[本文章](/help/marketo/product-docs/administration/users-and-roles/add-or-remove-a-user.md){target="_blank"}中的步骤操作。
