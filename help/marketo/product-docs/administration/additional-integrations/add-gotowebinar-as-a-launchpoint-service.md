...
# 将[!DNL GoToWebinar]添加为[!DNL LaunchPoint]服务 {#add-gotowebinar-as-a-launchpoint-service}

Marketo管理您的[!DNL GoToWebinar]注册和出席情况。
...
>[!NOTE]
>
>此步骤需要[!DNL GoToWebinar]的现有订阅和管理权限。 准备好用于登录到[!DNL GoToWebinar]的电子邮件和密码。
...
1. 太棒了！ 您的&#x200B;**[!UICONTROL GoToWebinar]**&#x200B;帐户现已与Marketo同步。

   ![](assets/add-gotowebinar-as-a-launchpoint-service-8.png)

>[!CAUTION]
>
>当您在[!DNL GoToWebinar]中更新密码时，还必须在Marketo中更新密码。

>[!MORELIKETHIS]
>
>了解如何[使用 [!DNL GotoWebinar]](/help/marketo/product-docs/demand-generation/events/create-an-event/create-an-event-with-gotowebinar.md){target="_blank"}创建事件。
