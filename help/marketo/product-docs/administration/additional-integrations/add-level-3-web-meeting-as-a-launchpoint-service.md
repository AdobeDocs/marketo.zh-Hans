...
description: 将 [!DNL Level 3 Web Meeting] 添加为LaunchPoint服务以管理Marketo中的注册和出勤情况。
...
1. 输入&#x200B;**[!UICONTROL Display Name]**。 在&#x200B;**[!UICONTROL Service]**&#x200B;下，选择&#x200B;**[!UICONTROL Level 3 Web Meeting]**。

   ![](assets/add-level-three-web-meeting-as-a-launchpoint-service-4.png)

1. 输入您的&#x200B;**[!UICONTROL Access Number]**、**[!UICONTROL Access Code]**&#x200B;和&#x200B;**[!UICONTROL Passcode]**，然后单击&#x200B;**[!UICONTROL Create]**。
