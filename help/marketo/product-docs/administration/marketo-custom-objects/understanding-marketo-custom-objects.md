...
创建自定义对象结构后，上载特定自定义对象数据时，使用自定义对象中的链接字段会自动将自定义对象与数据库中的人员关联。 您可以在人员详细信息页面的[!UICONTROL Custom Objects]选项卡中查看信息。
...
如果从CRM同步公司，或者使用API明确创建公司，则链接到公司的自定义对象将发挥最佳效果。 Marketo还建议您使用公司ID作为链接字段。
