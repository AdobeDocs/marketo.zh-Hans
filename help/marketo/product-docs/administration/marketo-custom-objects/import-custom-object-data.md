...
1. 从下拉列表中选择[!UICONTROL 重复数据删除模式]。 单击&#x200B;**[!UICONTROL 下一步]**。

   ![](assets/import-custom-object-data-5.png)

   >[!NOTE]
   >
   >在创建或更新自定义对象记录时，使用重复数据删除字段作为唯一标识符。 此示例使用&#x200B;**car**&#x200B;自定义对象的Dedupe字段 — vin（车辆ID号）。 如果只更新自定义对象记录，则可以选择[!UICONTROL Marketo Guid]作为[!UICONTROL 重复数据删除模式]。
...
1. 单击&#x200B;**[!UICONTROL 导入]**。
   ...
   >[!TIP]
   >
   >在&#x200B;**[!UICONTROL 将警报发送到]**&#x200B;字段中输入您的电子邮件地址，导入完成后，Marketo会通过电子邮件发送给您！
