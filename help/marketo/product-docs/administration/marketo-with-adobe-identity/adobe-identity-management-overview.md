...
>[!NOTE]
>
>如果您希望实施单点登录，并且您的订阅已登记到Adobe Identity而未在Adobe组织中实施SSO，请向[Marketo支持](https://nation.marketo.com/){target="_blank"}提交票证，并将主题指定为“Admin Console上的Marketo，实施SSO”。
...
<table>
 ...
 <tr>
  ...
  <td>被授予具有管理权限的Marketo Engage访问权限的用户。 在Marketo Engage中授予的角色，而不是Adobe Admin Console（在<b>编辑用户</b>模式中仅显示为“管理员”）。</td>
 </tr>
 <tr>
...
>* [添加或删除产品管理员](/help/marketo/product-docs/administration/users-and-roles/add-or-remove-a-product-admin.md){target="_blank"}
>* [添加或删除用户](/help/marketo/product-docs/administration/users-and-roles/add-or-remove-a-user.md){target="_blank"}
