...
1. 选择&#x200B;**[!UICONTROL 用户和角色]**，然后单击&#x200B;**[!UICONTROL 角色]**。

   ![](assets/enable-audit-trail-2.png)

1. 选择要为其启用审核跟踪的角色，然后单击&#x200B;**[!UICONTROL 编辑角色]**。
...
1. 展开&#x200B;**[!UICONTROL 访问管理员]**&#x200B;权限。 根据需要选择&#x200B;**[!UICONTROL 访问审核记录]**&#x200B;和/或&#x200B;**[!UICONTROL 访问登录历史记录]**。 单击&#x200B;**[!UICONTROL 保存]**。
   ...
   >**定义**
   >
   >**[!UICONTROL 访问审核记录]**：授予用户访问[!UICONTROL 资产审核记录]和[!UICONTROL 管理员审核记录]的权限。
   >
   >**[!UICONTROL 访问登录历史记录]**：授予用户访问[用户登录历史记录](/help/marketo/product-docs/administration/audit-trail/user-login-history.md)的权限。
...
1. 在&#x200B;**[!UICONTROL 用户和角色]**&#x200B;中，单击&#x200B;**[!UICONTROL 用户]**。

   ![](assets/enable-audit-trail-5.png)

1. 选择要授予其审核记录访问权限的用户，然后单击&#x200B;**[!UICONTROL 编辑用户]**。
