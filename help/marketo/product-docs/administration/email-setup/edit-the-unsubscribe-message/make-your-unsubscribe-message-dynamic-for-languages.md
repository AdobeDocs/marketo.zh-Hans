...
默认取消订阅消息和链接为英文。 您可以使用动态内容以不同的语言显示它们。

>[!NOTE]
>
>本文代表了一种最佳实践，但它可以通过其他方式实现。
...
1. 在&#x200B;**[!UICONTROL Segmentation]**&#x200B;部分中选择&#x200B;**[!UICONTROL Segment By]**。
...
## 在电子邮件中使用代码片段 {#use-a-snippet-in-an-email}

1. 在电子邮件编辑器中，单击可编辑的元素。 然后单击齿轮图标并选择&#x200B;**[!UICONTROL Replace with Snippet]**。 如果选择可编辑的代码片段元素，请单击齿轮图标并选择&#x200B;**[!UICONTROL Edit]**。
...
1. 单击不同的语言以查看代码片断更改。
   ...
   >[!TIP]
   >
   >您也可以编辑电子邮件的其余部分以使用动态语言。 在取消订阅页面上使用相同技术。

## 使用动态内容自定义取消订阅页面 {#customize-your-unsubscribe-page-with-dynamic-content}
...
1. 查找&#x200B;**[!UICONTROL Preferred Language]**&#x200B;区段。 单击 **[!UICONTROL Save]**。
   ...
   >[!NOTE]
   >
   >了解有关[动态内容](/help/marketo/product-docs/personalization/segmentation-and-snippets/segmentation/understanding-dynamic-content.md)的更多信息。
