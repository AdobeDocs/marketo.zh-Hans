...
description: 使用工作区时，添加其他品牌化域并为每个工作区分配主域。
title: 使用工作区添加附加品牌域名
...
>
>* [在添加其他品牌化域之前，将通用跟踪链接](/help/marketo/product-docs/administration/email-setup/add-multiple-branding-domains/edit-your-default-branding-domain-with-workspaces.md)替换为品牌化域。
...
1. 输入新的品牌策略域。 单击 **[!UICONTROL Next]**。
   ...
   >[!NOTE]
   >
   >您可以选择将此域设置为一个或多个工作区的主域，并且所有设置为“默认”的现有未发送电子邮件和所有新创建的电子邮件都将默认设置为主域。 您可以逐封电子邮件覆盖此项。
