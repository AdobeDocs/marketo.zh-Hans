...
* 对于[!DNL Munchkin]，将`{"anonymizeIP",true}`添加到[init函数](https://experienceleague.adobe.com/en/docs/marketo-developer/marketo/javascriptapi/leadtracking/configuration){target="_blank"}。
