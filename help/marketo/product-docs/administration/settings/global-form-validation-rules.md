...
>[!NOTE]
>
>Marketo Engage提供了一阻止列表个定义的免费消费者电子邮件域名，当使用我们预加载的“消费者电子邮件域名”规则时，这些域阻止列表名会被阻止。 [在此处查看该列表](https://experienceleague.adobe.com/docs/marketo/assets/freemaildomains.csv).
