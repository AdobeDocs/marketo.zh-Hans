...
<table>
 <tbody>
  <tr>
   ...
   <td colspan="1">如果您使用的是Marketo ABM，则所有帐户列表都将同步到MPI，并通过“ABM帐户列表”过滤器可见。 您可以选择帐户列表以筛选这些帐户的结果。<a href="https://docs.marketo.com/display/public/DOCS/Account-Based+Web+Marketing+with+ABM" rel="nofollow">了解有关ABM帐户列表的详细信息。</a></td>
  </tr>
  <tr>
