...
在Analytics中，探索用于电子邮件投放和参与度的聚合数据。 使用左侧的图表浏览数据，使用右侧的见解获得更引导的体验。
...
...或者无需通过扩展浏览器窗口（在较大的屏幕上）即可查看详细信息，而无需将鼠标悬停在其上。

![](assets/kpi-wide.png)

>[!TIP]
>
>那些颜色有意义！ 绿色表示更改良好，红色表示更改不良，灰色表示未更改任何内容。 这是基于您在筛选中选择的比较时段。

图表将显示筛选条件。 要隐藏某个滤镜，只需单击其颜色栏……
...
在页面的右侧，引导式量度可帮助您发现相关的驱动程序。 单击任意量度可在页面左侧的图表中查看该量度。

![](assets/guided-metrics-ps.png)

>[!NOTE]
>
>看到右上角的“刷新”了吗？ 当您看到它时，您需要手动单击它以刷新分析模块。 我们仅在您更改了会使当前值失效的筛选器时显示该值。
