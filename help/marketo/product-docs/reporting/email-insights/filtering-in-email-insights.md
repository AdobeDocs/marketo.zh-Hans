...
description: 在电子邮件分析 — Marketo文档 — 产品文档中进行筛选
title: 在电子邮件分析中筛选
...
如果同一类别中有多个过滤器，则它们将合并并显示数量。

![](assets/state.png)

如果您需要查看已应用的过滤器，只需单击该过滤器。 你甚至可以在那里添加更多内容。
...
从常见的预设日期范围中进行选择，选择特定的日期，甚至使用上一个时段进行比较。

![](assets/date-range.png)

>[!NOTE]
>
>日期范围同时适用于“Analytics”页面和“发送”页面。 此 **比较** 选项仅适用于Analytics页面。
