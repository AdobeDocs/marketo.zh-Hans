...
1. 如果要保存新的自定义分析器，请在Analyzer操作下拉列表中，选择&#x200B;**另存为**。
...
>* [克隆项目分析器](/help/marketo/product-docs/reporting/revenue-cycle-analytics/program-analytics/clone-a-program-analyzer.md)
