...
给定项目中有多少新名字曾在我的模型中达到过特定阶段？

![](assets/one-3.png)

给定项目中当前有多少个新名称在我的模型中处于特定阶段？
...
要视图类别中的可用维或度量，请单击类别名称旁边的右箭头以展开类别列表。 单击向下箭头可折叠类别列表。

>[!TIP]
>
>要获取有关报表中特定维度或度量的更多信息，请将鼠标悬停在该维度或度量上方。
...
<table> 
 <tbody> 
  ...
  <tr> 
   ...
   <td colspan="1" rowspan="1"><p>描述舞台是否处于成功路径中</p></td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colspan="1" rowspan="1"><p>收入周期模型中存在的阶段。 在分析两个阶段之间的度量时，用作“自”阶段</p></td> 
  </tr> 
  <tr> 
   <td colspan="1" rowspan="1"><p>舞台类型</p></td> 
   <td colspan="1" rowspan="1"><p>描述类型；库存、SLA或登记每个阶段是</p></td> 
  </tr> 
 </tbody> 
</table>
...
<table> 
 <tbody> 
  ...
  <tr> 
   <td colspan="1" rowspan="1"><p>新名称（当前名称）</p></td> 
   <td colspan="1" rowspan="1"><p>当前处于阶段并由项目获取的潜在客户总数</p></td> 
  </tr> 
  <tr> 
