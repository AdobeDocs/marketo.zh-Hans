...
description: 在收入模型 — Google文档 — 产品文档中设置Marketo AdWords转化
...
>[!NOTE]
>
>这是从Marketo到Google AdWords的推送集成。 将显示转化数据 _仅_ 在Google AdWords门户中， _不在Marketo UI中_.

详细了解 [Google离线转化导入功能](https://support.google.com/adwords/answer/2998031?hl=en). 将AdWords离线转化映射到收入模型中的一个或多个阶段。 有三种方法可以执行映射：

* AdWords转化
* 暂存操作
* AdWords映射

如果您使用“暂存操作”，则可以从Marketo创建新的AdWords离线转化。
...
## 使用AdWords转化 {#use-adwords-conversion}
...
1. 选择要映射到AdWords转化的收入阶段。

   ![](assets/image2015-2-26-16-3a40-3a2.png)

1. 选择 **AdWords转化** 你想映射到你的Marketo舞台。

   ![](assets/image2015-2-26-16-3a46-3a15.png)

   不错！ 您的AdWords转化数据将在您选择的频率上传到Google AdWords。

## 使用阶段操作 {#use-stage-action}

您还可以在“暂存操作”下映射AdWords转化。
...
1. 选择 **AdWords转化**.
   ...
   **笔尖**:如果您没有任何AdWords转化，请通过单击 **+新建转化**.
