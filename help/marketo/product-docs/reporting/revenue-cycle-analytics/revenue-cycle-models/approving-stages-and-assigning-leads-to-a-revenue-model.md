...
description: 了解如何在Marketo Engage中批准阶段并将潜在客户分配给收入模型，包括批准阶段和。 放心地迈出下一步。
...
>[!NOTE]
>
>如果您的模型处于“已批准阶段”状态，则不会在商机的活动日志中看到任何更改收入阶段事件。 如果您的模型获得完全批准，如果将商机移动到其当前所处的相同阶段，则将跳过此流程步骤。
