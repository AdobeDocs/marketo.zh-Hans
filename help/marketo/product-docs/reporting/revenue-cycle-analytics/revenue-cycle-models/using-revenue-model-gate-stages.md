...
1. 编辑&#x200B;**名称**&#x200B;并选择&#x200B;**类型**。
   ...
   >[!NOTE]
   >
   >选择[此时按帐户开始跟踪](/help/marketo/product-docs/reporting/revenue-cycle-analytics/revenue-cycle-models/start-tracking-by-account-in-the-revenue-modeler.md)以深入了解帐户在模型中的性能。
...
编辑“名称”、“描述”并调整“关卡”阶段的“类型”。 您还可以选择[按帐户](/help/marketo/product-docs/reporting/revenue-cycle-analytics/revenue-cycle-models/start-tracking-by-account-in-the-revenue-modeler.md)开始跟踪。
...
1. 您可以通过右键单击关机阶段图标并选择&#x200B;**删除**&#x200B;来删除关机阶段。

   ![](assets/image2015-4-28-12-3a30-3a19.png)

1. 也可以通过单击某个关口阶段将其删除，然后在&#x200B;**阶段操作**&#x200B;下拉列表中选择&#x200B;**删除**。
