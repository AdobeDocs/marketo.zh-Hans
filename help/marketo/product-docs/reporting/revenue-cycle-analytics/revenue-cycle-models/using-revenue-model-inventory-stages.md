...
description: 了解如何使用收入模型库存阶段在Marketo Engage中使用收入模型库存阶段。 使用本指南完成您的下一步。
title: 使用收入模型库存阶段
...
>[!TIP]
>
>最好在图形或演示程序中创建一个实践模型，并先与同事确认。

## 添加库存阶段 {#add-an-inventory-stage}

1. 要添加新的收入周期模型库存阶段，请单击&#x200B;**[!UICONTROL My Marketo]**&#x200B;主屏幕中的&#x200B;**[!UICONTROL Analytics]**&#x200B;按钮。
