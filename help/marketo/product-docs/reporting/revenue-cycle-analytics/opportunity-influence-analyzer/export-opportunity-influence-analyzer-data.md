...
description: Export Opportunity Influence Analyzer数据 — Marketo文档 — 产品文档
title: 导出Opportunity Influence Analyzer数据
...
# 导出Opportunity Influence Analyzer数据 {#export-opportunity-influence-analyzer-data}
...
1. 您的订阅已设置！ 如果您包含自己的电子邮件地址，您将通过电子邮件收到报告。
