...
**请注意绿色检查**. 它们表示在右侧勾选的一个名称的计划成功。 绿色区域表示机会的开始和结束。

>[!NOTE]
>
>Analyzer数据每夜更新一次，而不是实时更新。

使用右侧的控件，在图表中添加/删除人员，或切换到不同的帐户或机会。

## 标识唯一帐户 {#identifying-unique-accounts}

Marketo使用CRM ID唯一标识帐户。

以前，名称相同的帐户被视为一个帐户。 例如，如果帐户名称是华盛顿高中，并且美国各地有几个帐户名称是华盛顿高中，我们把它们合并到一个帐户中。 这种说法并不准确，因为每所学校都是一个独立的实体。

如果要保留此行为，请考虑在CRM系统中删除重复数据。

>[!TIP]
>
>每次完成交易后，第二天即可在此Analyser中找到它。 与销售代表共享。 他们将意识到您所做的所有艰苦工作 — 此外，您还可以问为什么某些人员“看起来”很有影响力，但没有在CRM中分配角色。
