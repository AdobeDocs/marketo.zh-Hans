...
1. 单击 **保存** ，以确认新限制。
   ...
   >
   >
   >现在，您可 [以使用新限](../../../../product-docs/reporting/basic-reporting/report-activity/export-a-report-to-excel.md) 制导出报表。

   在“基本”报告深入了解配置报 [表的更](http://docs.marketo.com/display/docs/basic+reporting) 多方法。
