---
description: Salesforce同步可观察性指标仪表板 — Marketo文档 — 产品文档
title: Salesforce同步可观察性指标仪表板
hide: true
hidefromtoc: true
feature: Reporting
...
# Salesforce同步可观察性指标仪表板 {#salesforce-sync-observability-metrics-dashboard}

查看您的同步性能吞吐量，并将积压与此仪表板同步。

## 同步吞吐量和积压 {#sync-throughput-and-backlog}

1. 在Marketo Engage中，转到“管理”区域。
...
<tbody>
  ...
  <tr>
    <td>估计积压（时间）</td>
    <td>按对象类型同步积压所需的估计时间。 计算为每小时同步的同步积压/平均记录数。</td>
  </tr>
  <tr>
    <td>上次获取的积压工作</td>
    <td>上次积压计算的时间。</td>
