...
从[网页活动报表](../../../../../product-docs/reporting/basic-reporting/report-types/web-page-activity-report.md)中，您可以看到报表中的人员查看的特定页面。
...
1. 在[网页活动报表](../../../../../product-docs/reporting/basic-reporting/report-types/web-page-activity-report.md)中，单击“页面视图”列中的数字。

   ![](assets/image2014-9-16-14-3a54-3a8.png)

1. 你在那！ 此时将打开一个新窗口，显示访客访问过的网站页面的列表以及访问时间。
   ...
   >
   >
   >利用报告完成更多工作！ 请参阅[基本报告](https://docs.marketo.com/display/docs/basic+reporting)深潜。
