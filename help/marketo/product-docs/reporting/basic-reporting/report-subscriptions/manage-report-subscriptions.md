...
1. 单击 **订阅** 选项卡。
   ...
   此页面显示您帐户中所有报告的订阅，分组依据 [报告类型](/help/marketo/product-docs/reporting/basic-reporting/report-types/report-type-overview.md). 这包括 [订阅基本报告](/help/marketo/product-docs/reporting/basic-reporting/report-subscriptions/subscribe-to-a-basic-report.md) 和到Revenue Cycle Explorer报表。

   >[!TIP]
   >
   >您还可以在中管理对单个报表的订阅 **营销活动**. 选择报告并单击 **订阅** 选项卡。

   要更改通过电子邮件发送报告的频率，请单击频率字段，然后从下拉菜单中选择一个新选项。
...
1. 要更改订阅中的电子邮件地址，请单击 **电子邮件收件人** 字段并编辑电子邮件地址。
   ...
   * 取消选择 **Excel** 用于发送不带电子表格附件的报表摘要的复选框。
   * 单击 **发送** 按钮立即发送报表电子邮件。
