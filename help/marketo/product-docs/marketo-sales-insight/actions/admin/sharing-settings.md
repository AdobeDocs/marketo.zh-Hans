...
首次创建Sales Insight Actions帐户时，将启用共享设置。 这使您的帐户管理员在打开闸门并允许用户将内容共享到您的团队类别中之前，有机会创建和组织您的模板类别。

启用“共享设置”后，只有管理员才能共享到不同的类别中，除非向团队或每个人都提供了共享权限。 禁用共享设置后，没有任何限制，所有用户都可以共享到任何模板类别中。
...
1. 现在您的团队已添加，您可以选择仅允许团队管理员共享或允许该团队中的所有用户。 在此示例中，我们将授予SDR团队中的所有用户共享访问权限。
