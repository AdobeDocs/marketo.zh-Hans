...
>[!NOTE]
>
>默认情况下，将为[!DNL Sales Insight Actions]实例选择[!UICONTROL Salesforce Only]选项。 我们建议使用此设置，以便用户能够从[!DNL Salesforce]中[自动登录](/help/marketo/product-docs/marketo-sales-insight/actions/admin/auto-login-from-salesforce.md)。
