---
description: 了解Sales Campaign步骤类型和提醒任务。 在命令中心和Salesforce中使用“电子邮件”、“呼叫”、“InMail”和“自定义任务”步骤和队列任务。
...
| **[!UICONTROL Use a Template]** | 选择一个预先存在的模板 |
|---|---|
| **[!UICONTROL Save as Template]** | 将您刚刚撰写的电子邮件另存为新模板 |
| **添加内容** | 将文件上传到我们的服务器，并接收可在您的电子邮件中跟踪的URL（指向内容） |
| **附加文件** | 将文件从计算机附加到电子邮件（23MB大小限制） |

>[!TIP]
>
>了解有关[发送选项](/help/marketo/product-docs/marketo-sales-insight/actions/campaigns/understanding-sales-campaign-send-options-for-email-steps.md){target="_blank"}的详细信息。
...
在多个渠道上跟进是联系潜在客户的好方法。 使用InMail任务，您可以设置提醒以通过LinkedIn联系。
