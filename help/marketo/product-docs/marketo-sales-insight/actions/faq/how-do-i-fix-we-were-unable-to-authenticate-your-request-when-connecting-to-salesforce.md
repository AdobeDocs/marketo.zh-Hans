...
如果您在尝试将Sales Insight Actions连接到Salesforce时收到错误消息“我们无法验证您的请求”，则您对Salesforce API的访问权限可能存在限制。 请咨询您的Salesforce管理员，确保具备以下条件。
...
1. 确保Sales Insight Actions旁边显示“块”。 如果您看到“取消阻止”，请单击按钮以取消阻止Sales Insight Actions访问Salesforce。
