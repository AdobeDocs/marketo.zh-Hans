...
>[!NOTE]
>
>这些按钮是Sales Insight包的一部分。 如果未看到可安装到列表视图中的按钮，则可能需要[升级包](/help/marketo/product-docs/marketo-sales-insight/msi-for-salesforce/upgrading/upgrading-your-msi-package.md){target="_blank"}。
...
1. 选择“列表视图”按钮布局。
1. 选择要将按钮添加到的布局旁的&#x200B;**编辑**。
1. 要更改页面上显示的内容，请使用“添加”按钮在“可用按钮”到“选定按钮”之间移动按钮。 “操作”按钮包括“添加到销售活动”和“发送销售电子邮件”。
1. 单击&#x200B;**保存**。
1. 如果仅对潜在客户或联系人执行此操作，请重复这些步骤，对其它对象完成此操作。
