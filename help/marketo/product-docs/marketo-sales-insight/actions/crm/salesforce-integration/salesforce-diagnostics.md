...
**发生的情况：**&#x200B;访问或刷新令牌已过期。 令牌将根据Salesforce[&#128279;](https://salesforce.stackexchange.com/questions/10759/invalid-grant-expired-access-refresh-token-error-when-authenticating-access-via)中的会话设置过期。
