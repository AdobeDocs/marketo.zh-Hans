...
Command Center是一个单一、统一的视图，可帮助您确定下一步骤，同时确保没有任何内容被漏掉。
...
<table>
 ...
 <tr>
  <th rowspan="3">待处理</th>
  <td>已安排</td>
  <td>当前计划发出的电子邮件。 发送电子邮件后，该电子邮件将被移动到已投放的文件夹。</td>
 </tr>
 <tr>
  <td>草稿</td>
  <td>已另存为草稿的电子邮件。<br/>
  <strong>注释</strong>：只能将单个电子邮件另存为草稿。 批量电子邮件（选择并发送电子邮件和群电子邮件）将不会另存为草稿。</td>
 </tr>
 <tr>
  <td>进行中</td>
  <td>这是一种中间状态，电子邮件在发送过程中会进入该状态。 电子邮件应该只进行几分钟的时间。</td>
 </tr>
 <tr>
  <th rowspan="3">未投放</th>
  <td>已失败</td>
 ...
 <tr>
  ...
  <strong>注释</strong>：仅当您是旧版ToutApp用户并且有权将MSC服务器作为投放渠道访问时，才会检测到此情况。</td>
 </tr>
 <tr>
  <td>垃圾邮件</td>
...
## 与参与的潜在客户进行跟踪 {#follow-up-with-engaged-prospects}
