---
description: 了解在Sales Insight操作中发送销售电子邮件的投放渠道。 了解投放渠道如何启用跟踪和投放。
title: 发送渠道概述
...
请务必注意，这些投放渠道具有其自身的发送限制，这些限制由Microsoft和Google实施。 为了应对这种情况，我们使用限制机制来帮助用户保持在这些限制之内。 在此处了解有关[电子邮件限制的详细信息](/help/marketo/product-docs/marketo-sales-connect/email/email-delivery/email-connection-throttling.md)。
