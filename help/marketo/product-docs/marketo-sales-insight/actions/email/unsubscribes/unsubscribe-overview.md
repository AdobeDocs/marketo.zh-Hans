...
当人员单击您的取消订阅链接时，将会转到取消订阅登陆页面，他们可以在其中选择要取消订阅的内容及其原因。

![](assets/unsubscribe-overview-1.png)

此信息将保存到人员详细信息视图，以供稍后查看。
...
>[!NOTE]
>
>只有在以下情况下，才会显示“取消订阅历史记录”卡： _已重新订阅_ 在某个时候。
...
<table> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td><p>重新订阅： Sales Connect管理员从联系人记录中手动删除了取消订阅。 它还可以显示与取消订阅联系人原因相关的一些详细信息。</p><p>取消订阅：联系人已取消订阅。</p></td> 
  </tr> 
  <tr> 
   <td><strong>源</strong></td> 
   <td><p>Salesforce同步：取消订阅是由Salesforce的同步捕获的。</p><p>手动：用户单击取消订阅按钮以选择退出。</p><p>已单击链接：电子邮件的收件人已单击取消订阅链接。</p><p>“管理员姓名”：当操作重新订阅联系人时，将显示管理员姓名。 这使用户知道谁删除了取消订阅。</p></td> 
  </tr> 
 </tbody> 
</table>
