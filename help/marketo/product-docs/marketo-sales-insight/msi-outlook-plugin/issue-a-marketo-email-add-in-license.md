...
1. 在**电子邮件插件**选项卡下，单击&#x200B;**发行许可证**。

   ![](assets/image2016-7-22-10-3a20-3a15.png)

1. 输入需要获得授权才能使用该插件的销售代表的电子邮件地址，然后单击&#x200B;**Issue License**。
   ...
   >[!NOTE]
   >
   >要远程安装该插件，请选中此复选框，然后将您的[企业密钥](http://docs.marketo.com/display/DOCS/Install+the+Marketo+Add-in+for+Outlook+with+an+Enterprise+Key)发送给您的IT团队。
   >
