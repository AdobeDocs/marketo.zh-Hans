...
1. 复制Outlook企业许可证密钥，并将其粘贴到电子邮件中以及[此链接](/help/marketo/product-docs/marketo-sales-insight/msi-outlook-plugin/marketo-outlook-plugin-installation-by-it.md)，然后将其发送给IT部门进行远程安装。
