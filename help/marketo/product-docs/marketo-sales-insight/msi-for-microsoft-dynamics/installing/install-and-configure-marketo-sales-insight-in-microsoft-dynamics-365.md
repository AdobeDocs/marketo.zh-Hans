...
1. 单击 ![—](assets/image2015-5-13-10-5-8.png) 菜单。 在下拉菜单中，选择 **设置**，然后选择 **解决方案**.
   ...
   >[!NOTE]
   >
   >您应该已经拥有 [已安装和配置Marketo解决方案](/help/marketo/product-docs/crm-sync/microsoft-dynamics-sync/sync-setup/microsoft-dynamics-365-with-ropc-connection/step-1-of-4-install.md) 再继续前行。

1. 单击 **导入**.

   ![](assets/image2014-12-12-9-3a5-3a27.png)

1. 在新窗口中，单击 **浏览**. 选择 [您在步骤1中下载的Marketo Sales Insight解决方案](#msi). 单击 **下一个**.
...
1. 返回至Microsoft Dynamics，单击 ![](assets/image2015-5-13-15-3a49-3a19.png) 图标，然后选择 **Marketo API配置** 在下拉菜单中。
