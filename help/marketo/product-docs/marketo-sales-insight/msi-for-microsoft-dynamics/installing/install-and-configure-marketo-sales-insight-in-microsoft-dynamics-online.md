...
description: 在Microsoft Dynamics Online中安装和配置Marketo Sales Insight - Marketo文档 — 产品文档
...
Marketo Sales Insight是一款非常棒的工具，可让您的销售团队更好地了解营销团队所拥有的丰富数据。 以下是如何在Microsoft Dynamics Online中安装和配置它。
...
>[!NOTE]
>
>如果您使用的是统一界面，请在下面的第1步之前，单击右上角的设置图标，然后选择 **高级设置**.
...
1. 这将 _自动_ 选择以前禁用的MSI字段（紧急、相对分数和优先级）。 只需单击 **保存** 以开始同步数据。
