...
description: 了解如何在Microsoft Dynamics 2015中安装和配置Marketo Sales Insight。 添加解决方案并完成设置。
title: 在 Microsoft Dynamics 2015 中安装和配置 Marketo Sales Insight
...
# 在[!DNL Microsoft Dynamics 2015]中安装和配置[!DNL Marketo Sales Insight] {#install-and-configure-marketo-sales-insight-in-microsoft-dynamics}
...
好，现在可以将[!DNL Marketo Sales Insight]解决方案导入[!DNL Microsoft Dynamics]了。 以下是具体操作方法：
