...
description: 了解如何为非本机Salesforce集成配置Sales Insight。 在Marketo通过自定义同步连接到Salesforce时设置MSI。
title: 非本机 [!DNL Salesforce] 集成的[!DNL Sales Insight]
exl-id: a771ecdf-c610-44e4-9e93-7fdcc9d79f4b
feature: Marketo Sales Insights
TQID: https://experienceleague.adobe.com/RoXhGAxqBvub-s-QWYh3Vw0oy-WEv-MCoUL8QyI3otY
product_v2: id: b27e5950-9033-45ac-9f86-eb22e567f615
feature_v2: id: b13bd2ad-8e65-49e5-9691-2a0d31067b35id: b3b8a63f-51fc-40f6-a7d2-a31c5d49fb45id: c5f60233-d5ea-4453-a799-0ad258b4d399
...
# 非本机[!DNL Salesforce]集成的[!DNL Sales Insight] {#sales-insight-for-non-native-salesforce-integrations}
   ...
   <table>
    ...
    <tbody>
     ...
     <tr>
      ...
      <td><p>向外部<span class="dnl">Salesforce</span>销售用户对象标识Marketo销售人员记录。</p><p>要求先同步销售人员，然后再同步其他对象，以便创建正确的关系。</p></td>
     </tr>
    </tbody>
   </table>
   ...
   <table>
    ...
    <tbody>
     ...
     <tr>
      <td>externalSalesPersonId</td>
        <td><span class="dnl">Salesforce</span>销售用户不区分大小写的全局唯一标识符</td>
        <td>标识拥有此潜在客户/联系人的外部<span class="dnl">Salesforce</span>销售用户对象。<br><br>还将此潜在客户与Marketo中的销售人员相关联。 要求首先正确同步销售人员。</td>
     </tr>
     <tr>
      <td>externalCompanyId</td>
        <td><span class="dnl">Salesforce</span>帐户不区分大小写的全局唯一标识符</td>
    ...
    <tbody>
     ...
     <tr>
      ...
      <td>不适用，这将是Marketo潜在客户ID</td>
        <td>这将是已同步的<span class="dnl">Salesforce</span>联系人的Marketo潜在客户ID。<br><br>一旦联系人在Marketo中同步，您就可以使用<span class="dnl">Salesforce</span>不区分大小写的全局唯一标识符作为externalPersonId，并使用Marketo REST API查询Marketo潜在客户。</td>
     </tr>
     <tr>
      <td>角色</td>
