...
* 潜在客户 — 包含单击超级“转到完整列表”的选项，您将被发送到Salesforce中的新选项卡，其中MSI面板将以完整页面布局显示
* 潜在客户完整列表 — 不包括“转到完整列表”选项
* 潜在客户移动设备 — 在Salesforce移动应用程序中可见
* Lead Contact Bridge — 显示您在MSI联系人ID字段中添加的联系人的MSI面板
...
* 上一个有趣时刻类型
* 按销售人员列出的最后Marketo活动
* 按销售人员列出的最近一次Marketo参与
* 相对分数
* 相对分数值
* 紧急
* 紧急值
* 在Marketo中查看 — 单击此字段可打开Marketo中潜在客户的不可编辑视图。 包括：潜在客户信息、公司信息、SFDC潜在客户信息、SFDC自定义字段、活动日志
* MSI联系人ID — 将Salesforce联系人添加到此字段，并在潜在客户布局中包含“潜在客户联系人网桥”面板，以查看联系人的MSI面板

## 联系人布局 {#contact-layout}

Visualforce页面：

* 联系人 — 包含单击“转到完整列表”超级选项卡的选项，您将被发送到Salesforce中的新选项卡，其中MSI面板将以全页布局显示
* 联系人完整列表 — 不包括“转到完整列表”选项
* 联系人移动设备 — 在Salesforce移动应用程序中可见
* 添加到Marketo Campaign ContactPage — 此面板中提供“添加到Marketo Campaign”功能
...
* 帐户 — 包含单击“转到完整列表”超级按钮的选项，您将被发送到Salesforce中的新选项卡，其中MSI面板将以全页布局显示
* 帐户完整列表 — 不包含“转到完整列表”选项
* 帐户移动设备 — 在Salesforce移动应用程序中可见
...
* Opportunity — 包含单击hyper“转到完整列表”的选项，您将被发送到Salesforce中的新选项卡，其中MSI面板将以完整页面布局显示
* Opportunity Full List — 不包括“转到完整列表”选项
...
以下功能包括 **不可用** 在Opportunity Layout页中：

* 星与火

## 潜在客户和联系人列表视图（批量操作） {#lead-and-contact-list-view-bulk-actions}

Salesforce Lightning：在“潜在客户”和“联系人”列表视图中，添加到“关注列表”、“添加到Marketo Campaign”和“发送Marketo电子邮件”批量操作按钮。
...
* 最佳匹配
   ...
   * 包括创建和编辑视图的功能。 能够根据Marketo配置页面中“默认隐藏”选项的配置隐藏最佳匹配
...
* 重置Marketo Sales Insight：包括清除所有配置的能力
