...
description: 了解Marketo Sales Insight中的优先级、紧迫性、相对分数和最佳匹配。 了解MSI面板中的商机评分。
...
火焰代表了一种紧迫感 — 这个人的商机分数最近发生了多大变化。 高度紧急（更易激动）意味着此潜在客户的分数最近大幅增加；这是一个很好的迹象，表明此潜在客户对您的选件感兴趣。 你应该尽快跟进这个人！
