...
参与对话框：访客单击聊天机器人并参与对话框时，登录Marketo并在Sales Insight中填充。

* 对话名称
* 页面 URL
* 状态（已启动/已删除/已完成）

计划的约会：访客通过聊天机器人成功安排约会时，登录Marketo并在Sales Insight中填充。
...
已实现目标：当访客在任何对话流程中实现目标时，登录到Marketo并在Sales Insight中填充。
...
Lead和Contact面板中提供了“聊天”选项卡。 它包括“活动类型”、“对话框名称”和“日期”列。
...
同样，“帐户”面板和“机会”面板包括“名称”、“活动类型”、“对话框名称”和“日期”列。

![](assets/dynamic-chat-integration-6.png)

“聊天”选项卡也包含在您的全局Marketo选项卡中。 它包括三种活动类型（“参与对话”、“计划约会”、“已实现目标”），以及以下列：

* 人员
* 帐户
* 活动类型（参与对话框、计划的约会、实现的目标）
* 对话名称
* 日期和时间戳

同样，您可以通过单击某个活动类型来了解关于该活动类型的更多信息。
