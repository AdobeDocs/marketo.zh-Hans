...
description: 了解Salesforce中的Sales Insight电子邮件性能报表。 查看销售电子邮件的电子邮件量度和参与度。
title: Sales Insight 电子邮件性能报告
...
# Sales Insight 电子邮件性能报告 {#sales-insight-email-performance-report}
