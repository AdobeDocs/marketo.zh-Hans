...
以下是在Salesforce企业版/无限版中配置Marketo Sales Insight所需的步骤。 我们开始吧。

>[!PREREQUISITES]
>
>* [在您的Salesforce Enterprise/Unlimited Edition中配置Marketo字段同步](https://docs.marketo.com/pages/viewpage.action?pageid=2360372)
