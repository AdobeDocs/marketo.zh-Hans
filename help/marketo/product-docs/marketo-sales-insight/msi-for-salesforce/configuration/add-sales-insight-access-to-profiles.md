...
1. 单击刚刚创建的新配置文件（或要授予[!DNL Sales Insight]访问权限的任何其他现有配置文件）的&#x200B;**[!UICONTROL Edit]**&#x200B;链接。
...
1. 从列表中选择您的[!DNL Sales Insight]配置文件，然后从“[!UICONTROL Select Page Layout]”下拉列表中选择您的[!DNL Sales insight]布局。
...
* 从[!UICONTROL Contacts]、[!UICONTROL Leads]和[!UICONTROL Accounts]的搜索布局中删除[!DNL Sales Insight]按钮
