...
description: 在SalesforceAppExchange中安装Marketo Sales Insight Package - Marketo文档 — 产品文档
...
您需要先在Salesforce订阅中安装Marketo Sales Insight应用程序，然后才能享受Sales Insight提供的所有好处。 下面是具体操作方法。
...
1. 转到 [Marketo Sales Insight的“AppExchange”页](https://appexchange.salesforce.com/listingDetail?listingId=a0N30000001SVZmEAO) 并单击 **立即获取**.

   ![](assets/install-marketo-sales-insight-package-in-salesforce-appexchange-1.png)

1. 单击 **登录到AppExchange** 按钮并使用Salesforce凭据登录。

1. 输入连接的Salesforce帐户登录名并单击 **在生产环境中安装**.
...
1. 仔细检查 **已部署** 已选中所有Marketo Sales Insight项目。
