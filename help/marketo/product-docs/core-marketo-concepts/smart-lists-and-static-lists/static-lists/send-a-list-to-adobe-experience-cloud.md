...
* 将列表从Marketo上传到Adobe Audience Manager后，Adobe Target也可以访问该列表。 需要在Adobe Target[中启用该配置](https://experienceleague.adobe.com/zh-hans/docs/target/using/integrate/audience-manager-target-integration){target="_blank"}。
