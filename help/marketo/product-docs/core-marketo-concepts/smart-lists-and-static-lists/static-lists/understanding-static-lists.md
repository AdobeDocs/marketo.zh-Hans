...
description: 了解适用于固定人员集的Marketo中的静态列表。 在手动管理成员资格时使用静态列表。
title: 了解静态列表
...
静态列表是Marketo最简单且最有用的功能之一。 它们是来自数据库的名称列表。 您会找到大量使用它们的理由。
...
>[!CAUTION]
>
>最常见的错误之一是认为可以通过“删除人员”将人员从列表中删除。 **这是错误的**。 删除人员会将其从&#x200B;**整个数据库**&#x200B;中删除，而不只是删除列表。

## 在列表中添加或删除人员的方法 {#ways-to-add-remove-people-from-a-list}
