...
1. **单独使用随机样本 —**&#x200B;随机样本是一个特殊的筛选器。 单独使用它可将您的人员列入预先创建的列表。 然后，使用“列表的成员”使您的智能列表变得超快。 随机抽样将&#x200B;**NOT**&#x200B;用于嵌套式智能列表。 如果随机采样过滤器是为“智能列表的成员”过滤器引用的智能列表，则该过滤器将不起作用。
...
1. **简化您的营销活动 —** 100多个独立规则显然需要一些时间才能处理。 保持简单，您会注意到速度的提高 — 而且它更易于您理解。
