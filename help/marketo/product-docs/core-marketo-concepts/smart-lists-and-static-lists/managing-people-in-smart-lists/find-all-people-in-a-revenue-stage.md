...
# 查找收入阶段的所有人员 {#find-all-people-in-a-revenue-stage}
...
1. 在智能列表中，单击 **智能列表** 选项卡，查找 **收入阶段** 筛选，并将其拖到画布中。
...
现在您已经知道哪些人处于收入阶段，您可以直接向他们进行营销。 除了选择 **收入阶段** 作为智能列表筛选器，您还可以在流程中选择它作为“if”筛选器。

1. 在所需的流程步骤中，单击 **添加选项** 并选择 **收入阶段** 从下拉菜单中查找。

   ![](assets/six.png)

   从那里，您可以选择哪些成员受流程步骤的哪个方面影响。 好玩！
