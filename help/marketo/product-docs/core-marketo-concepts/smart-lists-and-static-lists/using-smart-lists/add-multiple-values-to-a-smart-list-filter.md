...
# 向智能列表筛选器添加多个值 {#add-multiple-values-to-a-smart-list-filter}
...
假设您希望找到加利福尼亚的所有人，但您可能同时将“加利福尼亚”和“CA”存储在数据库中。 若要包含所有适用人员，您可以使用两个[!UICONTROL 状态]筛选器，但使用其中一个筛选器会更容易。

1. 转到&#x200B;**[!UICONTROL 营销活动]**。

   ![](assets/add-multiple-values-to-a-smart-list-filter-1.png)

1. 查找并选择智能列表，然后单击&#x200B;**[!UICONTROL 智能列表]**&#x200B;选项卡。
...
1. 您可以从左侧选择值，或者只需在右侧键入值，然后单击“**[!UICONTROL 确定]**”。
...
>* [在智能列表中使用高级筛选器](/help/marketo/product-docs/core-marketo-concepts/smart-lists-and-static-lists/using-smart-lists/using-advanced-smart-list-rule-logic.md){target="_blank"}
