...
默认情况下，您的智能列表将查找匹配的人员 **[!UICONTROL 所有]** 过滤器(过滤器1 _和_ 2 _和_ 3)。 您可以更改规则逻辑以查找匹配的人员 **[!UICONTROL 任意]** 已定义过滤器(过滤器1 _或_ 2 _或_ 3)，或使用高级过滤器(过滤器1 _和_ 2 _或_ 3)。

在此示例中，假设您希望查找加利福尼亚的人员 _和_ 得分至少为50分 _或_ 状态为“销售合格”。

1. 选择 **[!UICONTROL 使用高级过滤器]** 从下拉菜单中查找。

   ![](assets/one.png)

   >[!NOTE]
   >
   >使用 **[!UICONTROL 高级]** 过滤器可减少使用智能列表过滤器创建智能列表的需求。 这有助于优化性能。

1. 此 **[!UICONTROL 高级过滤器]** 文本框将显示“和”作为所有筛选器之间的默认值。
