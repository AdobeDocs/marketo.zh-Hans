...
在本例中，我们来添加一些限制到 **[数据值已更改](/help/marketo/product-docs/core-marketo-concepts/smart-campaigns/flow-actions/change-data-value.md)** 筛选以查找状态从MQL更改为SQL的人员。
...
1. 输入 **新值**. 在此示例中，我们使用的是SQL。

   ![](assets/six.png)

1. 做得好！ 单击 **人员** 选项卡查看所有拥有 **状态** 更改自 **MQL** 到 **SQL** 在过去30天内。
