...
1. 单击 **[!UICONTROL 全选]**. 您还可以使用 **Ctrl/Cmd** 并点击以手动选择一些记录。
...
1. 下 **[!UICONTROL 人员操作]**，选择您选择的流程步骤。 在此示例中，我们将使用 [更改数据值](/help/marketo/product-docs/core-marketo-concepts/smart-campaigns/flow-actions/change-data-value.md){target="_blank"}.
...
1. 输入一个新值. 单击 **[!UICONTROL 立即运行]**.

   ![](assets/runactionnewvalue-hands.png)

1. 如果要更改大量人员的数据值，您可能需要通过键入数字来确认更改。 单击 **[!UICONTROL 大胆试一试]**.
