...
description: 在程序中了解我的Token。 使用令牌通过项目或成员数据使内容个性化。
title: 了解项目中的我的令牌
...
<table>
 ...
 <tbody>
  ...
  <tr>
   <td colspan="1">SFDC 营销活动 <img alt="--" src="assets/sfdc-campaign-icon.jpg" data-linked-resource-id="11379761" data-linked-resource-type="attachment" data-base-url="https://docs.marketo.com" data-linked-resource-container-id="1147114" title="--"></td>
