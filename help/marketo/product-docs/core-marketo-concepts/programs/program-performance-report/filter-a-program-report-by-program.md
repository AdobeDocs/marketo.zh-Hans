...
关注您的 [方案执行情况报告](/help/marketo/product-docs/core-marketo-concepts/programs/program-performance-report/create-a-program-performance-report.md) 对特定程序进行性能比较。
...
1. 仅此而已！ 单击 **报表** 制表符查看 _只要_ 报表中选择的程序。
