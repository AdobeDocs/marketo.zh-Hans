...
description: 了解如何查看Smart Campaign结果。 查看谁符合条件、浏览流以及采取了哪些操作。
title: 查看智能营销活动结果
...
1. 单击&#x200B;**[!UICONTROL ID]**&#x200B;可查看有关该特定活动的更多详细信息。
   ...
   挖掘结果以查看您的营销活动实际执行的操作，或[将Smart Campaign结果导出到Excel](/help/marketo/product-docs/core-marketo-concepts/smart-campaigns/smart-campaign-data/export-smart-campaign-results-to-excel.md){target="_blank"}。
