...
如果Marketo是一辆强大的汽车，那么智能营销活动就真的成了引擎。 开始使用很简单，但几乎可以执行您要求的任何操作。
...
智能列表是您定义的方式 _谁_ 您希望通过智能营销活动进行定位。 它具有过滤器和触发器。
...
<table> 
 <tbody> 
  ...
  <tr> 
   ...
   <td colspan="1">当有人做某件事时，立即触发气流。</td> 
  </tr> 
 </tbody> 
</table>
...
最后，这控制您运行智能营销活动的时间。 您甚至可以设置循环以便它按重复计划运行。

明智的竞选活动可以做的事情有很多。 掌握其中的奥秘，您就会发现Marketo中的所有内容变得更易于理解。

>[!CAUTION]
>
>如果您将智能营销策划从一个项目移动到另一个项目，并且该营销策划的智能列表或流程步骤引用了原始项目，则必须手动更新信息以反映其新项目，就像这样 **非** 自动更新。
