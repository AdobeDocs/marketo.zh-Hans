...
每天给某人发多次电子邮件是不好的，或者一周内给某人发太多邮件是不好的，对吗？ 幸运的是，Marketo Engage的沟通能力有限。 以下是它们的工作方式。
...
>[!TIP]
>
>要使其成为默认值，请编辑您的  [通信限制](/help/marketo/product-docs/administration/email-setup/enable-communication-limits.md) 在管理员部分中。
