...
1. 查找并选择要将潜在客户添加到的Salesforce活动。
   ...
   >[!TIP]
   >
   >您可以使用Salesforce活动[我的令牌](/help/marketo/product-docs/core-marketo-concepts/programs/tokens/managing-my-tokens.md)简化项目克隆。
...
1. 选择要在添加潜在客户时分配给潜在客户的Salesforce活动成员状态。
   ...
   >[!CAUTION]
   >
   >如果某人已经是Salesforce活动的潜在客户成员，则将跳过他们，并且不会更新他们的状态。 您可以改用[更改SFDC活动](/help/marketo/product-docs/core-marketo-concepts/smart-campaigns/salesforce-flow-actions/change-status-in-sfdc-campaign.md)中的状态。
