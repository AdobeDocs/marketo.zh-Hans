...
description: 添加到SFDC营销活动 — Marketo文档 — 产品文档
title: 添加到SFDC营销活动
...
此流程步骤可以在Marketo营销活动中使用，也可以作为单个流程步骤在Salesforce营销活动中添加人员作为潜在客户。 如果Salesforce中不存在潜在客户，则它会自动同步到并以指定的状态添加到营销活动中。
...
1. 选择要在添加潜在客户时分配给潜在客户的Salesforce营销活动成员状态。
