...
1. 查找并选择要为其添加潜在客户的Salesforce营销活动。
   ...
   >[!TIP]
   >
   >您可以使用Salesforce营销活动 [我的令牌](/help/marketo/product-docs/core-marketo-concepts/programs/tokens/managing-my-tokens.md){target="_blank"} 使程序克隆更容易。
...
1. 选择添加潜在客户时要分配给这些潜在客户的Salesforce营销活动成员状态。
   ...
   >[!CAUTION]
   >
   >如果人员已经是Salesforce营销活动的主要成员，则将跳过这些人员并且不会更新其状态。 您可以使用 [在SFDC营销活动中更改其状态](/help/marketo/product-docs/core-marketo-concepts/smart-campaigns/salesforce-flow-actions/change-status-in-sfdc-campaign.md){target="_blank"} 而是。
