...
>[!NOTE]
>
>以下步骤也适用于 [更改项目群成员数据](/help/marketo/product-docs/core-marketo-concepts/smart-campaigns/program-flow-actions/change-program-member-data.md).

1. 在 **流量** 选项卡，拖入 **更改数据值** 流程步骤。
