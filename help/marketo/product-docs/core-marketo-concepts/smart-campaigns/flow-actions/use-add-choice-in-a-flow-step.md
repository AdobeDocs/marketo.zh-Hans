...
description: 了解如何在流程步骤中使用添加选择。 使用选择逻辑根据条件分支营销活动流程。
title: 在流程步骤中使用“添加选择”
...
# 在流程步骤中使用“添加选择” {#use-add-choice-in-a-flow-step}
...
1. 在Smart Campaign的&#x200B;**[!UICONTROL Flow]**&#x200B;选项卡下，添加任何流量步骤，然后单击&#x200B;**[!UICONTROL Add Choice]**。
