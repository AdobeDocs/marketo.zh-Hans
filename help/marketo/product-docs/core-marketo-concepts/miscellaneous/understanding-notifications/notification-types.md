...
description: 了解Marketo中的通知类型，包括营销活动失败、CRM同步和参与。 了解每个警报的含义。
title: 通知类型
...
当用户在流中精疲力尽时，将发送通知。 通知包括筋疲力尽的人数，以及一些其他信息。
...
>[!NOTE]
>
>[开发人员文档](https://experienceleague.adobe.com/zh-hans/docs/marketo-developer/marketo/rest/error-codes)中列出了您可能收到的某些错误代码。
