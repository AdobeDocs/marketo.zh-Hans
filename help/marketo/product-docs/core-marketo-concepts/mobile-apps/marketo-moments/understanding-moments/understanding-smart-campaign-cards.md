...
使用Marketo Ments从智能手机或iPad查看每次运行的智能营销活动。 Marketo时刻智能营销活动信息卡表示营销活动的一次运行；每次运行智能营销活动时，都会显示一张新信息卡。 智能营销活动卡在左上角标有一个灯泡。

对于已计划但尚未运行的未来智能营销活动， Marketo时刻卡尚未显示任何营销活动统计数据。 它们将显示在以后的版本中。
...
1. 利用详细信息卡，可访问有关智能列表筛选器、流量和电子邮件摘要的信息。
...
1. 现在，您将看到Smart Campaign的流程。 此营销活动只有一个流程步骤，但可以有多个步骤。
...
1. 现在，您可以按数量和百分比查看收件人对每个电子邮件的回复。

   ![](assets/image2015-9-21-13-3a59-3a29.png)

1. 看到底下那两个点了吗？ 它们表示有两封电子邮件连接到此智能营销活动。 要查看另一封电子邮件的结果，请向左滑动屏幕。 以下是第二封电子邮件的结果。
...
在电子邮件发出之前查看一下是个好主意。 或者，将样本发送给其他人，以便获得第二组眼睛。
...
未确认的智能营销活动的卡片为灰色，直到您确认为止。 然后，它们变成橙色。
...
1. 点按 **取消运行**. 如果您在最后时刻决定不取消运行，请点按 **没关系**，并且smart campaign将按计划运行。
...
## 其他Smart Campaign操作 {#other-smart-campaign-actions}
...
>[!NOTE]
>
>您也可以点按 **共享** 图标，以及 **完成** 和 **收藏** 图标。

## 快速删除智能营销活动信息卡 {#quickly-delete-a-smart-campaign-card}

如果您拥有不再需要的卡（可能用于测试的卡），可以通过向左或向右快速滑动将其删除。
