...
description: 了解如何设置参与计划的流频率。 安排每周或每月投放，并可以选择使用收件人时区。
title: 设置流发送节奏
...
1. 现在，选择您希望节奏每周发生还是间隔更长。 每2周挑一次。

   ![](assets/image2017-12-5-14-3a10-3a56.png)

1. 决定一周的哪几天。 在这种情况下，选择星期二、星期三和星期四。
...
1. 将鼠标悬停在节奏上。 未来发生剧变的日子即将到来。

   ![](assets/image2017-12-5-14-3a17-3a29.png)

   >[!NOTE]
   >
   >在此示例中，电子邮件将在星期四发出。 跳过了下周，电子邮件又在一周的周二、周三和周四发送。 然后循环就会重复。
...
1. 选择您希望它每月间隔一次还是间隔更长时间。 每四个月选一次。
