...
糟糕！ 那些人怎么进去的？ 您可以使用从参与计划中移除成员 **更改项目状态** 流程步骤。
...
1. 拖入 **更改项目状态** 流程步骤。
   ...
   格罗维。 您在中定义的所有成员 [智能列表](/help/marketo/product-docs/core-marketo-concepts/smart-lists-and-static-lists/creating-a-smart-list/create-a-smart-list.md) 将不再参与此参与计划。

## 暂停人员  {#pause-people}

有时，您只想暂停参与计划的人员，而不想删除他们。 此操作通过 **更改参与计划节奏**.
