...
所有这些字段都内置于您的Marketo订阅。 它们都是布尔（复选框）类型。 它们可以在Forms或[更改数据值](../../../product-docs/core-marketo-concepts/smart-campaigns/flow-actions/change-data-value.md)流步骤中使用。

## 取消订阅{#unsubscribed}

此选项用于标准取消订阅页面。 如果某人选中此框或单击电子邮件中的取消订阅链接，他们将不再收到营销电子邮件。 但是，他们将收到[操作电子邮件](../../../product-docs/email-marketing/general/functions-in-the-editor/make-an-email-operational.md)。
...
[将它用于竞争对手等人](http://docs.marketo.com/x/uwOQ)。希望收到&#x200B;**不**&#x200B;电子邮件的任何人，包括运营、营销等。 他们什么也得不到！
