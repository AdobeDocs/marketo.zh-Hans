...
>[!AVAILABILITY]
>
>您必须同意[用户协议](https://www.adobe.com/cn/legal/licenses-terms/adobe-dx-gen-ai-user-guidelines.html){target="_blank"}，然后才能在Adobe Marketo Engage中使用AI助手。 有关更多信息，请与您的 Adobe 代表联系。
