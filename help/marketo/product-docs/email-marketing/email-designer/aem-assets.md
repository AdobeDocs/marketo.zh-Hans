...
当&#x200B;_Adobe Experience Manager Assetsas a Cloud Service_&#x200B;与Adobe Marketo Engage集成时，您可以轻松访问数字资源以用于营销内容。 在创作内容时，可从左侧导航栏中的&#x200B;_[!UICONTROL Assets]_&#x200B;项访问资源，在创作电子邮件内容时也可访问资源。 您还可以直接从Marketo Engage将资源上传到连接的&#x200B;_AEM Assetsas a Cloud Service_&#x200B;存储库。 &lt;------- NILESH将检查

>[!NOTE]
>
>目前，Marketo Engage仅支持&#x200B;_Adobe Experience Manager Assets_&#x200B;中的图像资源。 &lt;---- NILESH将检查 — 必须从Adobe Experience Manager Assets中央存储库对资源进行更改。 [了解详情](https://experienceleague.adobe.com/en/docs/experience-manager-cloud-service/content/assets/manage/manage-digital-assets)
...
如果您的环境有一个或多个Assets存储库连接，则在创建或查看电子邮件、电子邮件模板或可视化片段的详细信息时，可以指定AEM Assets作为资源的来源。
