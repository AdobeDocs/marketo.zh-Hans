...
将您的&#x200B;_Adobe Experience Manager Assetsas a Cloud Service_&#x200B;帐户连接到Adobe Marketo Engage实例，以便您可以在Marketo EngageEmail Designer中利用AEM Asset存储库。
...
## 访问 AI 助手内容加速器 {#access-the-ai-assistant-content-accelerator}

在可以使用此功能之前，必须首先将AEMCloud Service与Adobe Marketo Engage关联。

+++链接AEMCloud Service和Marketo Engage
...
## 使用AEM assets {#working-with-aem-assets}
