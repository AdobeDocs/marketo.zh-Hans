...
<tbody>
  ...
  <tr>
    <td>生成内容</td>
    <td>能够通过<a href="/help/marketo/product-docs/email-marketing/email-designer/generate-content.md" target="_blank">生成AI</a>模型生成主题行、部分内容或整个电子邮件。</td>
    <td>不可用</td>
    <td>可用</td>
  </tr>
  <tr>
  ...
  <tr>
    <td>电子邮件模板转换器</td>
    <td>能够<a href="/help/marketo/product-docs/email-marketing/email-designer/import-template.md" target="_blank">将现有Marketo模板</a>导入新的电子邮件Designer。</td>
    <td>不需要</td>
    <td>可用</td>
  </tr>
  <tr>
