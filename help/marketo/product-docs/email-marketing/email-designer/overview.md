...
是，旧（经典）电子邮件编辑器将与新电子邮件Designer共存。 在经典编辑器中创建的电子邮件将保留。 虽然目前还不知道经典编辑器何时被弃用，但直到2026年它才会继续正常运行。 我们会在弃用旧编辑之前提前几个月通知。
...
目前建议使用Google Chrome、Apple Safari、Microsoft Edge或Mozilla Firefox。
