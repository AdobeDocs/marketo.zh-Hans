...
product: marketo
title: 片段
description: 了解如何创建片段并将其用作可重用的电子邮件组件。 将可视化内容片段添加到电子邮件和模板。
...
1. 单击&#x200B;_主题_&#x200B;图标。
   ...
   >[!INFO]
   >
   >了解有关[主题设置](/help/marketo/product-docs/email-marketing/email-designer/brands/brand-themes.md#settings){target="_blank"}的更多信息。
...
>[!NOTE]
>
>如果电子邮件中禁用了&#x200B;_与HTML同步_，则所做的更改（包括中断继承）将不会反映在文本内容中。
