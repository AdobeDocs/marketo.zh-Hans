...
下面的示例说明了主题行。 对于预标题，单击&#x200B;_预标题_&#x200B;复选框（如上图所示）可执行相同的步骤。
...
在提示中输入相关细节，例如“一位银行家，拿着成栈的现金，坐在办公桌前”。 如果您不确定要输入什么，也可以使用提示库（位于提示的右侧）。 单击&#x200B;**图像设置**。

![](assets/use-the-ai-assistant-9.png)

单击切换可启用&#x200B;_使用AI生成图像_，然后更改任何所需的设置，包括要使用的模型（Adobe Firefly或Gemini 2.5 Nano Banana）。 完成后，单击&#x200B;**生成**。

![](assets/use-the-ai-assistant-10.png)

将创建多个变体。 选择你的最爱，然后单击&#x200B;**应用**。

![](assets/use-the-ai-assistant-11.png)

>[!NOTE]
>
>如果没有任何图像符合您的需要，请再次单击&#x200B;**生成**&#x200B;以创建新版本。
