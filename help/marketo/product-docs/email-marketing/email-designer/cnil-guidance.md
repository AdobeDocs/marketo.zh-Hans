...
1. 通过数据导入（API同步或CSV上传）为每个人设置EmailPixelTracking字段值。
...
在电子邮件Designer中，可在电子邮件右侧&#x200B;_摘要_&#x200B;窗格的&#x200B;_详细信息_&#x200B;选项卡中找到&#x200B;**禁用打开跟踪**&#x200B;复选框。 在旧版电子邮件编辑器中，可以在&#x200B;_编辑设置_&#x200B;菜单中找到&#x200B;**禁用打开跟踪**&#x200B;复选框。
...
## 步骤4：配置智能营销活动 {#smart-campaign}

创建Smart Campaign以确定每个人收到的电子邮件。

1. 在Smart Campaign的&#x200B;_流程_&#x200B;选项卡中，插入&#x200B;**发送电子邮件**&#x200B;流程步骤。

   ![](assets/cnil-8.png){width="800" zoomable="yes"}

1. 在流程步骤中，单击&#x200B;**添加选项**。 在Choice 1中，将&#x200B;**if**&#x200B;设置为&#x200B;_EmailPixelTracking_，将运算符设置为&#x200B;_is_，并将值设置为&#x200B;_false_。 对于&#x200B;**电子邮件**，请选择&#x200B;_电子邮件二_。
