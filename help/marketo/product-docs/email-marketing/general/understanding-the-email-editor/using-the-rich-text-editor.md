...
富文本编辑器(RTE)会在整个Marketo中显示，并在您想要添加或编辑内容时可用。 您会在登陆页面、程序、电子邮件、表单和代码片段上看到此功能的某个版本。 只需单击&#x200B;**编辑草稿**，它就会弹出，为您提供服务。
...
1. 在&#x200B;**电子邮件/代码片段编辑器**&#x200B;下拉列表中，选择`<div>`或无，然后单击&#x200B;**保存**。 在此示例中使用了`<div>`。

   ![](assets/four.png)

   如果电子邮件模板中包含`<div class=“mktEditable”></div>`，则在打开部分并在编辑器中键入“Text Goes Here”时，您将看到以下SourceHTML行为：
...
>[!TIP]
>
>您也可以按照相同的步骤更改登陆页面编辑器的根块元素，但要在步骤4中单击&#x200B;**登陆页面编辑器**&#x200B;下拉列表而不是电子邮件/代码片段编辑器。
...
| ![—](assets/image2015-7-9-10-3a29-3a1.png) | 斜体 | *为强调或引号*&#x200B;而倾斜。 |
...
| ![—](assets/image2015-10-6-12-3a12-3a17.png) | 编辑HTML | 弹出HTMLSource编辑器，以便您调整代码。 |
...
>[!TIP]
>
>可以在单独的屏幕上编辑HTML和文本。 请确保在&#x200B;**文本**&#x200B;选项卡上单击&#x200B;**从HTML复制**，然后单击&#x200B;**保存**，以使您的文本与您的HTML匹配。
...
1. 在&#x200B;**登陆页面编辑器**&#x200B;下拉列表中，选择`<p>`或“无”，然后单击&#x200B;**保存**。 在此示例中使用了`<p>`。
