...
>[!IMPORTANT]
>
>虽然尚未确定具体日期，但经典电子邮件编辑器很可能会在 2027 年的某个时间弃用（届时将公布确切日期）。强烈建议开始采用高级[电子邮件设计器](/help/marketo/product-docs/email-marketing/email-designer/overview.md){target="_blank"}，因为它具备经典编辑器所不具备的多项功能。
