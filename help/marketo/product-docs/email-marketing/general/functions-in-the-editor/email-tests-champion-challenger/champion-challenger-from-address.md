...
希望尝试使用其他发件人地址而不用大惊小怪？ 下面是具体操作方法。
...
1. 输入 **发件人名称** （左）和 **发件人地址** （右）为挑战者。
   ...
   >[!TIP]
   >
   >如果您需要多个挑战者，请单击加号，然后输入其他名称和电子邮件。
...
1. 拖动滑块以确定使用冠军“发件人地址”接收电子邮件的用户与使用挑战者“发件人地址”接收电子邮件的用户之间的百分比拆分。
   ...
   >**示例**
   >
   >在上面所示的分布中，智能列表中指定的总受众的15%从挑战者发件人地址获得一封电子邮件，85%从冠军发件人地址获得电子邮件。 来自多个地址的挑战者收到的电子邮件平均占到15%。 测试结束后，您可以手动声明入选者。 从那时起，所有未来的人都会获得性能更好的内容。

   要获得统计置信度，请确保选择的百分比包含足够多的人员以使测试有效。 不要被无定论的结果所愚弄。 [比以往任何时候都要多的关于统计置信度的信息](https://en.wikipedia.org/wiki/Confidence_interval).
