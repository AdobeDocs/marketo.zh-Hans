...
通过此项目 [仪表板](http://docs.marketo.com/display/docs/email+programs) ，了解您的电子邮件视图。
...
这将显示整体参与 [情况得分](../../../../product-docs/email-marketing/drip-nurturing/reports-and-notifications/understanding-the-engagement-score.md)。
...
>[!TIP]
>
>上例 **中的** “取消订阅”率太小，Market放大后可为您提供更好的外观。 该条中的第二个数字仅用于缩放。
...
>
>**单击以打开** ，度量已打开和已在电子邮件中点击链接的电子邮件的百分比。 我们将唯一点击次数除以唯一打开次数，再乘以100将其显示为百分比。
