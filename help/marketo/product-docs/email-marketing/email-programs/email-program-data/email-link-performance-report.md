...
description: 了解如何创建和使用电子邮件链接性能报表。 查看电子邮件中每个链接的点击和参与情况。
title: 电子邮件链接性能报告
...
1. 双击&#x200B;**[!UICONTROL Settings]**&#x200B;下的&#x200B;**[!UICONTROL Date of Activity]**。
...
>[!TIP]
>
>如果您想确切了解个人做了什么，可以从计划的“成员”选项卡的[个人详细信息](/help/marketo/product-docs/core-marketo-concepts/smart-lists-and-static-lists/managing-people-in-smart-lists/using-the-person-detail-page.md)页面中打开[活动日志](/help/marketo/product-docs/core-marketo-concepts/smart-lists-and-static-lists/managing-people-in-smart-lists/filter-activity-types-in-the-activity-log-of-a-person.md)。
