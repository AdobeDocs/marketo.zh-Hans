...
创建电子邮件程序后，您将需要告诉它要将电子邮件发送到的收件人。 您可以执行以下操作来实现此目标 [创建智能列表](/help/marketo/product-docs/core-marketo-concepts/smart-lists-and-static-lists/creating-a-smart-list/create-a-smart-list.md) 或通过导入列表的方式。 以下是如何通过导入列表来实现此目的。
...
>
>使用 ![—](assets/image2014-10-23-16-3a32-3a36-1.png) 上的按钮 **受众** 图标以查看根据智能列表条件有资格接收电子邮件的人员数量。 从人员编号中减去阻止的编号，即可获得接收电子邮件的总人数。
