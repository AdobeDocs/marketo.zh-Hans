...
向您的新Marketo朋友（电子邮件程序）问好。 在一个位置发送电子邮件、创建A/B测试和跟踪您的所有结果。

## 控制面板 {#control-panel}

四个盒子让你保持专注。 **Audience** 定义“谁” **电子邮件** 提供“什么” **计划** 定义“何时”，以及 **批准** 让它准备就绪。

![](assets/emailprogram.png)

## A/B测试 {#a-b-testing}

通过A/B测试，您可以证明哪种电子邮件效果最佳。
...
电子邮件程序可以很好地与其他程序配合使用。

![](assets/image2015-4-27-11-3a49-3a22.png)

例如，使用电子邮件程序发送网络研讨会邀请。

![](assets/image2015-4-27-12-3a20-3a40.png)

在默认程序中使用电子邮件程序使事务保持井然有序。

>[!TIP]
>
>要将现有电子邮件程序放入另一个程序，您必须克隆该程序。
