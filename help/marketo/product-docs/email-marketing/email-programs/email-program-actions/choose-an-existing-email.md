...
1. 在 **电子邮件** 磁贴，选择要发送的磁贴。

   ![](assets/image2014-9-12-11-3a28-3a10.png)

   >[!NOTE]
   >
   >只能选择本地电子邮件。 是否需要将电子邮件从一个程序移动到另一个程序？ [在此处了解详情](/help/marketo/product-docs/email-marketing/email-programs/email-program-actions/move-an-email.md).
