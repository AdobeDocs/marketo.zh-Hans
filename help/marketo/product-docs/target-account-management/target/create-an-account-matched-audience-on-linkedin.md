...
description: 在LinkedIn - Marketo文档 — 产品文档中创建与帐户匹配的受众
title: 在LinkedIn上创建与帐户匹配的受众
...
# 在LinkedIn上创建与帐户匹配的受众 {#create-an-account-matched-audience-on-linkedin}

从TAM帐户列表中为 [linkedIn广告定位](https://business.linkedin.com/marketing-solutions/ad-targeting/account-targeting). linkedIn会将该列表与其系统中的帐户相匹配，您可以基于该帐户列表创建LinkedIn受众，以便跨LinkedIn渠道激活。 这样，营销人员便可以定位数据库内或数据库外的人员。
