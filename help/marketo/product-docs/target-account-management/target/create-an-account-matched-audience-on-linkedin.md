...
从您的TAM帐户列表中为创建帐户匹配受众 [linkedIn广告定位](https://business.linkedin.com/marketing-solutions/ad-targeting/account-targeting). linkedIn会将该列表与其系统中的帐户进行匹配，您可以根据该帐户列表创建一个LinkedIn受众，以在各个LinkedIn渠道中激活。 这允许营销人员定位数据库内或数据库外的人员。
...
1. 单击 **帐户列表操作** 下拉并选择 **通过AdBridge发送**.
...
1. 单击 **受众** 下拉菜单。 您可以选择现有受众，也可以创建新受众。 在本例中，我们将创建一个新受众（如果您选择现有受众，请跳至步骤7）。
