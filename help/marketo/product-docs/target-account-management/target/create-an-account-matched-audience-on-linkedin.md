...
description: 在LinkedIn上创建与帐户匹配的受众 — Marketo文档 — 产品文档
title: 在LinkedIn中创建与帐户匹配的受众
...
# 在LinkedIn中创建与帐户匹配的受众 {#create-an-account-matched-audience-on-linkedin}

从您的TAM帐户列表中为[LinkedIn广告定位](https://business.linkedin.com/marketing-solutions/ad-targeting/account-targeting)创建匹配的帐户受众。 linkedIn会将该列表与其系统中的帐户进行匹配，您可以根据该帐户列表创建一个LinkedIn受众，以在各个LinkedIn渠道中激活。 这允许营销人员定位数据库内或数据库外的人员。
...
1. 单击&#x200B;**帐户列表操作**&#x200B;下拉列表，然后选择&#x200B;**通过AdBridge发送**。
...
1. 单击&#x200B;**受众**&#x200B;下拉列表。 您可以选择现有受众，也可以创建新受众。 在本例中，我们将创建一个新受众（如果您选择现有受众，请跳至步骤7）。

   ![](assets/create-a-matched-audience-on-linkedin-5.png)

1. 单击&#x200B;**广告帐户**&#x200B;下拉列表并选择目标广告帐户。
