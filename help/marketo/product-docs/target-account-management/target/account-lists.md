...
>[!NOTE]
>
>在[Web Personalization](/help/marketo/product-docs/web-personalization/using-web-segments/web-segments.md)中构建智能列表和Web营销活动时，在Marketo [!UICONTROL Target Account Management]中创建的帐户列表会自动可用。
