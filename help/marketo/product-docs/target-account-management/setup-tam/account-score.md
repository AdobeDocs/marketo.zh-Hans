...
这是一种系统化的方法，旨在帮助销售和营销团队确定最有可能购买的公司（包括潜在客户）并确定其优先级。

在B2B购买流程的复杂世界中，很少有人做出购买决定。 通常涉及各种角色，每个角色都有自己的需求。 基于帐户的评分通过汇总多个潜在客户的潜在客户得分并在帐户级别提供得分来考虑这一点。
...
<table> 
 <tbody>
  <tr>
   ...
   <td>参与度深度基于特定目标帐户中人员在各种渠道（如电子邮件、Web和广告）中跟踪的行为活动。</td>
  </tr>
  <tr>
   <td><strong>帐户产品兴趣分数</strong></td>
   <td>Target帐户中的人员对特定产品的内容表现出兴趣（例如，下载白皮书）。</td> 
  </tr>
  <tr>
...
>[!NOTE]
>
>要计算帐户得分，您首先需要创建潜在客户得分。 Marketo TAM会自动将商机得分聚合到帐户分数。 例如，我们将以上述两个示例为例(_帐户产品兴趣分数_ 和 _帐户Web参与度分数_)。
>
>首先，创建商机得分字段，以从目标帐户的每个商机中捕获相关详细信息。\
