...
description: 了解Marketo Engage中的Web个性化术语表，包括dnl Web个性化术语表。 使用本指南完成您的下一步。
title: Web 个性化术语表
...
| 术语 | 定义 |
|---|---|
| **匿名访客** | 从未填写表单或在网站上留下个人信息的 web 访客。 |
| **Web营销活动** | 与特定区段关联的定制化反应 利用Web Personalization，Web营销活动包括对话、位于区域和小组件中。 |
...
| **拆分测试** | 一种包含两个或更多变量的测试试验，用于衡量结果差异。 其目标是找出可提升或最大化预期结果的网页更改。 |
