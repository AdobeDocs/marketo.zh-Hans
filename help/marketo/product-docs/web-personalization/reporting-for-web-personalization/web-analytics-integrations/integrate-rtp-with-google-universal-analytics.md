...
description: 了解如何使用将rtp与dnl google集成，在Marketo Engage中将rtp与google universal analytics集成。 使用本指南完成您的下一步。
title: 将 RTP 与 Google Universal Analytics 集成
