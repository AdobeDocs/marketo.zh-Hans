...
1. 登录到Google Analytics。 单击 **报告** 在顶部菜单中。 单击 **仪表板** 和 **+新建自定义功能板**.
...
它按行业、收入、规模、基于帐户的列表和目标区段提供访问源和现场行为等信息。
...
1. 创建一个名为的新功能板 **RTP B2B仪表板** 和定义以下构件：
  ...
  <tr> 
   <td> 
    <ul> 
     ...
     <li>分组依据：事件标签</li> 
     <li>透视依据：默认渠道分组</li> 
     <li>筛选条件： <br>仅显示 |事件类别（包含） RTP段</li> 
  ...
  <tr> 
   <th> 
    <ul> 
     ...
     <li><strong>创建条形图显示：会话</strong></li> 
   ...
   <th> 
    <ul> 
     ...
     <li><strong>创建饼图以显示：会话</strong></li> 
...
利用此功能板，用户可分析其RTP促销活动绩效和推荐引擎参与。 它提供了平均值的比较。 会话持续时间和每个会话的页数介于：

* 未参与
* 已参与（个性化营销活动的展示次数和点击次数）
* 推荐引擎和顶级推荐内容的点击量

创建一个名为的新功能板 **RTP参与仪表板** 和定义以下构件：
...
<table> 
 ...
 <tbody> 
  <tr> 
   ...
   <td> 
    <ul> 
     ...
     <li>筛选条件： <strong>[only show]页面（包含）： rcmd</strong></li> 
  ...
  <tr> 
   ...
   <td colspan="1"> 
    <ul> 
     ...
     <li>过滤器：<br>筛选条件： <strong>[only show]页面（包含）： rcmd</strong></li> 
  ...
  <tr> 
   <td> 
    <ul> 
     <li>名称： <strong>按CTA显示的展示次数</strong></li> 
