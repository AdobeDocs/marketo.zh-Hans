...
要编辑表单主题的CSS，请参阅 [此文章](../../../product-docs/demand-generation/forms/form-design/edit-the-css-of-a-form-theme.md)。
...
1. 单 **击预览** ，以查看它在活动中的呈现方式(表单不会显示在编辑器视图中)。 下面是一个示例，说明上面的表单代码如何在具有背景图像的活动中呈现。
