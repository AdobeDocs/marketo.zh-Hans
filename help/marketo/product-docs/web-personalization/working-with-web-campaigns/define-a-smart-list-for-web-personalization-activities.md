...
# 为Web个性化列表定义智能活动 {#define-a-smart-list-for-web-personalization-activities}
...
1. 在智能活动中，单击“智 **能列表** ”选项卡。
   ...
   >
   >
   >聪明的列表可以做令人惊叹的事情。 通过智能列表深 [入了解更多信息](../../../product-docs/core-marketo-concepts/smart-campaigns/understanding-smart-campaigns.md)。
