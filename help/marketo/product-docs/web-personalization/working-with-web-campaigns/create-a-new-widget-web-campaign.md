...
description: 使用扩展和合同功能创建在网页垂直侧显示为固定文本或横幅的小部件Web营销活动。 自定义位置、颜色、动画和显示设置。
...
<table>
 ...
 <tbody>
  ...
  <tr>
   ...
   <td colspan="1" rowspan="1">自定义小组件按钮本身。<br>箭头：允许您从右侧下拉菜单中的多个不同图标中进行选择。 左侧下拉列表决定其颜色。<br>自定义：插入任何托管图像的URL。 接受的文件类型 — .JPEG、.GIF（包括动画）、.PNG、.APNG、.SVG、.BMP。<br>文本：构件可以是文本 — 自定义其颜色、大小和字体。</td>
  </tr>
  <tr>
...
>[!NOTE]
>
>**要对Web营销活动进行A/B测试吗？** 一个或多个Web营销活动可以[A/B测试以获得最佳结果](/help/marketo/product-docs/web-personalization/working-with-web-campaigns/ab-test-your-web-campaign.md)。 通过使用[!UICONTROL Auto Tune]功能，平台会自动识别表现较好的营销活动，继续使用转化率最高的营销活动，并暂停其他营销活动。
