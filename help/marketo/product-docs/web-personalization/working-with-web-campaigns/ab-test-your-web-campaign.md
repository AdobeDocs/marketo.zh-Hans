...
要A/B测试您的个性化营销活动，您可以选择两个或更多营销活动，将它们关联到同一个&#x200B;**拆分测试**&#x200B;组，并选择&#x200B;**自动调整**&#x200B;以自动继续运行表现最佳的营销活动。

>[!TIP]
>
>如果您希望手动计算并查看哪个促销活动表现更好，请不要启用自动调整。
...
1. **保存**&#x200B;或&#x200B;**启动**&#x200B;营销活动。
   ...
   >[!TIP]
   >
   >选择&#x200B;**自动调整**&#x200B;将允许Web Personalization平台自动识别性能更好的拆分测试营销活动，并在暂停其他营销活动时继续使用转化率最高的营销活动。
...
1. 在&#x200B;**设置营销活动**&#x200B;页面中，选择&#x200B;**拆分测试**，然后从下拉列表中选择&#x200B;**组**。 选择&#x200B;**自动调整**。
...
1. 在&#x200B;**Web营销活动**&#x200B;中，您可以看到A/B图标表示的分割测试营销活动。
