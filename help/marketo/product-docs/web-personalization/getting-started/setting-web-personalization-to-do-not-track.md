...
在Web个性化和预测内容中，营销人员可以设置切换开关以指示是支持还是忽略浏览器的不跟踪(DNT)设置。 帐户的切换设置为默认关闭，这意味着应用程序不允许DNT。
...
1. 要禁用“执行DNT”切换并忽略浏览器的“请勿跟踪(DNT)”设置，请选择 **关闭** 在“荣誉DNT”下。
