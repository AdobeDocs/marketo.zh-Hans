...
description: 了解如何使用登录和用户管理在Marketo Engage中登录和用户管理。 使用本指南完成您的下一步。
title: 登录与用户管理
...
1. 单击 **[!UICONTROL Roles]**。
   ...
   >[!NOTE]
   >
   >如果Web Personalization (WP)用户角色已存在，请确保按照步骤4中的说明对其进行配置。

1. 单击 **[!UICONTROL New Role]**。

   ![](assets/three-1.png)

1. 输入[!UICONTROL Role Name]并选择[!UICONTROL Permissions]。 单击&#x200B;**[!UICONTROL Create]** （此角色必须[应用于所有工作区](/help/marketo/product-docs/administration/users-and-roles/edit-user-workspaces.md)）。
