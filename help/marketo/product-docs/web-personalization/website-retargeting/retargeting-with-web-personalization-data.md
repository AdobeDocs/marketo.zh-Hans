...
>[!AVAILABILITY]
>
>网站重定位现在归入“Web个性化”拼贴下。 如果您只购买了重定位，您将看到此拼贴并通过访问Web个性化产品 **仅限** 已启用重新定位功能。 这让您能够访问帐户设置、重定位页面、区段和其他跟踪页面。
...
Web个性化将以下数据通过发送至再营销平台，以创建受众并运行再营销广告营销活动：
...
1. 激活Facebook的配置。 单击并展开Facebook折叠面板，单击 **开启** 以将相应的事件和数据发送到FacebookAudience Manager。 单击 **保存**.
...
1. 单击 **保存**.
   ...
   您现在已完成Web个性化中的重定位设置，登录到重定位平台，根据这些数据创建受众并设置重定位广告营销活动。
