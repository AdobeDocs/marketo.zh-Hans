...
>[!NOTE]
>
>包括Audience Manager和[!DNL Adobe Real-Time CDP Marketo Connecter]的集成可能需要Marketo Engage中的IMS组织映射。 [了解如何设置Adobe组织映射](/help/marketo/product-docs/adobe-experience-cloud-integrations/set-up-adobe-organization-mapping.md){target="_blank"}。
