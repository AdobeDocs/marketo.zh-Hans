...
>[!NOTE]
>
>这些集成(包括Audience Manager、B2B CDP Marketo Connector和Dynamic Chat)可能需要在Marketo Engage中映射IMS组织。 [在此处了解如何设置Adobe组织映射](/help/marketo/product-docs/adobe-experience-cloud-integrations/set-up-adobe-organization-mapping.md){target=&quot;_blank&quot;}。
