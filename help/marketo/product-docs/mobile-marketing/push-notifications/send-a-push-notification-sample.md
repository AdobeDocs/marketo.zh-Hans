...
1. 如果已设置要使用的测试设备，则只需从列表中选择该设备。
   ...
   或者，单击&#x200B;**添加设备**&#x200B;到[添加新的测试设备](/help/marketo/product-docs/mobile-marketing/push-notifications/adding-a-new-test-device.md)以将示例发送至。
...
1. 您可以通过两种方式将设备连接到应用程序。
   ...
   或者，使用第二个选项，单击&#x200B;**使用设备扫描二维码**&#x200B;按钮，然后使用您的设备扫描此二维码。 当状态显示连接时，单击&#x200B;**发送**。

   ![](assets/image2015-7-29-8-3a31-3a20.png)

   >[!TIP]
   >
   >是否成功添加了一个测试设备，但未在&#x200B;**发送至**&#x200B;字段中看到该设备？ 选中这些项以进行故障排除：
   >
