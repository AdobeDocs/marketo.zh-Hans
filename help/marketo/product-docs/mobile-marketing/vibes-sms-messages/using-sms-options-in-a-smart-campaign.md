---
description: 了解Smart Campaigns中的SMS触发器、过滤器和流程步骤。 使用访客短信活动和列表定位和触发营销活动。
...
>[!NOTE]
>
>如果您要发送短信消息，我们针对此内容发表了[特定文章](/help/marketo/product-docs/mobile-marketing/vibes-sms-messages/send-an-sms-message.md){target="_blank"}。
