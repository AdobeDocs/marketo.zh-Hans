...
1. 单击选色方块，然后通过单击按钮颜色或在拾色器上输入十六进制或RGB编号来选择按钮颜色。

   ![](assets/image2016-5-6-15-3a14-3a8.png)

1. 在下拉菜单中选择一个形状。 标准形状选项包括锐角、圆角和渐变。

   ![](assets/image2016-5-6-15-3a16-3a26.png)

1. 如果要对按钮使用您自己的图像，请单击“图像”按钮，然后单击 **选择图像**.
...
1. 单击选色方块，然后通过单击字体颜色或在拾色器中输入十六进制或RGB编号来选择字体颜色。
...
1. 单击每个平台的下拉列表，然后选择点按操作。
   ...
   >[!NOTE]
   >
   >按钮始终包含点按操作，因此会自动选中点按操作复选框，并显示默认消息“关闭消息”。
