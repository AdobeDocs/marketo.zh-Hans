...
1. 在您的表单中，选择隐藏字段并单击&#x200B;**[!UICONTROL Autofill]**&#x200B;的&#x200B;**[!UICONTROL Edit]**。
...
如果您将数据存储在Cookie中，则可以在提交表单时使用&#x200B;**[!UICONTROL Cookie Value]**&#x200B;获取数据。

1. 为&#x200B;**[!UICONTROL Get Value From]**&#x200B;选择&#x200B;**[!UICONTROL Cookie Value]**。
