...
When [创建表单](/help/marketo/product-docs/demand-generation/forms/creating-a-form/create-a-form.md)，则可以非常轻松地更改表单字段标签的位置。 这是方法。
...
干得好！ 了解更改表单上的标签位置有多容易？ 好，让我们看看我们可以如何更改表单标签的字体。
