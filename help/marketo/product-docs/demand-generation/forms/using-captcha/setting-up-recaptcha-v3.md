---
description: 了解如何为Marketo表单设置reCAPTCHA v3。 配置不可见的reCAPTCHA以抗击垃圾邮件而不阻止用户。
...
1. 向下滚动至 [!UICONTROL Support Information]。
...
>[!IMPORTANT]
>
>执行这些步骤并[在第一个Marketo表单](/help/marketo/product-docs/demand-generation/forms/using-captcha/enable-captcha-in-marketo-forms.md){target="_blank"}中启用CAPTCHA后，立即测试表单，因为reCAPTCHA设置中的任何错误配置都会破坏表单。
...
1. 单击[!UICONTROL CAPTCHA]设置上的&#x200B;**[!UICONTROL Edit]**。
...
1. 插入&#x200B;**[!UICONTROL Secret Key]**&#x200B;和&#x200B;**[!UICONTROL Site Key]**。 完成后，单击 **[!UICONTROL Save]**。
