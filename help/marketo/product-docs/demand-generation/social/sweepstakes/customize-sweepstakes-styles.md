...
当您[创建抽奖](/help/marketo/product-docs/demand-generation/social/sweepstakes/create-sweepstakes.md)时，您可以自定义抽奖在登陆页上的显示方式。
...
1. 在“抽奖”编辑器中，转至&#x200B;**App Settings** > **Appearance**。
...
1. 对于要自定义的每个元素，输入您的自定义CSS属性。
   ...
   **输入按钮**的图像示例：
   ...
   >[!NOTE]
   >
   >如果使用图像上带有文本，请记住从上面的“文本”下的&#x200B;**“输入按钮**”字段中删除文本。
