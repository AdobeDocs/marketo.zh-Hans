...
1. 配置将显示在Facebook帖子中的消息。
   ...
   如果选择&#x200B;**添加动态内容**，则页面的&#x200B;**OpenGraph**&#x200B;标记（og：title、og：caption和og：description）和缩览图的值会自动添加到Facebook帖子中。 查看下一步。

   如果选择&#x200B;**添加静态内容**，请输入标题、题注、描述并上传图像。 查看接下来的两个步骤。
...
如果您选择页面标签的值（og：title、og：caption和og：description），则会自动将缩览图添加到Facebook帖子。 查看下一步。

## 配置Twitter消息 {#configure-the-twitter-message}

1. 编辑将显示在Twitter推文中的共享提示和消息。

   ![](assets/image2014-9-22-14-3a2-3a31.png)

   >[!TIP]
   >
   >在推文文本中使用{html_title}自动显示页面的标题。
...
1. 如果选择了&#x200B;**“添加静态内容”**，请编辑标题和描述，然后(从&#x200B;[**“Marketo图像和文件”**](/help/marketo/product-docs/demand-generation/images-and-files/add-images-and-files-to-marketo.md)&#x200B;中)上传自定义图像。
...
>[!MORELIKETHIS]
>
>接下来，您可以单击&#x200B;**完成** > **批准并关闭**，并将您的社交应用程序放置在登陆页面上。 您还可以配置[人物捕捉](/help/marketo/product-docs/demand-generation/social/configuring-social-actions/configure-person-capture-for-a-social-app.md)或[重新共享提示](/help/marketo/product-docs/demand-generation/social/configuring-social-actions/configure-re-share-email-and-prompt-for-a-social-app.md)。
