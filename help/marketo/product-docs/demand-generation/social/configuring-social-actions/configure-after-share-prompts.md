...
在社交按钮、视频共享和投票应用程序中，您可以选择当有人在其社交网络上共享您的内容后会出现的情况。
...
1. 如果您选择 **电子邮件捕获** （而不是确认）：转到 **共享流** 然后 **电子邮件捕获**.

   ![](assets/image2015-4-21-12-3a46-3a15.png)

1. 选择是否包含营销提示，以及默认情况下是否选中该复选框(**选择禁用**)或不是(**选择加入**)。
