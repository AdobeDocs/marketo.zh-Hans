...
1. 要添加多个图像和文件，请浏览到计算机上正确的文件夹，然后按 **Ctrl/Cmd** ，然后单击要添加的每个文件，然后单击 **打开**.

   ![](assets/image2014-9-15-18-3a6-3a58.png)

1. 展开 **文件详细信息** 要验证您选择了正确的图像，请单击 **上传**.

   ![](assets/image2014-9-15-18-3a7-3a22.png)

   >[!NOTE]
   >
   >要在上传之前删除任何已排队的文件，请单击文件名旁边的x。
...
>[!NOTE]
>
>虽然Marketo接受所有文件类型以供上传，但只有主要图像类型(JPG、PNG、GIF等) 将在我们的电子邮件编辑器中工作。
