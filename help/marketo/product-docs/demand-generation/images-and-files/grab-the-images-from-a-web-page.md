...
# 从网页抓取图像 {#grab-the-images-from-a-web-page}

若要从网页添加图像，请复制包含所需图像的网页的网址(URL)，然后执行以下步骤。

1. 前往 **[!UICONTROL Design Studio]**。

   ![](assets/designstudio-2.png)

1. 单击&#x200B;**[!UICONTROL New]**&#x200B;和&#x200B;**[!UICONTROL Grab Images from Web]**。

   ![](assets/image2014-9-16-11-3a37-3a46.png)

1. 选择&#x200B;**[!UICONTROL Images and Files]**&#x200B;文件夹，将网址(URL)粘贴到URL文本框中，然后单击&#x200B;**[!UICONTROL Next]**。
...
1. 选择要添加的图像，然后单击&#x200B;**[!UICONTROL Import]**。
...
1. 您可以在&#x200B;**[!UICONTROL Images and Files]**&#x200B;中看到所有可用的图像。
