---
description: 在交互式网络研讨会上了解GenAI功能。 使用AI增强网络研讨会内容、摘要或参与。
title: GenAI功能
...
* **无缝集成**：通过将HTML代码复制到您选择的网页编辑器，向您的登陆页面添加章节和摘要。
...
接受Adobe GenAI条款和条件后，下一步是为个人用户启用它。 为此，请转到&#x200B;**[!UICONTROL Admin]** > **[!UICONTROL Interactive Webinars]**，并选择哪些用户应有权访问GenAI。
