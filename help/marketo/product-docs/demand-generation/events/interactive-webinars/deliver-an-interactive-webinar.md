---
description: 了解如何在Marketo中举办交互式网络研讨会。 运行实时活动并使用参与工具与与会者联系。
title: 举办互动网络研讨会
...
1. 选择要向早期加入者显示的布局。
   ...
   >[!NOTE]
   >
   >参与者最多可以在计划开始前15分钟进入文件室，并看到活动布局。 建议为他们设计“大厅”布局。

   >[!TIP]
   >
   >启用广播控制以进入虚拟的绿色房间。 这样，主持人和演示者就可以私下交谈并相互交谈，而不用向房间中的参与者广播音频和视频。 它非常适合在会议前后使用，您可以在其中测试音频和视频，或在网络研讨会后进行汇报。
...
Broadcast Control会向交互式网络研讨会会话添加一个虚拟的绿色空间。 它使主持人和主持人能够私下交谈和见面，而不向房间中的参与者广播。 在会话开始前使用此工具测试麦克风和网络摄像头。 演示者还可以在主持人和演示者区域中进行协作，直到他们准备好上线为止。 它为演讲者和制作者在会议结束后私下相互汇报情况提供了一种方法，以防与会者忘记离开网络研讨会。
