---
description: 了解如何在Marketo中设计交互式网络研讨会。 规划内容、布局和参与元素以获得有效的网络研讨会体验。
title: 设计交互式网络研讨会
...
1. 您可以选择现有的网络研讨会聊天室或创建新聊天室。 在此示例中，我们正在创建一个新会议室，因此请单击&#x200B;**选择会议室**&#x200B;下拉菜单并选择&#x200B;**新建交互式网络研讨会会议室**。
   ...
   >* 会议室是用于举行会议的在线空间。
   >
   >* 如果您选择现有的网络研讨会聊天室并需要对其进行重命名，请单击右侧的&#x200B;**重命名网络研讨会聊天室**&#x200B;按钮。
   >
...
1. 您可以立即或稍后优化您的网络研讨会。 若要立即继续，请单击&#x200B;**立即优化您的网络研讨会**。
...
1. 有关会议室和模板的详细信息，请参阅[此Adobe帮助文章](https://helpx.adobe.com/in/adobe-connect/using/creating-arranging-meetings.html#creating_and_arranging_meetings){target="_blank"}的“会议室模板和布局”部分。
