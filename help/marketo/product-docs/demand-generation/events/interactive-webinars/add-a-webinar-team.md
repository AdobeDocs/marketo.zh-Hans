---
description: 了解如何在交互式网络研讨会中添加网络研讨会团队。 分配团队成员以帮助创建、管理或举办网络研讨会。
title: 添加网络研讨会团队
...
1. 您可以添加内部或外部用户。 在本例中，我们将选择外部。
   ...
   >[!NOTE]
   >
   >如果选择&#x200B;**内部交互式网络研讨会用户**，则必须单击&#x200B;**可用主机**&#x200B;下拉列表，并从已添加为Marketo Engage中的交互式网络研讨会用户的人员列表中进行选择。 现有主机将无法在此下拉列表中看到自身，因为它们已经是主机。
