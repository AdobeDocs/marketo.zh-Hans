...
首先在级别3中创建网络研讨会。 如果需要帮助，请查看[第3级资源库](https://www.level3.com/en/resource-library/)。 您会发现它与BrightTalk非常相似。  Marketo使用3级字段的一个小子集：
...
1. 选择您的新事件。 单击&#x200B;**事件操作，**，然后单击&#x200B;**事件设置。**

   ![](assets/image2016-3-24-15-3a40-3a39.png)

1. 在“活动伙伴”下，选择&#x200B;**第3级Web会议**。
