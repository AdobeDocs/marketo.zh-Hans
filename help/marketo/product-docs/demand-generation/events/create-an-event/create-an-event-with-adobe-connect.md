...
description: 了解如何在Marketo中使用Adobe Connect创建活动。 设置集成并同步注册和出勤数据。
...
>[!CAUTION]
>
>作为活动主持人，从应用程序内加入，**而不是**&#x200B;通过发送给与会者的链接加入。

>[!NOTE]
>
>目前不支持Adobe Connect On-Site。
...
1. 在新事件的主页上，选择&#x200B;**[!UICONTROL Event Actions]**，然后选择&#x200B;**[!UICONTROL Event Settings]**。
   ...
   >[!NOTE]
   >
   >如果您在下拉列表中未看到&#x200B;**[!UICONTROL Event Settings]**，请验证该事件的渠道是否已在“[!UICONTROL Applies to]”下选择&#x200B;**[!UICONTROL Event with Webinar]**。
...
1. 单击 **[!UICONTROL Save]**。
   ...
   您的Adobe Connect活动现在已与您的Marketo活动同步。
