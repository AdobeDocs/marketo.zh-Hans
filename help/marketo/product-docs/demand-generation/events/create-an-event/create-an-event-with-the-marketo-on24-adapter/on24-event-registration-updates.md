...
description: 了解ON24事件注册更新以及它们如何与Marketo同步。 在注册更改时，保持人员和项目群状态同步。
title: ON24 事件注册更新
...
Marketo每晚在太平洋时间晚上11点左右自动提取出席信息。 要手动更新出席信息，请单击&#x200B;**[!UICONTROL Event Actions]**&#x200B;下的&#x200B;**[!UICONTROL Refresh from Webinar Provider]**。
