...
输入网络研讨会的以下信息，网络研讨会将通过适配器拉入Marketo。 如果对此信息进行任何更改，则必须单击链接“**从网络研讨会提供商刷新**“” **事件操作**，以便Marketo查看更改。
...
>[!TIP]
>
>如果您需要其他GoTo网络研讨会帮助，请访问他们的 [帮助网站](https://support.logmeininc.com/gotowebinar).
