...
1. 从您的Marketo实例中选择最多50个属性（标准或自定义字段）以同步到Dynamic Chat，用于受众定位、数据映射和个性化。 完成后单击&#x200B;**[!UICONTROL Next]**。
...
1. 在&#x200B;**[!UICONTROL Integrations]**&#x200B;中，确保选择&#x200B;**[!UICONTROL Adobe Marketo Engage]**&#x200B;选项卡并单击&#x200B;**[!UICONTROL Add Attribute]**。
...
1. 在&#x200B;**[!UICONTROL Integrations]**&#x200B;中，确保选中&#x200B;**[!UICONTROL Adobe Marketo Engage]**&#x200B;选项卡，然后单击要删除的属性。
