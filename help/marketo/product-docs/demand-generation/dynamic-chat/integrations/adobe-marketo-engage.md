...
1. 从您的Marketo实例中选择最多50个属性（标准或自定义字段）以同步到Dynamic Chat，以用于受众定位、数据映射和个性化。 单击 **[!UICONTROL 下一个]** 完成时。
...
1. 在 **[!UICONTROL 集成]**，确保 **[!UICONTROL Adobe Marketo Engage]** 选项卡，然后单击 **[!UICONTROL 添加属性]**.

   ![](assets/adobe-marketo-engage-6.png)

1. 选择要添加的属性并单击 **[!UICONTROL 下一个]**.

   ![](assets/adobe-marketo-engage-7.png)

1. 查看您的选择并单击 **[!UICONTROL 确认]**.
...
1. 在 **[!UICONTROL 集成]**，确保 **[!UICONTROL Adobe Marketo Engage]** 选项卡中，然后单击要删除的属性。
