...
[创作AI](/help/marketo/product-docs/demand-generation/dynamic-chat/generative-ai/overview.md){target="_blank"} 在Adobe Dynamic Chat中，实时处理意图信号、用户偏好和过去行为，以便为聊天访客生成相关的个性化消息。
