...
description: 了解如何将Google Customer Match添加为LaunchPoint服务。 将Marketo受众发送到Google，以便在AdWords、YouTube、Search和Gmail上进行定位。
...
1. 输入&#x200B;**[!UICONTROL Display Name]**&#x200B;并从&#x200B;**[!UICONTROL Service]**&#x200B;下拉列表中选择&#x200B;**[!UICONTROL Google Customer Match]**。 单击 **[!UICONTROL Create]**。
...
1. 您的[!DNL Google AdWords]帐户现已连接到Marketo。 单击 **[!UICONTROL Create]**。
   ...
   Google匹配的受众现在作为[!DNL LaunchPoint]服务列在“已安装的服务”选项卡中。
