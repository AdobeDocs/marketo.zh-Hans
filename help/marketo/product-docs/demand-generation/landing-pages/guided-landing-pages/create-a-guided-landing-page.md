...
## 在程序中创建引导式登陆页面 {#create-a-guided-landing-page-in-a-program}

引导式登陆页面可以作为程序的本地资产创建，也可以在Design Studio中创建，以便在全局中使用。
...
1. 命名您的登陆页面。 单击 **模板** 下拉菜单并选择 **引导式模板**.

   >[!NOTE]
   >
   >引导式登陆页面模板具有 ![—](assets/image2015-5-26-9-3a26-3a51.png) 图标。 引导式模板的结构合理，可保持完全的响应能力。
...
>
>清除 **在编辑器中打开** 复选框（如果您不希望编辑器在单击后立即打开） **创建**.
