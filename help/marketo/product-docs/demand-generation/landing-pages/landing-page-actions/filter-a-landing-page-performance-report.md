...
description: 了解如何在Marketo中筛选登陆页面性能报表。 按日期、页面或其他标准缩小结果范围。
title: 筛选登录页面性能报告
...
1. 单击&#x200B;**[!UICONTROL Setup]**&#x200B;选项卡并拖入筛选器。

   ![](assets/image2014-9-18-15-3a46-3a16.png)

   * **[!UICONTROL Design Studio Landing Pages]：**&#x200B;全局资源，在[!UICONTROL Design Studio]中管理。
   * **[!UICONTROL Marketing Activities Landing Pages]：[!UICONTROL Marketing Activities]选项卡上程序中的**&#x200B;本地资源。
   * **[!UICONTROL Archived Landing Pages]：**&#x200B;个非活动、已弃用的登陆页面。
...
1. 完成了！ 单击&#x200B;**[!UICONTROL Report]**&#x200B;选项卡以查看已过滤的报告。
