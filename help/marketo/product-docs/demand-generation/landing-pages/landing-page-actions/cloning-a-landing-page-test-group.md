...
1. 在对话框底部，选择克隆的页面 **可用的登陆页面** 列表并单击指向右侧的箭头以将其包含在 **经过测试的登陆页面**. 对此组中需要的所有登陆页面执行此操作。
...
1. 准备好启动测试组后，右键单击树中的组并选择 **批准测试组**.

   ![](assets/image2015-4-27-16-3a19-3a10.png)

   该组现在将积极跟踪访问次数和表单完成情况，以便您能够查看哪个登陆页面的表现最佳。
