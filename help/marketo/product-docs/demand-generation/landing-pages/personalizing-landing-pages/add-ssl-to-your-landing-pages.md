...
当您填写Web表单或访问由Marketo托管的登陆页时，默认情况下，信息会通过非安全协议(HTTP)发送。 根据公司的策略，您可能希望通过(HTTPS)保护提交到Marketo的信息。 例如，当您访问时， `http://info.mydomain.com/` 它现在将是 `https://info.mydomain.com/`。
...
有关将SSL添加到登陆页的常见问题解答，请参 [阅此文章](http://nation.marketo.com/docs/DOC-5612)。
