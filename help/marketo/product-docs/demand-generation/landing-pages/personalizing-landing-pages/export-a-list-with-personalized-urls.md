...
1. 选择列表或智能列表，单击 **潜在客户** 选项卡以获取结果，然后单击excel图标。 INLINE确保您具有 **Marketo唯一代码** 和 **Marketo唯一名称** [列可见](/help/marketo/product-docs/core-marketo-concepts/smart-lists-and-static-lists/using-smart-lists/create-and-change-views-for-lists-and-smart-list.md).

   ![](assets/image2014-9-25-11-3a10-3a43.png)

1. Check **包括个性化URL**，查找并选择要为其生成PURL的登陆页面。
