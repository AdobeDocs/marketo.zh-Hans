...
# 将视频添加到自由格式的登陆页面 {#add-a-video-to-a-free-form-landing-page}
...
1. 选择 **新建** 下拉菜单中。
   ...
   >[!NOTE]
   >
   >此 **新建** 功能仅显示在营销活动中；但在Design Studio中不可用。 Design Studio中只有已创建的视频可用。 但是，您可以创建视频共享 _在计划内_ 通过选择 **新** > **新建本地资产**. 然后，您可以从下拉菜单中选择它，如下所示。
