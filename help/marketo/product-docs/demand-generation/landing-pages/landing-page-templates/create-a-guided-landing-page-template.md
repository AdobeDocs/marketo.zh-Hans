...
示例：`<div class="mktoText" id="exampleText" mktoName="Main Body Text"> Optionally add default text for the editable text area.</div>`
...
示例：`<div class="mktoImg" id="exampleImg" mktoName="Example Image"></div>`
...
示例：`<img class="mktoImg" id="exampleImg" mktoName="Example Image">`

>[!NOTE]
>
>使用`<img>`版本时，渲染的HTML将在`<img>`标记周围包含生成的div包装器。 它将设置为类“mktoImg mktoGen”，并将显示:inline-block。
...
示例：`<div class="mktoForm" id="exampleForm" mktoName="Example Form"></div>`
...
示例：`<div class="mktoSnippet" id="exampleSnippet" mktoName="Example Snippet"></div>`
...
示例：`<div class="mktoShareButton" id="exampleShareButton" mktoName="Example Share Button"></div>`
...
示例：`<div class="mktoVideo" id="exampleVideo" mktoName="Example Video"></div>`
...
基本示例： `<meta class="mktoString" id="var1" mktoName="My Variable">`

具有所有属性的示例： `<meta class="mktoString" id="var1" mktoName="My Variable" default="This is my default value" allowHtml="true">`
...
基本示例： `<meta class="mktoColor" id="color1" mktoName="My Color Variable">`

具有所有属性的示例： `<meta class="mktoColor" id="color" mktoName="My Color Variable" default="#336699">`
...
基本示例： `<meta class="mktoBoolean" id="boolean1" mktoName="My Boolean Variable">`

具有所有属性的示例： `<meta class="mktoBoolean" id="boolean1" mktoName="My Boolean Variable" default="false" true_value="block" false_value="none" true_value_name="Show" false_value_name="Hide">`

以下示例显示了一个常见用例，其中布尔变量通过将css display属性的值设置为“block”或“none”来控制css元素的可见性，从而使用CSS按ID显示/隐藏元素。 登陆页面编辑器将使用显示名称Show/Hide而不是OFF/ON。
