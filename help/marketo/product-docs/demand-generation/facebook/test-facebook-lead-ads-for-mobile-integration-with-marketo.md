...
description: 了解如何测试Facebook Lead Ads与Marketo的移动集成。 验证来自移动同步的潜在客户广告提交是否正确。
...
1. 在[!UICONTROL Facebook Power Editor]中，选择营销活动和广告，然后单击&#x200B;**[!UICONTROL Edit]**。

1. 在&#x200B;**[!UICONTROL Links]**&#x200B;下，单击&#x200B;**[!UICONTROL View on mobile app]**&#x200B;链接。

   ![](assets/image2016-5-13-15-3a2-3a38.png)

1. 将向你可以通过授权帐户在移动设备上访问的[!DNL Facebook]帐户发送新通知。 单击 **[!UICONTROL OK]**。
...
1. 在通知中，点按&#x200B;**[!UICONTROL Your ad is ready to preview]**。

   ![](assets/image2016-3-11-8-3a41-3a59.png)

1. 通过点按Call to action并填写您创建的表单，提交您的测试潜在客户广告单元。
