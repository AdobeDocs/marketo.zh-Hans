...
description: Publish登录页面到Facebook - Marketo文档 — 产品文档
title: Publish登录页面到Facebook
...
1. 选择要发布登陆页面的&#x200B;**Facebook页面**，并输入Marketo登陆页面应显示的名称。

   ![](assets/image2015-4-22-18-3a31-3a39.png)

   >[!NOTE]
   >
   >要替换您之前发布到Facebook的Marketo登陆页面，请选择&#x200B;**替换现有选项卡**，然后从下拉列表中选择要替换的选项卡。 请注意，这不会替换非Marketo选项卡。
