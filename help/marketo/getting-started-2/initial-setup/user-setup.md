...
现在您已完成了所有 [初始设置任务](/help/marketo/getting-started-2/initial-setup/initial-setup-tasks.md)，现在需要建立一些基本元素以确保顺利进行使用。 这将为您的Marketo Engage旅程奠定基础，并帮助您充分利用其功能。 让我们开始吧！

>[!NOTE]
>
>您还可以下载核对清单 [插入链接] 并随时检查步骤。
...
现在您的Marketo Engage帐户已准备就绪，请查看我们的 [新Marketo Engage实例的最佳实践](/help/marketo/getting-started-2/implementing-a-new-marketo-engage-instance/where-to-start.md) 充分利用您的投资并为长期成功做好准备。
