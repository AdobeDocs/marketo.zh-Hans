...
带有“lead”字样的令牌&#x200B;**未更改**。 我们为任何混淆表示歉意；但是，更改所有令牌以匹配新术语将破坏当前使用的大量令牌。 因此，您仍将看到令牌，如“`{{lead.First Name}}`”。 没有特定于个人的令牌。

>[!NOTE]
>
>*是*&#x200B;一个名为“Person Notes”的令牌，但该令牌始终存在。 它通常用于CRM中的描述字段（如果有）。
...
>[!NOTE]
>
>有关受影响的字段名称的完整列表，请访问此[支持文章](https://nation.marketo.com/docs/DOC-4218#jive_content_id_Field_Names_and_Tokens)。
...
|---|---|
| ** [基于帐户的Web营销](http://docs.marketo.com/display/DOCS/Account-Based+Web+Marketing)** | 可通过Web个性化拼贴访问 |
| ** [个性化重定位](http://docs.marketo.com/display/DOCS/Website+Retargeting)** | 可通过Web个性化拼贴访问 |
| ** [预测内容](http://docs.marketo.com/display/DOCS/Predictive+Content)** | 在主屏幕上有自己的拼贴 |
