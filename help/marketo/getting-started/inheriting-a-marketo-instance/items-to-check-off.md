...
description: 要签出的项目 — Marketo文档 — 产品文档
title: 要签出的项目
...
确保您正确设置了正确的访问和信息。 执行这些简单步骤，以便您立即从待办事项列表中查看一些内容！

* 观看的简短概述 [**Marketo的功能**](https://pages2.marketo.com/demoFull.html){target="_blank"}.

* **设置配置文件** 在 [**营销国家/地区**](https://nation.marketo.com/){target="_blank"} 社区（需要用户名和密码）。

* 了解如何与 [**营销国家/地区**](https://nation.marketo.com/t5/About-Community/ct-p/about-community){target="_blank"} 社区以获取问题的答案。
