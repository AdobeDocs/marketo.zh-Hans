...
<br/>如果是，您的“Adobe Admin Console系统管理员”是否向您授予“Adobe Admin Console产品管理员”角色？ 如果您不确定贵组织中的哪些人具有控制台中的管理员权限，请联系<a href="https://helpx.adobe.com/cn/contact.html" target="_blank">Adobe客户关怀团队</a>。</li>
...
<br/>如果不能，请确保在Adobe Admin Console中<a href="/help/marketo/product-docs/administration/users-and-roles/add-or-remove-a-user.md" target="_blank">添加和/或删除Marketo Engage产品配置文件中的用户</a>。 如果已将用户添加到产品配置文件，则无法在Marketo Engage &gt;管理员&gt;用户和角色中分配用户角色。</li>
...
<table>
 <tbody>
  ...
  <tr>
   ...
   <p>
   <li>有多少用户？</li>
<li>是否有任何应<a href="/help/marketo/product-docs/administration/users-and-roles/add-or-remove-a-user.md#remove-a-user" target="_blank">移除</a>的用户？</li>
...
<table style="table-layout:auto">
 <tbody>
  ...
  <tr>
   ...
   <br/>如果没有，请考虑添加一个。 我们建议将Smart Campaign限制为数据库的25%，以避免在工作流程中过度通信或处理整个数据库；这不仅可以保护您的品牌，还有助于保护实例的性能。</li></td>
  </tr>
 </tbody>
</table>
...
<p><img src="assets/note-icon.png" alt="注释图标"> 注意：请联系Adobe支持以确定自定义同步筛选器或请求实施自定义同步规则。</li></td>
  </tr>
  <tr>
   <td>登陆页面</td>
...
<br/>确认您的登陆页面资产是否包含“http”URL。</li></td>
  </tr>
  <tr>
   <td>Munchkin</td>
...
<p><img src="assets/tip-icon.png" alt="提示图标">提示：如果您缺少有关munchkin代码在您网站上的位置的文档，则可以通过创建<a href="/help/marketo/product-docs/reporting/basic-reporting/report-types/web-page-activity-report.md" target="_blank">网页活动报告</a>来查看所有URL。</li></td>
  </tr>
  <tr>
   <td>Web服务</td>
...
<li>您是否达到或接近达到API限制？
<br/>如果是，请考虑增加它或审核您的实例以停止这些API调用。</li></td>
  </tr>
  <tr>
...
     如果没有，您可以在Dynamic Chat</a>中<a href="/help/marketo/product-docs/demand-generation/dynamic-chat/setup-and-configuration/permissions.md#edit-existing-permissions" target="_blank">编辑它们。 您还可以<a href="/help/marketo/product-docs/demand-generation/dynamic-chat/setup-and-configuration/permissions.md#create-a-profile" target="_blank">创建具有自定义权限集的自定义配置文件</a>。</li>
