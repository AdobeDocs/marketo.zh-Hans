...
>[!TIP]
>
>如果您 [打印此核对清单](/help/marketo/getting-started/setup-steps/setup-checklist.md){target=&quot;_blank&quot;}，您可以在完成项目时将其签出。
...
祝贺您！你现在在Marketo，可以开始探索。 您可能希望邀请您营销团队的同事加入您。 您可以通过添加新用户来执行此操作。
...
>[!TIP]
>
>对于短期外部利益相关方或顾问而言，过期日期非常有用，他们只需在短时间内访问Marketo。

>[!NOTE]
>
>到达过期日期后，用户会收到过期通知，并且帐户已锁定。
...
要检索将要替换为登陆页面CNAME的帐户字符串，请转到“管理员”区域。
...
所有设置步骤都结束。 只剩下一样东西，就是潜入使用Marketo!
