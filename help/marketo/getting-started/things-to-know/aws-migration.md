...
有关最新信息，请将此页加入书签。 要在迁移开始和完成时接收状态更新，但[您必须订阅](https://experienceleague.adobe.com/en/docs/marketo/using/getting-started/things-to-know/system-status-notifications){target="_blank"}才能接收这些更新。 您也可以访问https://status.adobe.com/。
