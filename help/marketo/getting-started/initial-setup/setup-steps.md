...
* 为您的登陆页面 URL 和电子邮件链接设置品牌化域名，以提升可信度和投递成功率
* 为 Marketo Engage 配置相关协议
* 同步您的 CRM 系统
* 将跟踪代码添加到您的公司网站
...
前半部分即为电子邮件跟踪 CNAME，即 `[EmailTrackingCNAME]`。 您需要将该信息提供给 IT 团队。
...
要获取将由登陆页面 CNAME 替换的 Munchkin ID，请前往&#x200B;**管理员**&#x200B;区域。
...
收集完所有必要信息后，即可向IT部门发送请求。 您可以使用下面的文本作为模板，将其中加粗的内容替换为您自己的信息。
...
`1)`对于我们的登陆页面，请添加&#x200B;**[LandingPageCNAME]**.**[CompanyDomain]**.com的DNS条目(CNAME)，指向&#x200B;**[Munchkin ID]**.mktoweb.com。

`2)`对于电子邮件中的跟踪链接，请为&#x200B;**[EmailTrackingCNAME]**.**[CompanyDomain]**.com添加一个DNS条目(CNAME)，指向&#x200B;**[MktoTrackingLink]**。
...
这可能是整个设置过程中最令人期待的部分。 现在该在Marketo中填充您存储在CRM中的所有商机和联系人了！

根据您公司使用的 CRM，从以下选项中进行选择。

* [将 Marketo Engage 与  [!DNL Salesforce.com] 集成](/help/marketo/product-docs/crm-sync/salesforce-sync/understanding-the-salesforce-sync.md)
* [将 Marketo Engage 与  [!DNL Microsoft Dynamics] 集成](/help/marketo/product-docs/crm-sync/microsoft-dynamics-sync/understanding-the-microsoft-dynamics-sync.md)
...
Marketo Engage 提供了自定义的跟踪 JavaScript（称为 [!DNL Munchkin]），可用于跟踪任意网页上的用户活动。 要将您的网站集成到 Marketo 中，必须使用 [!DNL Munchkin]。 请按照以下步骤操作：[将 [!DNL Munchkin] 跟踪代码添加到您的网站](/help/marketo/product-docs/administration/additional-integrations/add-munchkin-tracking-code-to-your-website.md){target="_blank"}。

>[!NOTE]
>
>添加跟踪代码需要具备一定的 HTML 经验。
...
>[!MORELIKETHIS]
>
>* [为 Marketo Engage 配置协议](/help/marketo/getting-started/initial-setup/configure-protocols-for-marketo.md)
>
