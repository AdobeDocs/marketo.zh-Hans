...
>[!TIP]
>
>在此时，您可以单击“**[!UICONTROL 我的帐户]**”来更改您的帐户和位置设置，以及设置新的订阅名称。
...
选择一个角色，然后单击&#x200B;**[!UICONTROL 下一步]**。 标准用户有权访问除“管理员”之外的所有区域。
...
新用户现在列在&#x200B;**[!UICONTROL 用户]**&#x200B;选项卡中，应该会收到一封电子邮件，其中包含创建密码和登录的链接。 下一步！
...
在&#x200B;**[!UICONTROL 登陆页面的域名]**&#x200B;字段中输入您的新域名。 其形式应为：
...
在[!UICONTROL 管理员]区域，选择&#x200B;**[!UICONTROL 电子邮件]**&#x200B;以添加您的电子邮件CNAME
