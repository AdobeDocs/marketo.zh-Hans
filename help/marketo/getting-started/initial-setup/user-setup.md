...
>[!NOTE]
>
>您还可以下载此核对清单， [以及最佳实践列表](/help/marketo/getting-started/inheriting-a-marketo-engage-instance/assets/adobe-marketo-engage-new-instance-admin-checklist.xlsx) ，并在执行时查看相关步骤。
