...
<tbody>
  <tr>
    ...
    <li><a href="https://experienceleague.adobe.com/en/docs/marketo/using/product-docs/reporting/basic-reporting/editing-reports/change-a-report-time-frame">为报表使用相关的时间范围</a>（例如，YTD、最近90天等），以准确查看标准电子邮件参与和投放能力指标。</li>
  ...
  <tr>
    <td>人员绩效报表</td>
    <td><img src="assets/note-icon.png" alt="注释图标"> 注意：建议您为每个Marketo Engage实施都制定适当的<a href="https://experienceleague.adobe.com/en/docs/marketo/using/product-docs/core-marketo-concepts/programs/working-with-programs/understanding-tags">渠道和标记策略</a>，然后才能按渠道跟踪获得的人员和营销投资的ROI。
    <p>
