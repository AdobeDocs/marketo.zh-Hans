...
<tbody>
  ...
  <tr>
    <td>隐私和合规性</td>
    <td><li>保留您的表单 <a href="https://business.adobe.com/resources/ebooks/the-gdpr-and-the-marketer.html" target="_blank">通用数据保护条例(GDPR)</a> 合规。</li></td>
  </tr>
  <tr>
    <td>数据标准化</td>
...
<tbody>
  ...
  <tr>
    <td>隐私和合规性</td>
    <td><li><a href="https://experienceleague.adobe.com/en/docs/marketo/using/product-docs/email-marketing/general/functions-in-the-editor/add-a-snippet-to-an-email" target="_blank">添加代码片段</a> 以控制可重复使用的块，如版权年、全球位置和特定于法规遵从性的语言。</li>
    <li><a href="https://experienceleague.adobe.com/en/docs/marketo/using/product-docs/email-marketing/general/using-tokens/add-an-email-script-token-to-your-email" target="_blank">添加令牌</a> 根据目标受众对内容进行个性化。</li></td>
  </tr>
</tbody>
</table>
