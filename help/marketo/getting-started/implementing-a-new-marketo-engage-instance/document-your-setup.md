...
<tbody>
  <tr>
    ...
    <p>
    <li>作为Marketo Engage产品管理员，开发一个内部流程来定期审核和更新Marketo Engage用户列表。 要更改Adobe Admin Console中的用户列表，请考虑<a href="https://helpx.adobe.com/cn/enterprise/using/users.html" target="_blank">批量操作</a>，例如上传.CSV、使用用户管理REST API等</li></td>
  </tr>
  <tr>
    <td>组织</td>
  ...
  <tr>
    <td>与内部团队的对话</td>
    <td><li>使内部营销团队对Marketo Engage的期望与Marketo Engage的功能保持一致。</li>
    <li>确定在Marketo Engage实例中将成为您利益相关者的团队，并记录他们使用Marketo Engage作为技术要实现的目标。</li></td>
  </tr>
  <tr>
    <td>工作区和分区（如果适用）</td>
