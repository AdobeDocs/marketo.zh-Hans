...
<tbody>
  <tr>
    <td>列表导入</td>
    <td><li>收集将从中提取记录的数据源列表 <a href="https://experienceleague.adobe.com/en/docs/marketo/using/getting-started/quick-wins/import-a-list-of-people" target="_blank">导入到Marketo Engage</a>.</li>
...
<tbody>
  <tr>
    <td>用户</td>
    <td><li>记录 <a href="https://experienceleague.adobe.com/en/docs/marketo/using/product-docs/administration/marketo-with-adobe-identity/add-or-remove-a-user#add-a-user" target="_blank">当前用户</a> 出于安全原因，在您的实例中。 以下详细信息应至少包含在内（通过转至“管理员”&gt;“用户和角色”可全部显示）：</li>
    <ul>
    <li>名称</li>
    <li>电子邮件</li>
    <li>登录</li>
