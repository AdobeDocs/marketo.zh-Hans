...
## 任务：更新个人的联系信息或其他数据 {#mission-update-a-persons-contact-info-or-other-data}
...
1. 多次单击以打开人员详细信息。
   ...
   >[!TIP]
   >
   >在Marketo中有多种更新人员数据的方法。 请参 [阅导入人员列表](/help/marketo/getting-started/quick-wins/import-a-list-of-people.md) 和 [更改数据值](/help/marketo/product-docs/core-marketo-concepts/smart-campaigns/flow-actions/change-data-value.md)。
...
[÷°?提醒销售代表](/help/marketo/getting-started/quick-wins/alert-the-sales-rep.md)
