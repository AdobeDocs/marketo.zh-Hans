...
1. 选择在[上一个快速入门](/help/marketo/getting-started/quick-wins/drip-drip-nurture.md){target="_blank"}中创建的Nurture电子邮件之一，然后单击&#x200B;**[!UICONTROL Create draft]**。
...
如果尚未启用弹出窗口阻止程序，则将在一个新的选项卡/窗口中打开电子邮件编辑器。 否则，请单击&#x200B;**[!UICONTROL Create Draft]**&#x200B;两次。
...
1. 点击&#x200B;**[!UICONTROL From]**&#x200B;字段中的空格键，确保光标在您刚刚插入的令牌后闪烁一个空格。 然后再次单击&#x200B;**令牌**&#x200B;图标。
...
1. 选择顶部可编辑部分，单击齿轮图标并选择&#x200B;**[!UICONTROL Edit]**。
...
1. 在&#x200B;**[!UICONTROL Default Value]**&#x200B;字段中输入“Friend”（或任何所需的标签），然后单击&#x200B;**[!UICONTROL Insert]**。
...
1. 在&#x200B;**[!UICONTROL Email Actions]**&#x200B;下，选择&#x200B;**[!UICONTROL Approve and Close]**。
