...
1. 在 **电子邮件操作**，单击 **批准**.
   ...
   >[!NOTE]
   >
   >不要忘记批准电子邮件，否则以后将无法激活它们。

1. 现在，通过重复步骤2操作，再创建一封电子邮件。

   ![](assets/thirteen-2.png)

## 步骤3:向流中添加内容 {#step-add-content-to-your-stream}

1. 现在，该使用您创建的电子邮件为您的参与项目创建内容流了。

1. 选择您的参与计划，然后单击 **流** 选项卡。

   ![](assets/fourteen-2.png)

1. 将您创建的两封电子邮件拖到正确的画布上。
