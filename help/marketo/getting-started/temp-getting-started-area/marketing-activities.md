...
# 新区域：营销活动核对清单 {#new-area-marketing-activities-checklist}

营销活动包含构成自动营销计划的所有资源和内容。 在设置新的Marketo Engage实例时，一个简洁明了的机构可确保所有用户都能轻松找到和管理各种程序。 通过可下载的核对表跟踪您的配置进度并离线检查基本步骤 — 此处链接 — 
