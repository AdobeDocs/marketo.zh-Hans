...
<tbody>
  ...
  <tr>
    ...
    <li>查看电子邮件无效类别中的人员及其电子邮件是否需要 <a href="https://experienceleague.adobe.com/docs/marketo/using/product-docs/email-marketing/deliverability/hard-and-soft-bounces-in-email.html" target="_blank">手动重置</a>.</li></td>
  </tr>
  <tr>
    <td>可能的重复项</td>
