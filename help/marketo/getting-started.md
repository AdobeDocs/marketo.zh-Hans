...
在 IT 团队的协助下，您可以快速完成设置。

[开始设置](/help/marketo/getting-started/initial-setup/setup-steps.md){target="_blank"}

## 快速上手，立即见效 {#get-some-quick-wins}

完成以下任务，学习 Marketo Engage 的核心功能。
...
<tr>
  <td>
    ...
    <div>
    <a href="/help/marketo/getting-started/quick-wins/get-set-up-and-add-a-person.md">1. 完成设置并添加人员</a>
    </div>
    <br>
  </td>
  <td>
  ...
  <td>
    ...
    <div><a href="getting-started/quick-wins/email-auto-response.md">5. 电子邮件自动回复</a>
    </div>
    <br>
  </td>
</tr>
<tr>
  ...
  <td>
    ...
    <div>
    <a href="getting-started/quick-wins/drip-drip-nurture.md">7. 滴灌式培养</a>
    </div>
    <br>
  </td>
  <td>
  ...
  <td>
    ...
    <div>
    <a href="getting-started/quick-wins/alert-the-sales-rep.md">9. 通知销售代表</a>
    </div>
    <br>
  </td>
  <td>
