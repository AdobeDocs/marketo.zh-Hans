...
## Marketo性能分析 {#marketo-performance-insights}

[Marketo性能分析](/help/marketo/product-docs/reporting/performance-insights/performance-insights-overview.md)
...
>[!NOTE]
>
>在第3季度版本中，我们将将[!DNL GoToWebinar]的[!DNL OAuth]版本从1.0升级到2.0。 此更改是在[!DNL GoToWebinar]之前进行的，将于2019年1月弃用[!DNL OAuth] 1.0支持。 如果您是[!DNL GoToWebinar]客户，则需要在2019年1月之前通过[!DNL LaunchPoint]（在[!UICONTROL Admin]区域）重新进行身份验证，以确保您的集成能够继续工作。
