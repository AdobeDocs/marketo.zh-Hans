...
* **新的开发人员文档网站**：作为我们继续努力改进Marketo Engage用户体验的一部分，我们将在2024年7月将所有开发人员文档迁移到Adobe Experience League和Adobe Developer网站。 [了解详情](https://nation.marketo.com/t5/employee-blogs/new-developer-documentation-website/ba-p/351055){target="_blank"}
...
* **查询参数弃用中的访问令牌**：在将来的版本中，将移除对在Marketo Engage REST API调用的查询参数中使用访问令牌的身份验证的支持（具体日期待定）。 现有集成应迁移到此处描述的授权标头[的使用情况](https://developers.marketo.com/rest-api/authentication/){target="_blank"}。 新开发应仅使用Authorization标头进行与Marketo Engage的身份验证。

* **LinkedIn需要重新身份验证**： LinkedIn正在升级其Marketo Engage LinkedIn集成使用的营销API。 在2024年7月26日至12月15日期间，这些更改将要求对您的&#x200B;**管理员** > **LaunchPoint**&#x200B;菜单中的所有LinkedIn LaunchPoint服务进行重新身份验证，以避免服务中断。 您可以在此处找到有关Forms潜在客户如何完成此[的说明](/help/marketo/product-docs/demand-generation/social/social-functions/set-up-linkedin-lead-gen-forms.md){target="_blank"}和[此处提供的有关匹配受众的说明](/help/marketo/product-docs/demand-generation/ad-network-integrations/add-linkedin-matched-audiences-as-a-launchpoint-service.md){target="_blank"}。 Lead Gen Form服务具有“LinkedIn Lead Gen”类型，而Matched Audience服务具有“LinkedIn匹配受众”类型。 有关详细信息，请访问[迁移常见问题解答](https://nation.marketo.com/t5/employee-blogs/linkedin-re-authentication-required/ba-p/347794){target="_blank"}。
