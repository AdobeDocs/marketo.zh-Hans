...
在Revenue Explorer中创建高级电子邮件报表，如“单击活动热网格”报表。 此报告可让您深入了解用户单击电子邮件中的链接的日期和时间。

随着我们迁移您的2012和2013年电子邮件数据，整个电子邮件分析功能将在4月和5月分阶段启用。 换言之，某些客户将比其他客户更早获得此功能的访问权限。

![](assets/image2014-9-22-15-3a49-3a16.png)

## 程序API {#program-apis}

支持SOAP API调用中的程序，包括对程序数据的只读访问，例如：程序会员计数、获得者、成功、设置、渠道、标记、令牌和成本。 有关详细信息，请参阅SOAP API文档。

## ON24增强功能 {#on-enhancement}

职称和公司名称将从Marketo注册表中同步到ON24。
