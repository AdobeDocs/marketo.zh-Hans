---
title: "2017"
description: 2017 - Marketo文档 — 产品文档
...
## Facebook自定义受众的高级匹配 {#advanced-matching-for-facebook-custom-audiences}

[Facebook自定义受众的高级匹配](/help/marketo/product-docs/demand-generation/ad-network-integrations/add-facebook-custom-audiences-as-a-launchpoint-service.md)

基本匹配仅使用电子邮件地址，但新的高级匹配使用额外的七个字段，从而提高匹配率以实现更多转化。

![](assets/fb-custom-audiences-schebsches.png)

## 自定义对象导入API {#custom-object-import-api}

[自定义对象导入API](https://developers.marketo.com/rest-api/lead-database/custom-objects/)

此API提供了一个更快的界面，用于将自定义对象同步到Marketo中。 您可以将CSV、TSV或SSV电子表格文件作为自定义对象导入Marketo。

## Web Personalization营销活动导出 {#web-personalization-campaigns-export}

[Web Personalization营销活动导出](/help/marketo/product-docs/web-personalization/working-with-web-campaigns/export-web-campaign-data.md)
...
## SDK增强功能 {#sdk-enhancements}

[SDK增强功能](https://developers.marketo.com/mobile/)
...
## Marketo活动API {#marketo-activity-apis}

[Marketo活动API](https://developers.marketo.com/blog/important-change-activity-records-marketo-apis/)
...
## LinkedIn潜在客户Forms {#linkedin-lead-gen-forms}

[LinkedIn潜在客户Forms](/help/marketo/product-docs/demand-generation/social/social-functions/set-up-linkedin-lead-gen-forms.md)
...
## 使MSI模板过期 {#expire-msi-template}

[使MSI模板过期](/help/marketo/product-docs/marketo-sales-insight/msi-for-salesforce/features/actions-in-the-msi-panel/send-marketo-email/publish-an-email-to-sales-insight.md)
...
## 批量提取人员和活动的API {#bulk-extract-apis-for-people-and-activities}

[批量提取人员和活动的API](https://developers.marketo.com/rest-api/bulk-extract/)
...
## 其他Facebook离线转化阶段 {#additional-facebook-offline-conversion-stages}

[其他Facebook离线转化阶段](/help/marketo/product-docs/demand-generation/facebook/set-up-facebook-offline-conversions.md)

选择最多7个额外的离线转化阶段以映射到Marketo生命周期阶段（超出目前可用的3个）。 根据客户历程中的转化优化您的[!DNL Facebook]广告支出，以实现更好的ROI。

![](assets/image2017-8-24-15-3a23-3a31.png)

## 锁定Sales Insight模板 {#lock-sales-insight-template}

[锁定Sales Insight模板](/help/marketo/product-docs/marketo-sales-insight/msi-for-salesforce/features/actions-in-the-msi-panel/send-marketo-email/lock-sales-template.md)
...
## 收件人时区 {#recipient-time-zone}

[收件人时区](/help/marketo/product-docs/email-marketing/email-programs/email-program-actions/scheduling-with-recipient-time-zone/understanding-recipient-time-zone.md)
...
## 按区段查看示例电子邮件 {#review-sample-emails-by-segment}

[按区段查看示例电子邮件](/help/marketo/product-docs/email-marketing/general/creating-an-email/send-a-sample-email.md)

在发送示例电子邮件以供审阅时，Marketo新增了一个用于选取区段的选项。 您不再需要手动确定商机属于哪个区段，从而更轻松地向不同区段发送包含动态内容的电子邮件。

## LinkedIn潜在客户一般自定义问题 {#linkedin-lead-gen-custom-questions}

[LinkedIn潜在客户一般自定义问题](/help/marketo/product-docs/demand-generation/social/social-functions/set-up-linkedin-lead-gen-forms.md)
...
## 动态帐户列表 {#dynamic-account-lists}

[动态帐户列表](/help/marketo/product-docs/target-account-management/target/account-lists.md)
