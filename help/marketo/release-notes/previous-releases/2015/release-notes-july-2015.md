...
午饭时外出，但需要重新安排一封电子邮件吗？ App Store或Google Play提供的Marketo Moments应用程序让您能够实时查看电子邮件和事件促销活动的效果，以及将来将会发生的事件(从iPhone、iPad或Android手机)。
...
`<iframe width="420" height="315" src="https://www.youtube.com/embed/LmmBN6IQrII" frameborder="0" allowfullscreen></iframe>` 此更新将在7月版本发布后的几天内自动推出。 之后，您将能够在编辑器的新版本和旧版本之间切换 **管理员>电子邮件>编辑编辑器设置**.
...
学习 [更多](https://developers.marketo.com/documentation/company-api/) 请参阅公司API参考指南。
