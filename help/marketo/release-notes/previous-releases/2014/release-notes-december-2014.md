...
我们推出了一项新的安全功能，可自动HTML编码令牌，此功能将在2015年3月默认启用。 在此之前，请在字段管理中切换此功能以提前测试行为。 所有潜在客户和公司令牌在插入电子邮件或登陆页面时都将进行编码。 选项也可用于单个字段。
...
## Revenue Explorer升级外观 {#revenue-explorer-upgraded-look-and-feel}
...
在新的“指定帐户”页面中管理和监视关键的高收益帐户。 上载指定帐户的新列表以标识和定位这些组织。 我们已将流程自动化，为您提供更大的控制力和灵活性，以便实施基于帐户的营销计划并跨不同渠道（Web和广告）定位您的关键帐户。
