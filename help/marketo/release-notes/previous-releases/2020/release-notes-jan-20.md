...
* **Microsoft Dynamics — 实时同步潜在客户与CRM**：实时同步Marketo Engage和Microsoft Dynamics之间的潜在客户和联系人。 创建潜在客户或联系人，然后立即在Microsoft Dynamics中通过“将人员同步到Microsoft”流程操作查看这些潜在客户或联系人。
...
* **Salesforce Lightning Bulk Actions**：提高销售效率，让购买者能够使用Salesforce Lightning批量向促销活动添加多达200个联系人/潜在客户，并向他们发送Marketo Engage电子邮件。
* **Salesforce1**&#x200B;的移动支持：您现在可以在Salesforce1应用程序中移动访问所有Sales Insight功能，如“有趣的时刻”和“Web活动和电子邮件”。
...
>
>* **ITP 2.1+ Munchkin更新**：由于对Safari的Cookie策略进行了更改，Munchkin在同一域上跨会话跟踪用户的能力将受ITP限制，具体期限为1天或7天，具体取决于访客使用的浏览器和浏览器版本。 为此，我们正在实施一项新的Web服务，以允许通过HTTP响应使用Set-Cookie标头设置Munchkin Cookie。 有关如何实施此新服务的详细信息，可在[此处](https://nation.marketo.com/docs/DOC-7351)找到。
