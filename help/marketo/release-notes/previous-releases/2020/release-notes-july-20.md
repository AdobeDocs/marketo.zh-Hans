...
>[!AVAILABILITY]
>
>请注意，根据您当前的包，带星形(![(star)](assets/yellow-star.png))的项目可能需要购买值附加组件。 请联系您的Marketo Engage代表以了解更多信息。

**_季度_** 版本以下功能将于2020年7月 **31日发布**。
...
* **更新了帐户分析的UI**:通过在单个屏幕中简化所有步骤，简化“帐户分析”中目标帐户列表的创建。
...
* **[为具有非本机Salesforce CRM集成（测试版）](/help/marketo/product-docs/marketo-sales-insight/sales-insight-for-non-native-salesforce-integrations.md)**&#x200B;的客户启用的Sales Insight:将非本机Salesforce CRM集成的Marketo Engage客户现在可以使用Sales Insight帮助其销售团队了解、排定优先级并与最投入的商机和机会进行互动，从而实现智能销售和更快的交易。

## Sales Connect {#sales-connect}

![（星号）](assets/yellow-star.png)

* **[增强了销售呼叫的双方同意：](/help/marketo/product-docs/marketo-sales-connect/phone/two-party-consent-settings.md)** 管理员现在可以更好地控制呼叫记录配置。[确保您](/help/marketo/product-docs/marketo-sales-connect/phone/enable-call-recording.md) 符合双方同意法，同时启用呼叫记录。自动通知正在录制的呼叫，并激活要在呼叫之前播放的音频剪辑。
...
* **支持Internet Explorer**:如前所述，Marketo Engage对Internet Explorer 11的支持将于2020 **年7月31日终止**。我们将继续支持Google Chrome、Mozilla Firefox、Apple Safari和Microsoft Edge。
...
* **EdgeHTML（非Chromium）Microsoft Edge支持**:Marketo Engage将在2020年底不再支持Microsoft Edge的EdgeHTML版本。从2021年1月1日开始，我们将仅支持最新的Chromium版本的Microsoft Edge。
