...
2017年夏季版本中包含以下功能。 查看Marketo版本以了解功能可用性。
...
选择最多7个额外的离线转化阶段以映射到Marketo生命周期阶段（当前可用的3个阶段以外）。 根据客户历程中的转化优化您的Facebook广告支出，以实现更好的ROI。
...
LeanData集成现在允许在Marketo中进行商机帐户匹配。 通过将相同的潜在客户与记录中的销售和营销系统中的客户关联起来，使营销和销售保持一致。 更灵活的选项使营销和销售运营部门能够更好地控制商机与客户的匹配规则，以便他们达到所需的精确级别。
...
营销从业者现在可以确保其Web营销活动在任何设备上都具有出色的外观 *早于* 发射它们。 通过这些增强功能，了解您的Web营销活动将如何跨桌面、移动设备和平板电脑进行呈现。 适用于Chrome的新插件还提供了更一致、更准确的预览。

**[Widget Campaign增强](/help/marketo/product-docs/web-personalization/working-with-web-campaigns/create-a-new-widget-web-campaign.md)**
...
通过更深入的Analytics和AI支持的内容建议提高内容营销的回报，从而提升参与度。 功能强大的分析可显示推荐内容的表现如何，包括热门、趋势和基于受众的视图。 您还将看到有关要包含的其他内容的建议。

## Analytics {#analytics}

**电子邮件分析增强功能**

通过准备和共享数据的新方式，从您的电子邮件分析体验中获得更多信息。 您现在可以将电子邮件分析结果下载到Microsoft Excel和PowerPoint以处理Marketo以外的数据。

## 联合身份配置支持 {#federated-identity-configuration-support}

将身份验证(Active Directory)保留在防火墙内部部署之后，同时继续在云中使用Microsoft Dynamics CRM。
