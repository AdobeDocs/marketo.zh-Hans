...
# 发行说明：2025 年 4 月 {#release-notes-apr-25}

在下方，您会找到2025年4月版本中包含的所有功能。 请检查您的 Adobe Marketo Engage 版本以确认功能可用性。
...
以下功能属于标准发行周期，将于&#x200B;**2025年4月25日**&#x200B;开始发行，并在接下来的几周内分阶段推出剩余功能。 功能及发布时间可能会有变动。请查看每个功能旁的状态标记。
