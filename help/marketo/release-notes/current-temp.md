...
<table style="table-layout:auto">
 ...
 <tr>
  ...
  <tr>
   ...
   <td>开放Beta版</td>
   <td><a href="https://experienceleague.adobe.com/en/docs/marketo/using/product-docs/marketo-ai/skills/product-knowledge" target="_blank">Marketo AI概述</a></td>
  </tr>
  <tr>
   <td> </td>
   <td> </td>
  ...
  <tr>
   ...
   <td>开放Beta版</td>
   <td><a href="https://experienceleague.adobe.com/en/docs/marketo/using/product-docs/marketo-ai/skills/investigate-leads" target="_blank">Marketo AI概述</a></td>
  </tr>
  <tr>
   <td> </td>
   <td> </td>
