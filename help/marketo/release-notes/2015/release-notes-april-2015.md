...
[重新设计Analytics主页](/help/marketo/product-docs/reporting/basic-reporting/creating-reports/navigating-the-analytics-home-page.md)

>[!NOTE]
>
>此功能将于4月28日星期二发布。

新的[分析主页](/help/marketo/product-docs/reporting/basic-reporting/creating-reports/navigating-the-analytics-home-page.md)允许快速访问，以便跨可用报表类型运行临时报表。

![](assets/image2015-4-20-11-3a18-3a8.png)

此外，现在提供私有与共享报表组织。 创建报表或将其拖入“我的报表”文件夹，以阻止其他用户查看、编辑或删除报表。 组报告将共享给所有用户。
...
借助指定帐户列表的新性能图，根据购买周期中的每个阶段即时了解您的关键指定帐户列表的性能。 该图表根据访问次数和访客状态显示关键组织从始终意识到行动的访问阶段。
