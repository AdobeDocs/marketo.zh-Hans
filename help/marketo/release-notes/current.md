...
<table style="table-layout:auto">
 ...
 <tr>
  ...
  <tr>
   ...
   <td>已发布</td>
   <td><a href="https://experienceleague.adobe.com/en/docs/marketo/using/product-docs/core-marketo-concepts/miscellaneous/understanding-folders#disable-smart-campaigns-archive" target="_blank">在存档上禁用营销活动</a></td>
  </tr>
    <tr>
   <td> </td>
   <td> </td>
