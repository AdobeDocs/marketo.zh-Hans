...
## [电子邮件洞察](http://docs.marketo.com/display/docs/email+insights) {#email-insights}

Email Insights是一种全新的历史聚合数据电子邮件分析体验，作为Project Orion的一部分，它经过了端到端的重新设计，实现了闪电般的性能。 它采用全新的用户界面设计，经过优化，可满足电子邮件营销人员的需求和工作流程。

>[!NOTE]
>
>从6月3日开始，我们将批量向客户发布电子邮件洞察。 我们的目标是在未来几个月内完成这一工作。 启用后，我们将通过电子邮件通知您。
...
使用我们新的入门模板创建精美的电子邮件！ 此外，还可以从模板的实时缩略图中快速找到模板。
...
## [电子邮件编辑——重塑](/help/marketo/product-docs/email-marketing/general/email-editor-2/email-editor-v2-0-overview.md) {#email-editing-re-imagined}

没错，是一位全新的电子邮件编辑！ 使用轻量拖放功能添加和重新排序内容。 包括图像、视频、变量和模块在内的新元素必定能增强您的编辑体验。 另请查看更新的代码编辑器、预览器和预标题支持。
...
直接在Marketo中为您的应用程序创建令人赞叹的应用程序内消息。 使用应用程序内消息项目准确定义应查看该消息的人员以及时间。 借助项目仪表板轻松监控其性能。

![](assets/pasted-image-at-2016-05-24-09-45-am.png)

## [无草稿代码片段](/help/marketo/product-docs/administration/users-and-roles/managing-user-roles-and-permissions/enable-no-draft-for-snippets.md) {#no-draft-snippets}

每次更新片段时，您必须重新批准所有内容的日子都已过去！ 使用“无草稿”时，所有使用片段的电子邮件和登陆页都将获得片段更新并保持其先前的状态。 每次批准代码片断时，您都可以选择运行“无草稿”并更新所有内容，或创建草稿。 由您决定！ “无草稿”将对所有客户可用，并由“管理员”中的新权限控制。
...
如今，很难区分Marketo实例，如沙箱和生产实例。 此功能可让您了解当前正在处理的实例。

![](assets/image2016-5-16-15-3a57-3a14.png)

## [订阅限时访问](/help/marketo/product-docs/administration/users-and-roles/managing-marketo-users.md) {#limited-time-access-for-subscriptions}

如今，用户被邀请使用Marketo订阅无限期。 此功能使管理员能够在有限的时间段内（例如2周或1个月）邀请用户加入订阅。
