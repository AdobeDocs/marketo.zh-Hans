...
+ Marketo快速入门 {#getting-started-with-marketo}
   ...
   + 快速入门 {#quick-wins}
      ...
      + [针对可能存在的重复人员自动发出警报](getting-started/quick-wins/advanced-solutions/automate-an-alert-for-possible-duplicate-people.md)
...
+ 产品文档 {#product-docs}
   ...
   + 管理 {#administration}
      ...
      + 其他集成 {#additional-integrations}
         ...
         + [使用经理帐户添加Google AdWords作为Launchpoint服务](product-docs/administration/additional-integrations/add-google-adwords-as-a-launchpoint-service-with-a-manager-account.md)
         ...
         + [将3级Web会议添加为LaunchPoint服务](product-docs/administration/additional-integrations/add-level-3-web-meeting-as-a-launchpoint-service.md)
         ...
         + [仅限用户登录SSO](product-docs/administration/additional-integrations/restrict-user-login-to-sso-only.md)
      + 审核记录 {#audit-trail}
      ...
      + 电子邮件设置 {#email-setup}
         + 添加多个品牌推广域 {#add-multiple-branding-domains}
            + [添加带有工作区的附加品牌推广域](product-docs/administration/email-setup/add-multiple-branding-domains/add-an-additional-branding-domain-with-workspaces.md)
            + [添加附加品牌推广域](product-docs/administration/email-setup/add-multiple-branding-domains/add-an-additional-branding-domain.md)
         ...
         + [更改默认发件人电子邮件和发件人标签](product-docs/administration/email-setup/change-the-default-from-email-and-from-label.md)
         + [编辑取消订阅消息](product-docs/administration/email-setup/edit-the-unsubscribe-message.md)
         + [使您的取消订阅消息对语言动态显示](product-docs/administration/email-setup/edit-the-unsubscribe-message/make-your-unsubscribe-message-dynamic-for-languages.md)
      ...
      + 字段管理 {#field-management}
         ...
         + [创建和使用连接字符串（公式）字段](product-docs/administration/field-management/create-and-use-a-concatenated-string-formula-field.md)
      ...
      + 具有Adobe身份的Marketo {#marketo-with-adobe-identity}
         ...
         + [使用Adobe ID登录用户](product-docs/administration/marketo-with-adobe-identity/user-sign-in-with-adobe-id.md)
      ...
      + 设置 {#settings}
         ...
         + [更改Analytics的属性设置](product-docs/administration/settings/change-attribution-settings-for-analytics.md)
         ...
         + [启用或禁用“金库功能”](product-docs/administration/settings/enable-or-disable-treasure-chest-features.md)
         ...
         + [根据IP限制Marketo登录](product-docs/administration/settings/restrict-marketo-logins-based-on-ip.md)
      ...
      + 标记 {#tags}
         ...
         + [创建项目群渠道](product-docs/administration/tags/create-a-program-channel.md)
         + [创建自定义标记](product-docs/administration/tags/create-custom-tags.md)
         + [删除项目群频道](product-docs/administration/tags/delete-a-program-channel.md)
   ...
   + 核心Marketo概念 {#core-marketo-concepts}
      + Smart Campaign {#smart-campaigns}
         ...
         + 创建智能营销活动 {#creating-a-smart-campaign}
            ...
            + [为智能营销活动定义智能列表 |批次](product-docs/core-marketo-concepts/smart-campaigns/creating-a-smart-campaign/define-smart-list-for-smart-campaign-batch.md)
            ...
            + [Smart Campaign核对清单](product-docs/core-marketo-concepts/smart-campaigns/creating-a-smart-campaign/smart-campaign-checklist.md)
         + 使用智能营销活动 {#using-smart-campaigns}
            ...
            + [自动触发器营销活动清理](product-docs/core-marketo-concepts/smart-campaigns/using-smart-campaigns/automatic-trigger-campaign-cleanup.md)
            ...
            + [触发器营销活动的优先级覆盖](product-docs/core-marketo-concepts/smart-campaigns/using-smart-campaigns/priority-override-for-trigger-campaigns.md)
            ...
            + [计划循环批处理活动](product-docs/core-marketo-concepts/smart-campaigns/using-smart-campaigns/schedule-a-recurring-batch-campaign.md)
         ...
         + 流操作 {#flow-actions}
            ...
            + [重新排序智能营销活动中的流量步骤](product-docs/core-marketo-concepts/smart-campaigns/flow-actions/add-a-flow-step-to-a-smart-campaign/reorder-the-flow-steps-in-a-smart-campaign.md)
         ...
         + Smart Campaign数据 {#smart-campaign-data}
            ...
            + [在Smart Campaign中查看符合条件的人员](product-docs/core-marketo-concepts/smart-campaigns/smart-campaign-data/view-qualified-people-in-a-smart-campaign.md)
      ...
      + 智能列表和静态列表 {#smart-lists-and-static-lists}
         ...
         + 使用智能列表 {#using-smart-lists}
            ...
            + [从智能列表中运行单个流程步骤](product-docs/core-marketo-concepts/smart-lists-and-static-lists/using-smart-lists/run-a-single-flow-step-from-a-smart-list.md)
         ...
         + 管理智能列表中的人员 {#managing-people-in-smart-lists}
            ...
            + [从列表或智能列表中将人员导出到Excel](product-docs/core-marketo-concepts/smart-lists-and-static-lists/managing-people-in-smart-lists/export-people-to-excel-from-a-list-or-smart-list.md)
      ...
      + 程序 {#programs}
         + 创建项目 {#creating-programs}
            ...
            + [了解程序中的本地资产](product-docs/core-marketo-concepts/programs/creating-programs/understanding-local-assets-in-a-program.md)
         ...
         + 使用项目 {#working-with-programs}
            ...
            + [项目群成员自定义字段同步](product-docs/core-marketo-concepts/programs/working-with-programs/program-member-custom-field-sync.md)
         ...
         + 项目库 {#program-library}
            ...
            + [内容管理计划模板](product-docs/core-marketo-concepts/programs/program-library/content-management-program-template.md)
         + 项目执行情况报告 {#program-performance-report}
            + [创建项目群绩效报表](product-docs/core-marketo-concepts/programs/program-performance-report/create-a-program-performance-report.md)
            ...
            + [按项目群筛选项目群报告](product-docs/core-marketo-concepts/programs/program-performance-report/filter-a-program-report-by-program.md)
         ...
         + 项目计划视图 {#program-schedule-view}
            ...
            + [在项目计划视图中创建自定义叠加图](product-docs/core-marketo-concepts/programs/program-schedule-view/creating-custom-overlays-in-program-schedule-view.md)
            + [在程序计划视图中编辑条目](product-docs/core-marketo-concepts/programs/program-schedule-view/editing-entries-in-the-program-schedule-view.md)
            ...
            + [在项目计划视图中重新计划批量智能促销活动](product-docs/core-marketo-concepts/programs/program-schedule-view/reschedule-a-batch-smart-campaign-in-the-program-schedule-view.md)
            + [从“计划”视图中重新计划整个项目](product-docs/core-marketo-concepts/programs/program-schedule-view/rescheduling-an-entire-program-from-the-schedule-view.md)
         ...
         + 令牌 {#tokens}
            ...
            + [了解程序中的我的令牌](product-docs/core-marketo-concepts/programs/tokens/understanding-my-tokens-in-a-program.md)
      ...
      + 营销日历 {#marketing-calendar}
         + 了解日历 {#understanding-the-calendar}
            ...
            + [在营销日历中导航](product-docs/core-marketo-concepts/marketing-calendar/understanding-the-calendar/navigating-the-marketing-calendar.md)
            + [了解/启用计划焦点](product-docs/core-marketo-concepts/marketing-calendar/understanding-the-calendar/understand-enable-program-focus.md)
      ...
      + 移动应用程序 {#mobile-apps}
         + 事件签入 {#event-check-in}
            ...
            + [通过平板电脑将人员登记到您的活动中](product-docs/core-marketo-concepts/mobile-apps/event-check-in/check-people-into-your-event-from-your-tablet.md)
      ...
      + 其他 {#miscellaneous}
         ...
         + [创建新的Campaign文件夹](product-docs/core-marketo-concepts/miscellaneous/create-new-campaign-folder.md)
   ...
   + CRM同步 {#crm-sync}
      + Microsoft Dynamics同步 {#microsoft-dynamics}
         ...
         + 同步设置 {#sync-setup}
            ...
            + 具有ROPC连接的Microsoft Dynamics 365{#microsoft-dynamics-365-with-ropc-connection}
               + [第1步（共4步）：通过ROPC连接安装Marketo解决方案](product-docs/crm-sync/microsoft-dynamics-sync/sync-setup/microsoft-dynamics-365-with-ropc-connection/step-1-of-4-install.md)
               ...
               + [第4步（共4步）：将Marketo解决方案连接到ROPC连接](product-docs/crm-sync/microsoft-dynamics-sync/sync-setup/microsoft-dynamics-365-with-ropc-connection/step-4-of-4-connect.md)
            ...
            + 连接到旧版本 {#connecting-to-legacy-versions}
               ...
               + [第2步（共3步）：在Dynamics中设置Marketo同步用户（2011年内部部署）](product-docs/crm-sync/microsoft-dynamics-sync/sync-setup/connecting-to-legacy-versions/step-2-of-3-set-up-2011.md)
               ...
               + [步骤1/3：在Dynamics中安装Marketo解决方案（2013内部部署）](product-docs/crm-sync/microsoft-dynamics-sync/sync-setup/connecting-to-legacy-versions/step-1-of-3-install-2013.md)
               ...
               + [步骤3/3：连接Marketo和Dynamics（2013年内部部署）](product-docs/crm-sync/microsoft-dynamics-sync/sync-setup/connecting-to-legacy-versions/step-3-of-3-connect-2013.md)
               + [步骤1/3：在Dynamics中安装Marketo解决方案（2015年内部部署）](product-docs/crm-sync/microsoft-dynamics-sync/sync-setup/connecting-to-legacy-versions/step-1-of-3-install-2015.md)
               ...
               + [步骤3/3：连接Marketo和Dynamics（2015年内部部署）](product-docs/crm-sync/microsoft-dynamics-sync/sync-setup/connecting-to-legacy-versions/step-3-of-3-connect-2015.md)
         + Microsoft Dynamics同步详细信息 {#microsoft-dynamics-sync-details}
            ...
            + [Microsoft Dynamics同步： Contact同步](product-docs/crm-sync/microsoft-dynamics-sync/microsoft-dynamics-sync-details/microsoft-dynamics-sync-contact-sync.md)
         ...
         + [使用Azure注册应用程序以获取您的客户端ID/应用程序ID](product-docs/crm-sync/microsoft-dynamics-sync/register-an-app-with-azure-to-acquire-your-client-id-app-id.md)
      ...
      + Salesforce同步 {#salesforce-sync}
         ...
         + 设置 {#setup}
            + Enterprise/无限制版本 {#enterprise-unlimited-edition}
               ...
               + [第2步（共3步）：创建Salesforce User for Marketo (Enterprise/Unlimited)](product-docs/crm-sync/salesforce-sync/setup/enterprise-unlimited-edition/step-2-of-3-create-a-salesforce-user-for-marketo-enterprise-unlimited.md)
            ...
            + Professional版 {#professional-edition}
               ...
               + [第2步（共3步）：创建Salesforce用户以使用Marketo（专业）](product-docs/crm-sync/salesforce-sync/setup/professional-edition/step-2-of-3-create-a-salesforce-user-for-marketo-professional.md)
      ...
      + Veeva CRM同步 {#veeva-crm-sync}
         ...
         + 同步详细信息 {#sync-details}
            ...
            + [正在同步呼叫和呼叫关键消息](product-docs/crm-sync/veeva-crm-sync/sync-details/syncing-call-and-call-key-messages.md)
   ...
   + 需求生成 {#demand-generation}
      + 广告网络集成 {#ad-network-integrations}
         + [了解Ad Network集成](product-docs/demand-generation/ad-network-integrations/understanding-ad-network-integrations.md)
         ...
         + [将Google Customer Match添加为LaunchPoint Service](product-docs/demand-generation/ad-network-integrations/add-google-customer-match-as-a-launchpoint-service.md)
      ...
      + Dynamic Chat {#dynamic-chat}
         ...
         + 集成 {#integrations}
            + [将Dynamic Chat连接到Marketo](product-docs/demand-generation/dynamic-chat/integrations/connect-dynamic-chat-to-marketo.md)
            + [使用文档信息卡](product-docs/demand-generation/dynamic-chat/integrations/using-the-document-card.md)
         + 对话 {#dialogues}
      ...
      + 事件 {#events}
         ...
         + 创建事件 {#create-an-event}
            ...
            + [使用级别3 Web会议创建事件](product-docs/demand-generation/events/create-an-event/create-an-event-with-level-3-web-meeting.md)
      ...
      + Facebook {#facebook}
         ...
         + [测试桌面版与Marketo集成的Facebook潜在客户广告](product-docs/demand-generation/facebook/test-facebook-lead-ads-for-desktop-integration-with-marketo.md)
         ...
         + [在Smart Campaign中使用潜在广告过滤器和触发器](product-docs/demand-generation/facebook/use-lead-ads-filters-and-triggers-in-a-smart-campaign.md)
      + Forms {#forms}
         ...
         + 表单操作 {#form-actions}
            ...
            + [定义单选字段或表单中的选定字段中的值](product-docs/demand-generation/forms/form-actions/define-values-in-a-radio-or-selected-field-in-a-form.md)
      ...
      + 图像和文件 {#images-and-files}
         ...
         + [从网页获取图像](product-docs/demand-generation/images-and-files/grab-the-images-from-a-web-page.md)
      ...
      + 登陆页面 {#landing-pages}
         ...
         + 自由格式登陆页面 {#free-form-landing-pages}
            ...
            + [为您的自由格式登陆页面添加移动视图](product-docs/demand-generation/landing-pages/free-form-landing-pages/add-a-mobile-view-for-your-free-form-landing-page.md)
            ...
            + [将视频添加到自由格式的登陆页面](product-docs/demand-generation/landing-pages/free-form-landing-pages/add-a-video-to-a-free-form-landing-page.md)
            ...
            + [将自定义HTML添加到自由格式登录页面](product-docs/demand-generation/landing-pages/free-form-landing-pages/adding-custom-html-to-a-free-form-landing-page.md)
            + [创建自由格式登陆页面](product-docs/demand-generation/landing-pages/free-form-landing-pages/create-a-free-form-landing-page.md)
            + [自定义自由格式登陆页面的移动设备视图](product-docs/demand-generation/landing-pages/free-form-landing-pages/customize-mobile-view-for-your-free-form-landing-page.md)
            ...
            + [使用指南进行自由格式登陆页面设计](product-docs/demand-generation/landing-pages/free-form-landing-pages/use-guides-for-free-form-landing-page-design.md)
         ...
         + 登陆页面操作 {#landing-page-actions}
            ...
            + [将Marketo登录页面重定向到其他页面](product-docs/demand-generation/landing-pages/landing-page-actions/redirect-a-marketo-landing-page-to-another-page.md)
         + 登陆页面模板 {#landing-page-templates}
            ...
            + [编辑Marketo登录页模板](product-docs/demand-generation/landing-pages/landing-page-templates/edit-a-marketo-landing-page-template.md)
      ...
      + 社交 {#social}
         + 配置社交操作 {#configuring-social-actions}
            ...
            + [为反向链接选件配置跟踪进度流](product-docs/demand-generation/social/configuring-social-actions/configure-track-progress-flow-for-a-referral-offer.md)
            ...
            + [设置数字广告促销活动的收入归因](product-docs/demand-generation/social/configuring-social-actions/set-up-revenue-attribution-for-digital-advertising-campaigns.md)
         ...
         + 反向链接选件 {#referral-offers}
            ...
            + [发送反向链接优惠履行电子邮件](product-docs/demand-generation/social/referral-offers/send-referral-offer-fulfillment-email.md)
         ...
         + 社交功能 {#social-functions}
            ...
            + [设置LinkedIn潜在客户群Forms](product-docs/demand-generation/social/social-functions/set-up-linkedin-lead-gen-forms.md)
            ...
            + [为优惠履行使用促销代码](product-docs/demand-generation/social/social-functions/use-promo-codes-for-offer-fulfillment.md)
         ...
         + 抽奖活动 {#sweepstakes}
            ...
            + [精选抽奖活动赢家](product-docs/demand-generation/social/sweepstakes/select-sweepstakes-winners.md)
   + 电子邮件营销 {#email-marketing}
      + 可投放性 {#deliverability}
         + [持久取消订阅](product-docs/email-marketing/deliverability/durable-unsubscribe.md)
         + [Email Deliverability Power Pack：如何导入种子列表](product-docs/email-marketing/deliverability/email-deliverability-power-pack-how-to-import-a-seed-list.md)
      ...
      + 滴管培养 {#drip-nurturing}
         ...
         + 使用参与计划 {#using-engagement-programs}
            ...
            + [在参与计划中暂停人员](product-docs/email-marketing/drip-nurturing/using-engagement-programs/pause-people-in-an-engagement-program.md)
            + [内容已耗竭的人](product-docs/email-marketing/drip-nurturing/using-engagement-programs/people-who-have-exhausted-content.md)
      ...
      + 电子邮件程序 {#email-programs}
         ...
         + 电子邮件项目操作 {#email-program-actions}
            ...
            + 电子邮件测试 — A/B测试 {#email-test-a-b-test}
               ...
               + [定义A/B测试入选标准](product-docs/email-marketing/email-programs/email-program-actions/email-test-a-b-test/define-the-a-b-test-winner-criteria.md)
               ...
               + [使用电子邮件计划仪表板 — A/B测试视图](product-docs/email-marketing/email-programs/email-program-actions/email-test-a-b-test/use-the-email-program-dashboard-a-b-test-view.md)
         ...
         + 电子邮件程序数据 {#email-program-data}
            ...
            + [查看电子邮件计划结果](product-docs/email-marketing/email-programs/email-program-data/view-email-program-results.md)
         ...
         + 管理电子邮件程序中的人员 {#managing-people-in-email-programs}
            + [通过导入列表来定义受众](product-docs/email-marketing/email-programs/managing-people-in-email-programs/define-an-audience-by-importing-a-list.md)
      ...
      + 常规 {#general}
         ...
         + 创建电子邮件 {#creating-an-email}
            ...
            + [编辑您的电子邮件标头](product-docs/email-marketing/general/creating-an-email/edit-your-email-header.md)
         ...
         + 编辑器中的函数 {#functions-in-the-editor}
            + [在电子邮件中转发至朋友链接](product-docs/email-marketing/general/functions-in-the-editor/forward-to-a-friend-link-in-emails.md)
            ...
            + [使电子邮件可运行](product-docs/email-marketing/general/functions-in-the-editor/make-an-email-operational.md)
   ...
   + 现代UXMarketo Engage {#marketo-engage-modern-ux}
   ...
   + Marketo Sales连接 {#marketo-sales-connect}
      ...
      + CRM {#crm}
         + Salesforce自定义 {#salesforce-customization}
            ...
            + [编辑Salesforce字段可用性](product-docs/marketo-sales-connect/crm/salesforce-customization/edit-salesforce-field-accesibility.md)
            ...
            + [如何在Salesforce沙盒中安装自定义项](product-docs/marketo-sales-connect/crm/salesforce-customization/how-to-install-customizations-in-your-salesforce-sandbox.md)
            ...
            + [为Professional Edition客户安装Salesforce Customization](product-docs/marketo-sales-connect/crm/salesforce-customization/install-salesforce-customization-for-professional-edition-customers.md)
            + [推送到Sales Connect](product-docs/marketo-sales-connect/crm/salesforce-customization/push-to-sales-connect.md)
            + [Salesforce中的报告仪表板](product-docs/marketo-sales-connect/crm/salesforce-customization/reporting-dashboards-in-salesforce.md)
         ...
         + Salesforce集成 {#salesforce-integration}
            ...
            + [将Salesforce从您的Sales Connect帐户断开](product-docs/marketo-sales-connect/crm/salesforce-integration/disconnect-salesforce-from-your-sales-connect-account.md)
            ...
            + [回复日志](product-docs/marketo-sales-connect/crm/salesforce-integration/reply-logging.md)
      ...
      + 电子邮件插件 {#email-plugins}
         + Gmail {#gmail}
            ...
            + [防止辅助Gmail地址与Sales Connect集成](product-docs/marketo-sales-connect/email-plugins/gmail/preventing-secondary-gmail-address-from-integrating-with-sales-connect.md)
            ...
            + [将电子邮件安排在以后的日期](product-docs/marketo-sales-connect/email-plugins/gmail/schedule-an-email-for-a-later-date.md)
         ...
         + MSC for Outlook {#msc-for-outlook}
            ...
            + Office 365加载项 {#office-365-add-in}
               ...
               + [安装Sales Connect for Office365 Mac OS、Windows和联机版](product-docs/marketo-sales-connect/email-plugins/msc-for-outlook/office-365-add-in/installing-sales-connect-for-office365-mac-os-windows-and-online.md)
      + 电子邮件 {#email}
         + 指挥中心 {#command-center}
         ...
         + 常见跟踪问题 {#common-tracking-questions}
            ...
            + [阻止自我查看](product-docs/marketo-sales-connect/email/common-tracking-questions/preventing-self-views.md)
      ...
      + 常见问题解答 {#faq}
         ...
         + [我的账户被锁了。 我该怎么办？](product-docs/marketo-sales-connect/faq/i-got-locked-out-of-my-account-what-do-i-do.md)
      ...
      + 人员 {#people}
         ...
         + 管理联系人 {#managing-contacts}
            ...
            + [Sales Connect如何处理电子邮件重复数据删除](product-docs/marketo-sales-connect/people/managing-contacts/how-sales-connect-handles-email-de-duping.md)
      ...
      + 电话 {#phone}
         + [调用未登录到Salesforce](product-docs/marketo-sales-connect/phone/calls-arent-logging-to-salesforce.md)
         ...
         + [将致电原因和致电结果记录到Salesforce](product-docs/marketo-sales-connect/phone/log-call-reasons-and-call-outcomes-to-salesforce.md)
         + [销售电话国际通话](product-docs/marketo-sales-connect/phone/sales-phone-international-calling.md)
   ...
   + Marketo Sales Insight {#marketo-sales-insight}
      + 操作 {#actions}
         ...
         + 快速入门 {#getting-started}
            ...
            + [销售分析操作用户入门清单](product-docs/marketo-sales-insight/actions/getting-started/sales-insight-actions-user-onboarding-checklist.md)
         ...
         + CRM {#crm}
            ...
            + Salesforce集成 {#salesforce-integration}
               ...
               + [回复日志](product-docs/marketo-sales-insight/actions/crm/salesforce-integration/reply-logging.md)
               ...
               + [将Sales Activities同步到Salesforce](product-docs/marketo-sales-insight/actions/crm/salesforce-integration/sync-sales-activities-to-salesforce.md)
         ...
         + 常见问题解答 {#faq}
            ...
            + [我该如何防止自我观点？](product-docs/marketo-sales-insight/actions/faq/how-do-i-prevent-self-views.md)
         ...
         + 电话 {#phone}
            ...
            + [将致电原因和致电结果记录到Salesforce](product-docs/marketo-sales-insight/actions/phone/log-call-reasons-and-call-outcomes-to-salesforce.md)
         ...
         + 任务 {#tasks}
            + [与Salesforce同步提醒任务](product-docs/marketo-sales-insight/actions/tasks/reminder-task-sync-with-salesforce.md)
         + 模板 {#templates}
      ...
      + MSI Chrome插件 {#msi-chrome-plugin}
         ...
         + [在Google Mail中查看人员和帐户信息以及活动](product-docs/marketo-sales-insight/msi-chrome-plugin/view-person-and-account-information-and-activities-in-google-mail.md)
      + 适用于Microsoft Dynamics的MSI {#msi-for-microsoft-dynamics}
         ...
         + 设置和使用 {#setting-up-and-using}
            + [从Microsoft Dynamics将潜在客户/联系人添加到Marketo营销活动](product-docs/marketo-sales-insight/msi-for-microsoft-dynamics/setting-up-and-using/add-a-lead-contact-to-a-marketo-campaign-from-microsoft-dynamics.md)
      ...
      + Salesforce的MSI {#msi-for-salesforce}
         ...
         + 配置 {#configuration}
            ...
            + [在Salesforce Professional Edition中配置Marketo Sales Insight](product-docs/marketo-sales-insight/msi-for-salesforce/configuration/configure-marketo-sales-insight-in-salesforce-professional-edition.md)
            + [现有客户的配置](product-docs/marketo-sales-insight/msi-for-salesforce/configuration/configuration-for-existing-customers.md)
            + [Salesforce中的“Marketo Sales Insight配置”选项卡](product-docs/marketo-sales-insight/msi-for-salesforce/configuration/marketo-sales-insight-configuration-tab-in-salesforce.md)
            ...
            + [面向Marketo管理员的“销售分析”页面](product-docs/marketo-sales-insight/msi-for-salesforce/configuration/sales-insight-page-for-marketo-admins.md)
         ...
         + 功能 {#features}
            ...
            + MSI面板中的操作 {#actions-in-the-msi-panel}
               + [在销售分析中选择活动](product-docs/marketo-sales-insight/msi-for-salesforce/features/actions-in-the-msi-panel/choose-an-action-in-sales-insight.md)
            ...
            + 性能报表 {#performance-reports}
               + [销售分析电子邮件性能报告](product-docs/marketo-sales-insight/msi-for-salesforce/features/performance-reports/sales-insight-email-performance-report.md)
            + 星星和火焰 {#stars-and-flames}
               ...
               + [在Sales Insight中设置要用于星和火焰的分数字段](product-docs/marketo-sales-insight/msi-for-salesforce/features/stars-and-flames/set-score-fields-to-be-used-for-stars-and-flames-in-sales-insight.md)
            + MSI面板中的选项卡 {#tabs-in-the-msi-panel}
               ...
               + 有趣的时刻 {#interesting-moments}
                  + [有趣时刻概述](product-docs/marketo-sales-insight/msi-for-salesforce/features/tabs-in-the-msi-panel/interesting-moments/interesting-moments-overview.md)
                  + [有趣时刻的触发器令牌](product-docs/marketo-sales-insight/msi-for-salesforce/features/tabs-in-the-msi-panel/interesting-moments/trigger-tokens-for-interesting-moments.md)
         ...
         + 适用于移动设备的MSI {#msi-for-mobile}
            ...
            + [在Salesforce1中发送Marketo电子邮件、Campaign和Watchlist操作](product-docs/marketo-sales-insight/msi-for-salesforce/msi-for-mobile/send-marketo-email-and-campaign-and-watchlist-actions-in-salesforce1.md)
         + 升级 {#upgrading}
      ...
      + MSI Outlook插件 {#msi-outlook-plugin}
         ...
         + [使用Outlook的Email Add-In发送和跟踪电子邮件](product-docs/marketo-sales-insight/msi-outlook-plugin/send-and-track-an-email-with-the-email-add-in-for-outlook.md)
   ...
   + Marketo Sky {#marketo-sky}
      ...
      + [Predictive Audiences入门](product-docs/marketo-sky/getting-started-with-predictive-audiences.md)
      + [模型运行状况和数据有效性](product-docs/marketo-sky/model-health-and-data-validity.md)
   ...
   + 移动营销 {#mobile-marketing}
      + 管理员 {#admin}
         ...
         + [将Vibes添加为LaunchPoint服务](product-docs/mobile-marketing/admin/add-vibes-as-a-launchpoint-service.md)
      ...
      + 应用程序内消息 {#in-app-messages}
         ...
         + 创建应用程序内消息 {#creating-in-app-messages}
            ...
            + [设置取消按钮并批准消息](product-docs/mobile-marketing/in-app-messages/creating-in-app-messages/set-up-the-dismiss-button-and-approve-the-message.md)
      ...
      + Vibes SMS消息 {#vibes-sms-messages}
         + [创建Vibes SMS消息](product-docs/mobile-marketing/vibes-sms-messages/create-a-vibes-sms-message.md)
   ...
   + Personalization {#personalization}
      + 分段和代码片段 {#segmentation-and-snippets}
         ...
         + 代码片段 {#snippets}
            ...
            + [批准带有无草稿的代码片段](product-docs/personalization/segmentation-and-snippets/snippets/approve-a-snippet-with-no-draft.md)
   ...
   + 报告 {#reporting}
      ...
      + 基本报告 {#basic-reporting}
         ...
         + 编辑报告 {#editing-reports}
            ...
            + [向潜在客户报告添加机会列](product-docs/reporting/basic-reporting/editing-reports/add-opportunity-columns-to-a-lead-report.md)
         ...
         + 报告活动 {#report-activity}
            ...
            + [筛选促销活动报表](product-docs/reporting/basic-reporting/report-activity/filter-a-campaign-activity-report.md)
            + [在营销活动电子邮件报表中筛选资产](product-docs/reporting/basic-reporting/report-activity/filter-assets-in-a-campaign-email-reports.md)
            + [在电子邮件报表中筛选资源](product-docs/reporting/basic-reporting/report-activity/filter-assets-in-an-email-report.md)
            + [按属性分组人员报表](product-docs/reporting/basic-reporting/report-activity/group-person-reports-by-attribute.md)
            + [报告电子邮件、跨工作区的营销活动效果](product-docs/reporting/basic-reporting/report-activity/report-email-campaign-performance-across-workspaces.md)
      ...
      + 电子邮件分析 {#email-insights}
         ...
         + [电子邮件分析的自定义Dimension](product-docs/reporting/email-insights/custom-dimensions-for-email-insights.md)
         ...
         + [在电子邮件分析中筛选](product-docs/reporting/email-insights/filtering-in-email-insights.md)
      ...
      + 收入周期分析 {#revenue-cycle-analytics}
         + 电子邮件分析 {#email-analysis}
            ...
            + [生成显示项目群信息的电子邮件分析报告](product-docs/reporting/revenue-cycle-analytics/email-analysis/build-an-email-analysis-report-that-shows-program-information.md)
         ...
         + 机会影响分析器 {#opportunity-influence-analyzer}
            ...
            + [导出Opportunity Influence Analyzer数据](product-docs/reporting/revenue-cycle-analytics/opportunity-influence-analyzer/export-opportunity-influence-analyzer-data.md)
         ...
         + 程序分析 {#program-analytics}
            ...
            + [使用Program Analyzer比较渠道效率](product-docs/reporting/revenue-cycle-analytics/program-analytics/compare-channel-effectiveness-with-the-program-analyzer.md)
            + [使用Program Analyzer比较计划效果](product-docs/reporting/revenue-cycle-analytics/program-analytics/compare-program-effectiveness-with-the-program-analyzer.md)
            + [创建程序分析器](product-docs/reporting/revenue-cycle-analytics/program-analytics/create-a-program-analyzer.md)
            + [使用计划分析器探索计划和渠道详细信息](product-docs/reporting/revenue-cycle-analytics/program-analytics/explore-program-and-channel-details-with-the-program-analyzer.md)
            ...
            + [覆盖程序级别的Analytics行为](product-docs/reporting/revenue-cycle-analytics/program-analytics/override-analytics-behavior-at-the-program-level.md)
            ...
            + [了解计划收入阶段分析区域](product-docs/reporting/revenue-cycle-analytics/program-analytics/understanding-the-program-revenue-stage-analysis-area.md)
         + 收入周期模型 {#revenue-cycle-models}
            ...
            + [报告您的收入模型](product-docs/reporting/revenue-cycle-analytics/revenue-cycle-models/report-on-your-revenue-model.md)
         ...
         + Revenue Explorer {#revenue-explorer}
            ...
            + [创建收入资源管理器报表](product-docs/reporting/revenue-cycle-analytics/revenue-explorer/create-a-revenue-explorer-report.md)
            ...
            + [订阅Revenue Explorer报表](product-docs/reporting/revenue-cycle-analytics/revenue-explorer/subscribe-to-a-revenue-explorer-report.md)
            ...
            + [在Revenue Explorer中使用功能板](product-docs/reporting/revenue-cycle-analytics/revenue-explorer/using-dashboards-in-revenue-explorer.md)
         + 收入工具 {#revenue-tools}
            ...
            + 现场组织者 {#field-organizers}
               + [使用字段组织者](product-docs/reporting/revenue-cycle-analytics/revenue-tools/using-field-organizers.md)
   ...
   + 目标帐户管理 {#target-account-management}
      ...
      + 目标 {#target}
         + 指定帐户 {#named-accounts}
            ...
            + [商机帐户匹配](product-docs/target-account-management/target/named-accounts/lead-to-account-matching.md)
         ...
         + [在LinkedIn中创建与帐户匹配的受众](product-docs/target-account-management/target/create-an-account-matched-audience-on-linkedin.md)
      + 参与 {#engage}
   ...
   + Web个性化 {#web-personalization}
      ...
      + 快速入门 {#getting-started}
         ...
         + [将Web个性化设置为“不跟踪”](product-docs/web-personalization/getting-started/setting-web-personalization-to-do-not-track.md)
      ...
      + RTP标记实施 {#rtp-tag-implementation}
         ...
         + [使用Tealium Tag Manager实施RTP](product-docs/web-personalization/rtp-tag-implementation/implementing-rtp-using-tealium-tag-manager.md)
      + Web个性化报表 {#reporting-for-web-personalization}
         ...
         + [排除特定的IP而不被跟踪](product-docs/web-personalization/reporting-for-web-personalization/exclude-specific-ips-from-being-tracked.md)
      ...
      + 使用Web营销活动 {#working-with-web-campaigns}
         ...
         + [新建区域内的Web营销活动](product-docs/web-personalization/working-with-web-campaigns/create-a-new-in-zone-web-campaign.md)
         ...
         + [将表单嵌入到Web营销活动中](product-docs/web-personalization/working-with-web-campaigns/embed-a-form-into-a-web-campaign.md)
         ...
         + [为您的Web营销活动设置标签](product-docs/web-personalization/working-with-web-campaigns/label-your-web-campaigns.md)
         ...
         + [按最新或最佳绩效对Web营销活动进行排序](product-docs/web-personalization/working-with-web-campaigns/sort-web-campaigns-by-latest-or-top-performing.md)
