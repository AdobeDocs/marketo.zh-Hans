   ...
   + 需求生成 {#demand-generation}
      ...
      + Forms {#forms}
         ...
         + 表单操作 {#form-actions}
            ...
            + [更改表单验证/错误消息的语言并提交按钮](product-docs/demand-generation/forms/form-actions/change-the-language-of-form-validation-error-messages-and-submit-button.md)
      ...
      + 操作 {#actions}
         ...
         + 电子邮件 {#email}
            ...
            + 使用撰写窗口 {#using-the-compose-window}
               ...
               + [向电子邮件添加Highspot内容](product-docs/marketo-sales-insight/actions/email/using-the-compose-window/adding-highspot-content-to-your-email.md)
