...
>[!TIP]
>
>项目打开时，参与项目图标将显示一个绿色按钮，项目关闭时不显示按钮。

| **参与项目开启** | ![图像开启](/help/sky/assets/engagement-programs/turn-an-engagement-program-on-and-off/turn-an-engagement-program-on-and-off-on.png) |
| --- | --- |
| **参与项目关闭** | ![图像关闭](/help/sky/assets/engagement-programs/turn-an-engagement-program-on-and-off/turn-an-engagement-program-on-and-off-off.png) |
