...
在流中使用项目时，是否以前收到过该特定电子邮件并不重要。 只要该特定项目&#x200B;_中_&#x200B;之前未发出该电子邮件，您就可以再次收到它。
...
在某人被从嵌套项目的智能活动的智能列表中筛选出的事件中，他们在当前播放期间不会继续移动到下一段内容。 在&#x200B;_转换后，它们将移至流中的下一段内容。_
